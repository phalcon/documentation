...
*implements* [Phalcon\Mvc\Model\CriteriaInterface](Phalcon_Mvc_Model_Criteria.md), [Phalcon\Di\InjectionAwareInterface](Phalcon_Di.md)
...
public [Phalcon\Mvc\Model\Criteria](Phalcon_Mvc_Model_Criteria.md) **columns** (*string* | *array* $columns)
...
public static  **fromInput** ([Phalcon\DiInterface](Phalcon_Di.md) $dependencyInjector, *mixed* $modelName, *array* $data, [*mixed* $operator])
