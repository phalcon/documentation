...
## Attributes
The [Phalcon\Html\Attributes][html-attributes] is a wrapper of [Phalcon\Collection](collection.md). It also contains two more methods `render()` and `__toString()`. `render()` uses [Phalcon\Tag](tag.md) internally to render the attributes that a HTML element has. These HTML attributes are defined in the object itself.
...
This component is used internally by [Phalcon\Forms\Form](forms.md) to store the attributes of form elements.
...
[html-helper-anchorraw]: api/phalcon_html.md#html-helper-anchorraw
...
[html-helper-elementraw]: api/phalcon_html.md#html-helper-elementraw
...
[html-helper-textarea]: api/phalcon_html.md#html-helper-textarea
