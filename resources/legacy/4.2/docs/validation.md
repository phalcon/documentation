...
Filtering and sanitizing is performed using the [filter](filter.md) component. You can add more filters to this component or use the built-in ones.
...
[validation]: api/phalcon_validation.md#validation
[validation-abstractcombinedfieldsvalidator]: api/phalcon_validation.md#validation-abstractcombinedfieldsvalidator
[validation-abstractvalidator]: api/phalcon_validation.md#validation-abstractvalidator
[validation-abstractvalidatorcomposite]: api/phalcon_validation.md#validation-abstractvalidatorcomposite
[validation-exception]: api/phalcon_validation.md#validation-exception
[validation-validationinterface]: api/phalcon_validation.md#validation-validationinterface
[validation-validator-alnum]: api/phalcon_validation.md#validation-validator-alnum
[validation-validator-alpha]: api/phalcon_validation.md#validation-validator-alpha
[validation-validator-between]: api/phalcon_validation.md#validation-validator-between
[validation-validator-callback]: api/phalcon_validation.md#validation-validator-callback
[validation-validator-confirmation]: api/phalcon_validation.md#validation-validator-confirmation
[validation-validator-creditcard]: api/phalcon_validation.md#validation-validator-creditcard
[validation-validator-date]: api/phalcon_validation.md#validation-validator-date
[validation-validator-digit]: api/phalcon_validation.md#validation-validator-digit
[validation-validator-email]: api/phalcon_validation.md#validation-validator-email
[validation-validator-exception]: api/phalcon_validation.md#validation-validator-exception
[validation-validator-exclusionin]: api/phalcon_validation.md#validation-validator-exclusionin
[validation-validator-file]: api/phalcon_validation.md#validation-validator-file
[validation-validator-file-abstractfile]: api/phalcon_validation.md#validation-validator-file-abstractfile
[validation-validator-file-mimetype]: api/phalcon_validation.md#validation-validator-file-mimetype
[validation-validator-file-resolution-equal]: api/phalcon_validation.md#validation-validator-file-resolution-equal
[validation-validator-file-resolution-max]: api/phalcon_validation.md#validation-validator-file-resolution-max
[validation-validator-file-resolution-min]: api/phalcon_validation.md#validation-validator-file-resolution-min
[validation-validator-file-size-equal]: api/phalcon_validation.md#validation-validator-file-size-equal
[validation-validator-file-size-max]: api/phalcon_validation.md#validation-validator-file-size-max
[validation-validator-file-size-min]: api/phalcon_validation.md#validation-validator-file-size-min
[validation-validator-identical]: api/phalcon_validation.md#validation-validator-identical
[validation-validator-inclusionin]: api/phalcon_validation.md#validation-validator-inclusionin
[validation-validator-ip]: api/phalcon_validation.md#validation-validator-ip
[validation-validator-numericality]: api/phalcon_validation.md#validation-validator-numericality
[validation-validator-presenceof]: api/phalcon_validation.md#validation-validator-presenceof
[validation-validator-regex]: api/phalcon_validation.md#validation-validator-regex
[validation-validator-stringlength]: api/phalcon_validation.md#validation-validator-stringlength
[validation-validator-stringlength-max]: api/phalcon_validation.md#validation-validator-stringlength-max
[validation-validator-stringlength-min]: api/phalcon_validation.md#validation-validator-stringlength-min
[validation-validator-uniqueness]: api/phalcon_validation.md#validation-validator-uniqueness
[validation-validator-url]: api/phalcon_validation.md#validation-validator-url
[validation-validatorcompositeinterface]: api/phalcon_validation.md#validation-validatorcompositeinterface
[validation-validatorfactory]: api/phalcon_validation.md#validation-validatorfactory
[validation-validatorinterface]: api/phalcon_validation.md#validation-validatorinterface
