...
### Converters
Converters are snippets of code that allow you to convert the parameters of a route prior to it being sent to the [dispatcher](/5.8/dispatcher/)
...
## Events
Similar to other Phalcon components, [Phalcon\Mvc\Router][mvc-router] also has events, when an [Events Manager](/5.8/events/) is present. The available events are:
...
[mvc-router-annotations]: /5.8/api/phalcon_mvc/#mvcrouterannotations
[mvc-router-exception]: /5.8/api/phalcon_mvc/#mvcrouterexception
[mvc-router-group]: /5.8/api/phalcon_mvc/#mvcroutergroup
[mvc-router-groupinterface]: /5.8/api/phalcon_mvc/#mvcroutergroupinterface
[mvc-router-route]: /5.8/api/phalcon_mvc/#mvcrouterroute
[mvc-router-routeinterface]: /5.8/api/phalcon_mvc/#mvcrouterrouteinterface
[mvc-routerinterface]: /5.8/api/phalcon_mvc/#mvcrouterinterface
...
Source: https://docs.phalcon.io/5.8/routing/index.mdx
