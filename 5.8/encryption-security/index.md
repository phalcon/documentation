...
[security]: /5.8/api/phalcon_encryption/#encryptionsecurity
[security-exception]: /5.8/api/phalcon_encryption/#encryptionsecurityexception
[security-random]: /5.8/api/phalcon_encryption/#encryptionsecurityrandom
[sha1]: https://php.net/manual/en/function.sha1.php
[wiki-csrf]: https://en.wikipedia.org/wiki/Cross-site_request_forgery
[di]: /5.8/di/

Source: https://docs.phalcon.io/5.8/encryption-security/index.mdx
