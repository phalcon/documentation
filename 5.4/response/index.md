...
[http-cookie]: /5.4/api/phalcon_http/#http-cookie
[http-cookie-exception]: /5.4/api/phalcon_http/#http-cookie-exception
[http-cookieinterface]: /5.4/api/phalcon_http/#http-cookieinterface
[http-response]: /5.4/api/phalcon_http/#http-response
[http-response-cookies]: /5.4/api/phalcon_http/#http-response-cookies
[http-response-cookiesinterface]: /5.4/api/phalcon_http/#http-response-cookiesinterface
[http-response-exception]: /5.4/api/phalcon_http/#http-response-exception
[http-response-headers]: /5.4/api/phalcon_http/#http-response-headers
[http-response-headersinterface]: /5.4/api/phalcon_http/#http-response-headersinterface
...
[url]: /5.4/api/phalcon_mvc/#mvc-url
...
[events-eventsawareinterface]: /5.4/api/phalcon_events/#events-eventsawareinterface
[readfile]: https://www.php.net/manual/en/function.readfile.php
[http-message-response]: /5.4/api/phalcon_http/#http-message-response

Source: https://docs.phalcon.io/5.4/response/index.mdx
