...
[image-adapter-abstractadapter]: /5.4/api/phalcon_image/#image-adapter-abstractadapter
[image-adapter-adapterinterface]: /5.4/api/phalcon_image/#image-adapter-adapterinterface
[image-adapter-gd]: /5.4/api/phalcon_image/#image-adapter-gd
[image-adapter-imagick]: /5.4/api/phalcon_image/#image-adapter-imagick
[image-enum]: /5.4/api/phalcon_image/#image-enum
[image-exception]: /5.4/api/phalcon_image/#image-exception
[image-imagefactory]: /5.4/api/phalcon_image/#image-imagefactory
[imagick-liquidrescale]: https://www.php.net/manual/en/imagick.liquidrescaleimage.php 
[config]: /5.4/config/

Source: https://docs.phalcon.io/5.4/image/index.mdx
