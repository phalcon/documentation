...
### Converters
Converters are snippets of code that allow you to convert the parameters of a route prior to it being sent to the [dispatcher](/5.4/dispatcher/)
...
## Events
Similar to other Phalcon components, [Phalcon\Mvc\Router][mvc-router] also has events, when an [Events Manager](/5.4/events/) is present. The available events are:
...
[mvc-router-annotations]: /5.4/api/phalcon_mvc/#mvc-router-annotations
[mvc-router-exception]: /5.4/api/phalcon_mvc/#mvc-router-exception
[mvc-router-group]: /5.4/api/phalcon_mvc/#mvc-router-group
[mvc-router-groupinterface]: /5.4/api/phalcon_mvc/#mvc-router-groupinterface
[mvc-router-route]: /5.4/api/phalcon_mvc/#mvc-router-route
[mvc-router-routeinterface]: /5.4/api/phalcon_mvc/#mvc-router-routeinterface
[mvc-routerinterface]: /5.4/api/phalcon_mvc/#mvc-routerinterface
...
Source: https://docs.phalcon.io/5.4/routing/index.mdx
