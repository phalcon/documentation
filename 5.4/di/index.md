...
[di]: /5.4/api/phalcon_di/#di
[di-abstractinjectionaware]: /5.4/api/phalcon_di/#di-abstractinjectionaware
[di-diinterface]: /5.4/api/phalcon_di/#di-diinterface
[di-exception]: /5.4/api/phalcon_di/#di-exception
[di-exception-serviceresolutionexception]: /5.4/api/phalcon_di/#di-exception-serviceresolutionexception
[di-factorydefault]: /5.4/api/phalcon_di/#di-factorydefault
[di-factorydefault-cli]: /5.4/api/phalcon_di/#di-factorydefault-cli
[di-injectable]: /5.4/api/phalcon_di/#di-injectable
[di-injectionawareinterface]: /5.4/api/phalcon_di/#di-injectionawareinterface
[di-service]: /5.4/api/phalcon_di/#di-service
[di-service-builder]: /5.4/api/phalcon_di/#di-service-builder
[di-serviceinterface]: /5.4/api/phalcon_di/#di-serviceinterface
[di-serviceproviderinterface]: /5.4/api/phalcon_di/#di-serviceproviderinterface
[ioc]: https://en.wikipedia.org/wiki/Inversion_of_control
[singleton]: https://en.wikipedia.org/wiki/Singleton_pattern
[yaml]: https://php.net/manual/book.yaml.php
[response]: /5.4/response/
[events]: /5.4/events/
[annotations]: /5.4/annotations/
[ssets]: /5.4/ssets/
[encryption-crypt]: /5.4/encryption-crypt/
[response-cookies]: /5.4/response/#cookies
[dispatcher]: /5.4/dispatcher/
[html-escaper]: /5.4/html-escaper/
[events]: /5.4/events/
[flash]: /5.4/flash/
[filter-filter]: /5.4/filter-filter/
[support-helper]: /5.4/support-helper/
[db-models]: /5.4/db-models/
[db-models-metadata]: /5.4/db-models-metadata/
[request]: /5.4/request/
[response]: /5.4/response/
[routing]: /5.4/routing/
[encryption-security]: /5.4/encryption-security/
[tagfactory]: /5.4/html-tagfactory/
[db-models-transactions]: /5.4/db-models-transactions/
[mvc-url]: /5.4/mvc-url/
[db-layer]: /5.4/db-layer/
[session#bag]: /5.4/session/#bag

Source: https://docs.phalcon.io/5.4/di/index.mdx
