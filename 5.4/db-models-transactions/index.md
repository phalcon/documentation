...
[mvc-model-transaction]: /5.4/api/phalcon_mvc/#mvc-model-transaction
[mvc-model-transaction-exception]: /5.4/api/phalcon_mvc/#mvc-model-transaction-exception
[mvc-model-transaction-failed]: /5.4/api/phalcon_mvc/#mvc-model-transaction-failed
[mvc-model-transaction-manager]: /5.4/api/phalcon_mvc/#mvc-model-transaction-manager
[mvc-model-transaction-managerinterface]: /5.4/api/phalcon_mvc/#mvc-model-transaction-managerinterface
[mvc-model-transactioninterface]: /5.4/api/phalcon_mvc/#mvc-model-transactioninterface

Source: https://docs.phalcon.io/5.4/db-models-transactions/index.mdx
