...
[mvc-model-metadata]: /5.4/api/phalcon_mvc/#mvc-model-metadata
[mvc-model-metadata-apcu]: /5.4/api/phalcon_mvc/#mvc-model-metadata-apcu
[mvc-model-metadata-libmemcached]: /5.4/api/phalcon_mvc/#mvc-model-metadata-libmemcached
[mvc-model-metadata-memory]: /5.4/api/phalcon_mvc/#mvc-model-metadata-memory
[mvc-model-metadata-redis]: /5.4/api/phalcon_mvc/#mvc-model-metadata-redis
[mvc-model-metadata-strategy-annotations]: /5.4/api/phalcon_mvc/#mvc-model-metadata-strategy-annotations
[mvc-model-metadata-strategy-introspection]: /5.4/api/phalcon_mvc/#mvc-model-metadata-strategy-introspection
[mvc-model-metadata-strategyinterface]: /5.4/api/phalcon_mvc/#mvc-model-metadata-strategyinterface
[mvc-model-metadata-stream]: /5.4/api/phalcon_mvc/#mvc-model-metadata-stream
[mvc-model-metadatainterface]: /5.4/api/phalcon_mvc/#mvc-model-metadatainterface
[cache-adapter-factory]: /5.4/cache/#adapter-factory
[annotations]: /5.4/annotations/

Source: https://docs.phalcon.io/5.4/db-models-metadata/index.mdx
