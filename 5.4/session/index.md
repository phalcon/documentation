...
[session-adapter-abstractadapter]: /5.4/api/phalcon_session/#session-adapter-abstractadapter
[session-adapter-libmemcached]: /5.4/api/phalcon_session/#session-adapter-libmemcached
[session-adapter-noop]: /5.4/api/phalcon_session/#session-adapter-noop
[session-adapter-redis]: /5.4/api/phalcon_session/#session-adapter-redis
[session-adapter-stream]: /5.4/api/phalcon_session/#session-adapter-stream
[session-bag]: /5.4/api/phalcon_session/#session-bag
[session-exception]: /5.4/api/phalcon_session/#session-exception
[session-manager]: /5.4/api/phalcon_session/#session-manager
[session-managerinterface]: /5.4/api/phalcon_session/#session-managerinterface
[sessionhandlerinterface]: https://www.php.net/manual/en/class.sessionhandlerinterface.php
[storage-adapter]: /5.4/api/phalcon_storage/#storage-adapterfactory
...
Source: https://docs.phalcon.io/5.4/session/index.mdx
