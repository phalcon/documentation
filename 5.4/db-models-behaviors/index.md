...
[events-list]: /5.4/events/#list-of-events
[mvc-model-behavior]: /5.4/api/phalcon_mvc/#mvc-model-behavior
[mvc-model-behavior-softdelete]: /5.4/api/phalcon_mvc/#mvc-model-behavior-softdelete
[mvc-model-behavior-timestampable]: /5.4/api/phalcon_mvc/#mvc-model-behavior-timestampable
[mvc-model-behaviorinterface]: /5.4/api/phalcon_mvc/#mvc-model-behaviorinterface
[time]: https://php.net/manual/en/function.time.php
[traits]: https://php.net/manual/en/language.oop5.traits.php
[events]: /5.4/events/

Source: https://docs.phalcon.io/5.4/db-models-behaviors/index.mdx
