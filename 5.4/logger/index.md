...
[logger-logger]: /5.4/api/phalcon_logger/#logger-logger
[logger-abstractlogger]: /5.4/api/phalcon_logger/#logger-abstractlogger
[logger-adapter-noop]: /5.4/api/phalcon_logger/#logger-adapter-noop
[logger-adapter-stream]: /5.4/api/phalcon_logger/#logger-adapter-stream
[logger-adapter-syslog]: /5.4/api/phalcon_logger/#logger-adapter-syslog
[logger-loggerfactory]: /5.4/api/phalcon_logger/#logger-loggerfactory
[logger-adapterfactory]: /5.4/api/phalcon_logger/#logger-adapterfactory
[logger-formatter-line]: /5.4/api/phalcon_logger/#logger-formatter-line
[logger-formatter-json]: /5.4/api/phalcon_logger/#logger-formatter-json
[logger-formatter-syslog]: /5.4/api/phalcon_logger/#logger-formatter-syslog
[logger-formatter-formatterinterface]: /5.4/api/phalcon_logger/#logger-formatter-formatterinterface
[logger-adapter-adapterinterface]: /5.4/api/phalcon_logger/#logger-adapter-adapterinterface
[logger-formatter-abstractformatter]: /5.4/api/phalcon_logger/#logger-formatter-abstractformatter
[logger-adapter-abstractadapter]: /5.4/api/phalcon_logger/#logger-adapter-abstractadapter
[logger-exception]: /5.4/api/phalcon_logger/#logger-exception
[logger-item]: /5.4/api/phalcon_logger/#logger-item
[proxy-psr3]: https://github.com/phalcon/proxy-psr3
[psr-3]: https://www.php-fig.org/psr/psr-3/
[stream-wrappers]: https://php.net/manual/en/wrappers.php

Source: https://docs.phalcon.io/5.4/logger/index.mdx
