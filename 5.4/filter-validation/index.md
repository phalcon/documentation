...
[messages-message]: /5.4/api/phalcon_messages/#messages-message
[messages-messages]: /5.4/api/phalcon_messages/#messages-messages
[validation]: /5.4/api/phalcon_filter/#filter-validation
[validation-abstractcombinedfieldsvalidator]: /5.4/api/phalcon_filter/#filter-validation-abstractcombinedfieldsvalidator
[validation-abstractvalidator]: /5.4/api/phalcon_filter/#filter-validation-abstractvalidator
[validation-abstractvalidatorcomposite]: /5.4/api/phalcon_filter/#filter-validation-abstractvalidatorcomposite
[validation-exception]: /5.4/api/phalcon_filter/#filter-validation-exception
[validation-validationinterface]: /5.4/api/phalcon_filter/#filter-validation-validationinterface
[validation-validator-alnum]: /5.4/api/phalcon_filter/#filter-validation-validator-alnum
[validation-validator-alpha]: /5.4/api/phalcon_filter/#filter-validation-validator-alpha
[validation-validator-between]: /5.4/api/phalcon_filter/#filter-validation-validator-between
[validation-validator-callback]: /5.4/api/phalcon_filter/#filter-validation-validator-callback
[validation-validator-confirmation]: /5.4/api/phalcon_filter/#filter-validation-validator-confirmation
[validation-validator-creditcard]: /5.4/api/phalcon_filter/#filter-validation-validator-creditcard
[validation-validator-date]: /5.4/api/phalcon_filter/#filter-validation-validator-date
[validation-validator-digit]: /5.4/api/phalcon_filter/#filter-validation-validator-digit
[validation-validator-email]: /5.4/api/phalcon_filter/#filter-validation-validator-email
[validation-validator-exception]: /5.4/api/phalcon_filter/#filter-validation-validator-exception
[validation-validator-exclusionin]: /5.4/api/phalcon_filter/#filter-validation-validator-exclusionin
[validation-validator-file]: /5.4/api/phalcon_filter/#filter-validation-validator-file
[validation-validator-file-abstractfile]: /5.4/api/phalcon_filter/#filter-validation-validator-file-abstractfile
[validation-validator-file-mimetype]: /5.4/api/phalcon_filter/#filter-validation-validator-file-mimetype
[validation-validator-file-resolution-equal]: /5.4/api/phalcon_filter/#filter-validation-validator-file-resolution-equal
[validation-validator-file-resolution-max]: /5.4/api/phalcon_filter/#filter-validation-validator-file-resolution-max
[validation-validator-file-resolution-min]: /5.4/api/phalcon_filter/#filter-validation-validator-file-resolution-min
[validation-validator-file-size-equal]: /5.4/api/phalcon_filter/#filter-validation-validator-file-size-equal
[validation-validator-file-size-max]: /5.4/api/phalcon_filter/#filter-validation-validator-file-size-max
[validation-validator-file-size-min]: /5.4/api/phalcon_filter/#filter-validation-validator-file-size-min
[validation-validator-identical]: /5.4/api/phalcon_filter/#filter-validation-validator-identical
[validation-validator-inclusionin]: /5.4/api/phalcon_filter/#filter-validation-validator-inclusionin
[validation-validator-ip]: /5.4/api/phalcon_filter/#filter-validation-validator-ip
[validation-validator-numericality]: /5.4/api/phalcon_filter/#filter-validation-validator-numericality
[validation-validator-presenceof]: /5.4/api/phalcon_filter/#filter-validation-validator-presenceof
[validation-validator-regex]: /5.4/api/phalcon_filter/#filter-validation-validator-regex
[validation-validator-stringlength]: /5.4/api/phalcon_filter/#filter-validation-validator-stringlength
[validation-validator-stringlength-max]: /5.4/api/phalcon_filter/#filter-validation-validator-stringlength-max
[validation-validator-stringlength-min]: /5.4/api/phalcon_filter/#filter-validation-validator-stringlength-min
[validation-validator-uniqueness]: /5.4/api/phalcon_filter/#filter-validation-validator-uniqueness
[validation-validator-url]: /5.4/api/phalcon_filter/#filter-validation-validator-url
[validation-validatorcompositeinterface]: /5.4/api/phalcon_filter/#filter-validation-validatorcompositeinterface
[validation-validatorfactory]: /5.4/api/phalcon_filter/#filter-validation-validatorfactory
[validation-validatorinterface]: /5.4/api/phalcon_filter/#filter-validation-validatorinterface
[filter-filter]: /5.4/filter-filter/

Source: https://docs.phalcon.io/5.4/filter-validation/index.mdx
