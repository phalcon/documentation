...
[filter-exception]: /5.4/api/phalcon_filter/#filter-exception
[filter-filter]: /5.4/api/phalcon_filter/#filter
[filter-filterfactory]: /5.4/api/phalcon_filter/#filter-filterfactory
[filter-filterinterface]: /5.4/api/phalcon_filter/#filter-filterinterface
[filter-sanitize-absint]: /5.4/api/phalcon_filter/#filter-sanitize-absint
[filter-sanitize-alnum]: /5.4/api/phalcon_filter/#filter-sanitize-alnum
[filter-sanitize-alpha]: /5.4/api/phalcon_filter/#filter-sanitize-alpha
[filter-sanitize-boolval]: /5.4/api/phalcon_filter/#filter-sanitize-boolval
[filter-sanitize-email]: /5.4/api/phalcon_filter/#filter-sanitize-email
[filter-sanitize-floatval]: /5.4/api/phalcon_filter/#filter-sanitize-floatval
[filter-sanitize-intval]: /5.4/api/phalcon_filter/#filter-sanitize-intval
[filter-sanitize-lower]: /5.4/api/phalcon_filter/#filter-sanitize-lower
[filter-sanitize-lowerfirst]: /5.4/api/phalcon_filter/#filter-sanitize-lowerfirst
[filter-sanitize-regex]: /5.4/api/phalcon_filter/#filter-sanitize-regex
[filter-sanitize-remove]: /5.4/api/phalcon_filter/#filter-sanitize-remove
[filter-sanitize-replace]: /5.4/api/phalcon_filter/#filter-sanitize-replace
[filter-sanitize-special]: /5.4/api/phalcon_filter/#filter-sanitize-special
[filter-sanitize-specialfull]: /5.4/api/phalcon_filter/#filter-sanitize-specialfull
[filter-sanitize-stringval]: /5.4/api/phalcon_filter/#filter-sanitize-stringval
[filter-sanitize-striptags]: /5.4/api/phalcon_filter/#filter-sanitize-striptags
[filter-sanitize-trim]: /5.4/api/phalcon_filter/#filter-sanitize-trim
[filter-sanitize-upper]: /5.4/api/phalcon_filter/#filter-sanitize-upper
[filter-sanitize-upperfirst]: /5.4/api/phalcon_filter/#filter-sanitize-upperfirst
[filter-sanitize-upperwords]: /5.4/api/phalcon_filter/#filter-sanitize-upperwords
[filter-sanitize-url]: /5.4/api/phalcon_filter/#filter-sanitize-url
[factorydefault]: /5.4/api/phalcon_di/#di-factorydefault
[http-request]: /5.4/api/phalcon_html/#http-request

Source: https://docs.phalcon.io/5.4/filter-filter/index.mdx
