...
[db-rawvalue]: /5.4/api/phalcon_db/#db-rawvalue
[DRY]: https://en.wikipedia.org/wiki/Don%27t_repeat_yourself
[mvc-model]: /5.4/api/phalcon_mvc/#mvc-model
[mvc-model-binder]: /5.4/api/phalcon_mvc/#mvc-model-binder
[mvc-model-binder-bindableinterface]: /5.4/api/phalcon_mvc/#mvc-model-binder-bindableinterface
[mvc-model-binderinterface]: /5.4/api/phalcon_mvc/#mvc-model-binderinterface
[mvc-model-criteria]: /5.4/api/phalcon_mvc/#mvc-model-criteria
[mvc-model-criteriainterface]: /5.4/api/phalcon_mvc/#mvc-model-criteriainterface
[mvc-model-exception]: /5.4/api/phalcon_mvc/#mvc-model-exception
[mvc-model-manager]: /5.4/api/phalcon_mvc/#mvc-model-manager
[mvc-model-managerinterface]: /5.4/api/phalcon_mvc/#mvc-model-managerinterface
[mvc-model-query]: /5.4/api/phalcon_mvc/#mvc-model-query
[mvc-model-query-builder]: /5.4/api/phalcon_mvc/#mvc-model-query-builder
[mvc-model-query-builderinterface]: /5.4/api/phalcon_mvc/#mvc-model-query-builderinterface
[mvc-model-query-lang]: /5.4/api/phalcon_mvc/#mvc-model-query-lang
[mvc-model-query-status]: /5.4/api/phalcon_mvc/#mvc-model-query-status
[mvc-model-query-statusinterface]: /5.4/api/phalcon_mvc/#mvc-model-query-statusinterface
[mvc-model-queryinterface]: /5.4/api/phalcon_mvc/#mvc-model-queryinterface
[mvc-model-relation]: /5.4/api/phalcon_mvc/#mvc-model-relation
[mvc-model-relationinterface]: /5.4/api/phalcon_mvc/#mvc-model-relationinterface
[mvc-model-resultinterface]: /5.4/api/phalcon_mvc/#mvc-model-resultinterface
[mvc-model-resultset]: /5.4/api/phalcon_mvc/#mvc-model-resultset
[mvc-model-resultset-complex]: /5.4/api/phalcon_mvc/#mvc-model-resultset-complex
[mvc-model-resultset-simple]: /5.4/api/phalcon_mvc/#mvc-model-resultset-simple
[mvc-model-resultsetinterface]: /5.4/api/phalcon_mvc/#mvc-model-resultsetinterface
[mvc-model-row]: /5.4/api/phalcon_mvc/#mvc-model-row
[mvc-model-validationfailed]: /5.4/api/phalcon_mvc/#mvc-model-validationfailed
[mvc-modelinterface]: /5.4/api/phalcon_mvc/#mvc-modelinterface
...
[db-models-transactions]: /5.4/db-models-transactions/
[db-phql]: /5.4/db-phql/
[cache]: /5.4/cache/
[events]: /5.4/events/
[flash]: /5.4/flash/

Source: https://docs.phalcon.io/5.4/db-models/index.mdx
