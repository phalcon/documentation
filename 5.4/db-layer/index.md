...
[db-abstractdb]: /5.4/api/phalcon_db/#db-abstractdb
[db-adapter-abstractadapter]: /5.4/api/phalcon_db/#db-adapter-abstractadapter
[db-adapter-adapterinterface]: /5.4/api/phalcon_db/#db-adapter-adapterinterface
[db-adapter-pdo-abstractpdo]: /5.4/api/phalcon_db/#db-adapter-pdo-abstractpdo
[db-adapter-pdo-mysql]: /5.4/api/phalcon_db/#db-adapter-pdo-mysql
[db-adapter-pdo-postgresql]: /5.4/api/phalcon_db/#db-adapter-pdo-postgresql
[db-adapter-pdo-sqlite]: /5.4/api/phalcon_db/#db-adapter-pdo-sqlite
[db-adapter-pdofactory]: /5.4/api/phalcon_db/#db-adapter-pdofactory
[db-column]: /5.4/api/phalcon_db/#db-column
[db-columninterface]: /5.4/api/phalcon_db/#db-columninterface
[db-dialect]: /5.4/api/phalcon_db/#db-dialect
[db-dialect-mysql]: /5.4/api/phalcon_db/#db-dialect-mysql
[db-dialect-postgresql]: /5.4/api/phalcon_db/#db-dialect-postgresql
[db-dialect-sqlite]: /5.4/api/phalcon_db/#db-dialect-sqlite
[db-dialectinterface]: /5.4/api/phalcon_db/#db-dialectinterface
[db-enum]: /5.4/api/phalcon_db/#db-enum
[db-exception]: /5.4/api/phalcon_db/#db-exception
[db-index]: /5.4/api/phalcon_db/#db-index
[db-indexinterface]: /5.4/api/phalcon_db/#db-indexinterface
[db-profiler]: /5.4/api/phalcon_db/#db-profiler
[db-profiler-item]: /5.4/api/phalcon_db/#db-profiler-item
[db-rawvalue]: /5.4/api/phalcon_db/#db-rawvalue
[db-reference]: /5.4/api/phalcon_db/#db-reference
[db-referenceinterface]: /5.4/api/phalcon_db/#db-referenceinterface
[db-result-pdo]: /5.4/api/phalcon_db/#db-result-pdo
[db-resultinterface]: /5.4/api/phalcon_db/#db-resultinterface
[mvc-model]: /5.4/api/phalcon_mvc/#mvc-model
[events]: /5.4/events/
[db-phql]: /5.4/db-phql/
[logger]: /5.4/logger/

Source: https://docs.phalcon.io/5.4/db-layer/index.mdx
