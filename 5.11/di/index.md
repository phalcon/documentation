...
[di-exception]: /5.11/api/phalcon_di/#diexception
[di-exception-serviceresolutionexception]: /5.11/api/phalcon_di/#diexceptionserviceresolutionexception
[di-factorydefault]: /5.11/api/phalcon_di/#difactorydefault
[di-factorydefault-cli]: /5.11/api/phalcon_di/#difactorydefaultcli
[di-injectable]: /5.11/api/phalcon_di/#diinjectable
[di-injectionawareinterface]: /5.11/api/phalcon_di/#diinjectionawareinterface
[di-service]: /5.11/api/phalcon_di/#diservice
[di-service-builder]: /5.11/api/phalcon_di/#diservicebuilder
[di-serviceinterface]: /5.11/api/phalcon_di/#diserviceinterface
[di-serviceproviderinterface]: /5.11/api/phalcon_di/#diserviceproviderinterface
[ioc]: https://en.wikipedia.org/wiki/Inversion_of_control
[singleton]: https://en.wikipedia.org/wiki/Singleton_pattern
[yaml]: https://php.net/manual/book.yaml.php
[response]: /5.11/response/
[events]: /5.11/events/
[annotations]: /5.11/annotations/
[ssets]: /5.11/ssets/
[encryption-crypt]: /5.11/encryption-crypt/
[assets]: /5.11/assets/
[response-cookies]: /5.11/response/#cookies
[dispatcher]: /5.11/dispatcher/
[html-escaper]: /5.11/html-escaper/
[events]: /5.11/events/
[flash]: /5.11/flash/
[filter-filter]: /5.11/filter-filter/
[support-helper]: /5.11/support-helper/
[db-models]: /5.11/db-models/
[db-models-metadata]: /5.11/db-models-metadata/
[request]: /5.11/request/
[response]: /5.11/response/
[routing]: /5.11/routing/
[encryption-security]: /5.11/encryption-security/
[tagfactory]: /5.11/html-tagfactory/
[db-models-transactions]: /5.11/db-models-transactions/
[mvc-url]: /5.11/mvc-url/
[db-layer]: /5.11/db-layer/
[session-bag]: /5.11/session/#bag
[singletons]: https://en.wikipedia.org/wiki/Singleton_pattern

Source: https://docs.phalcon.io/5.11/di/index.mdx
