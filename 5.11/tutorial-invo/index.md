...
[di]: /5.11/di/
[di-factorydefault]: /5.11/di/#factory-default
[db-models-profiler]: /5.11/db-models-events/#profiling-sql-statements
[config]: /5.11/config/
[application]: /5.11/application/
[volt]: /5.11/volt/
[controllers]: /5.11/controllers/
[encryption-security]: /5.11/encryption-security/
[dispatcher]: /5.11/dispatcher/
[db-pagination]: /5.11/db-pagination/
[session-persistent-data]: /5.11/session/#persistent-data
[logger]: /5.11/logger/
[events]: /5.11/events/
[acl]: /5.11/acl/
[forms]: /5.11/forms/
...
Source: https://docs.phalcon.io/5.11/tutorial-invo/index.mdx
