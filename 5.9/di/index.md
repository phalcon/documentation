...
[di]: /5.9/api/phalcon_di/#didi
[di-abstractinjectionaware]: /5.9/api/phalcon_di/#diabstractinjectionaware
[di-diinterface]: /5.9/api/phalcon_di/#didiinterface
[di-exception]: /5.9/api/phalcon_di/#diexception
[di-exception-serviceresolutionexception]: /5.9/api/phalcon_di/#diexceptionserviceresolutionexception
[di-factorydefault]: /5.9/api/phalcon_di/#difactorydefault
[di-factorydefault-cli]: /5.9/api/phalcon_di/#difactorydefaultcli
[di-injectable]: /5.9/api/phalcon_di/#diinjectable
[di-injectionawareinterface]: /5.9/api/phalcon_di/#diinjectionawareinterface
[di-service]: /5.9/api/phalcon_di/#diservice
[di-service-builder]: /5.9/api/phalcon_di/#diservicebuilder
[di-serviceinterface]: /5.9/api/phalcon_di/#diserviceinterface
[di-serviceproviderinterface]: /5.9/api/phalcon_di/#diserviceproviderinterface
[ioc]: https://en.wikipedia.org/wiki/Inversion_of_control
[singleton]: https://en.wikipedia.org/wiki/Singleton_pattern
[yaml]: https://php.net/manual/book.yaml.php
[response]: /5.9/response/
[events]: /5.9/events/
[annotations]: /5.9/annotations/
[ssets]: /5.9/ssets/
[encryption-crypt]: /5.9/encryption-crypt/
[assets]: /5.9/assets/
[response-cookies]: /5.9/response/#cookies
[dispatcher]: /5.9/dispatcher/
[html-escaper]: /5.9/html-escaper/
[events]: /5.9/events/
[flash]: /5.9/flash/
[filter-filter]: /5.9/filter-filter/
[support-helper]: /5.9/support-helper/
[db-models]: /5.9/db-models/
[db-models-metadata]: /5.9/db-models-metadata/
[request]: /5.9/request/
[response]: /5.9/response/
[routing]: /5.9/routing/
[encryption-security]: /5.9/encryption-security/
[tagfactory]: /5.9/html-tagfactory/
[db-models-transactions]: /5.9/db-models-transactions/
[mvc-url]: /5.9/mvc-url/
[db-layer]: /5.9/db-layer/
[session-bag]: /5.9/session/#bag
[singletons]: https://en.wikipedia.org/wiki/Singleton_pattern

Source: https://docs.phalcon.io/5.9/di/index.mdx
