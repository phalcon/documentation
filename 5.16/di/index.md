...
[container]: /5.16/container/
[db-layer]: /5.16/db-layer/
[db-models]: /5.16/db-models/
[db-models-metadata]: /5.16/db-models-metadata/
[db-models-transactions]: /5.16/db-models-transactions/
[di]: /5.16/api/phalcon_di/#didi
[di-abstractinjectionaware]: /5.16/api/phalcon_di/#diabstractinjectionaware
[di-diinterface]: /5.16/api/phalcon_di/#didiinterface
[di-exception]: /5.16/api/phalcon_di/#diexception
[di-exception-serviceresolutionexception]: /5.16/api/phalcon_di/#diexceptionserviceresolutionexception
[di-factorydefault]: /5.16/api/phalcon_di/#difactorydefault
[di-injectionawareinterface]: /5.16/api/phalcon_di/#diinjectionawareinterface
[di-serviceinterface]: /5.16/api/phalcon_di/#diserviceinterface
[di-serviceproviderinterface]: /5.16/api/phalcon_di/#diserviceproviderinterface
[dispatcher]: /5.16/dispatcher/
[encryption-crypt]: /5.16/encryption-crypt/
[encryption-security]: /5.16/encryption-security/
[events]: /5.16/events/
[filter-filter]: /5.16/filter-filter/
[flash]: /5.16/flash/
[html-escaper]: /5.16/html-escaper/
[ioc]: https://en.wikipedia.org/wiki/Inversion_of_control
[mvc-url]: /5.16/mvc-url/
[request]: /5.16/request/
[response]: /5.16/response/
[response-cookies]: /5.16/response/#cookies
[routing]: /5.16/routing/
[session-bag]: /5.16/session/#bag
[singletons]: https://en.wikipedia.org/wiki/Singleton_pattern
[support-helper]: /5.16/support-helper/
[tagfactory]: /5.16/html-tagfactory/
[yaml]: https://php.net/manual/book.yaml.php

Source: https://docs.phalcon.io/5.16/di/index.mdx
