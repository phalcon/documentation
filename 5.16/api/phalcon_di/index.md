...
- [`Phalcon\Assets\Manager`](/5.16/api/phalcon_assets/#assetsmanager)
- [`Phalcon\Cli\Router`](/5.16/api/phalcon_cli/#clirouter)
- [`Phalcon\Dispatcher\AbstractDispatcher`](/5.16/api/phalcon_dispatcher/#dispatcherabstractdispatcher)
- [`Phalcon\Encryption\Security`](/5.16/api/phalcon_encryption/#encryptionsecurity)
- [`Phalcon\Flash\AbstractFlash`](/5.16/api/phalcon_flash/#flashabstractflash)
- [`Phalcon\Http\Cookie`](/5.16/api/phalcon_http/#httpcookie)
- [`Phalcon\Http\Request`](/5.16/api/phalcon_http/#httprequest)
- [`Phalcon\Http\Response\Cookies`](/5.16/api/phalcon_http/#httpresponsecookies)
- [`Phalcon\Mvc\Model`](/5.16/api/phalcon_mvc/#mvcmodel)
- [`Phalcon\Mvc\Router`](/5.16/api/phalcon_mvc/#mvcrouter)
- [`Phalcon\Mvc\Url`](/5.16/api/phalcon_mvc/#mvcurl)
- [`Phalcon\Session\Manager`](/5.16/api/phalcon_session/#sessionmanager)
...
- [`Phalcon\Filter\Validation`](/5.16/api/phalcon_filter/#filtervalidation)
- [`Phalcon\Forms\Form`](/5.16/api/phalcon_forms/#formsform)
- [`Phalcon\Mvc\Controller`](/5.16/api/phalcon_mvc/#mvccontroller)
- [`Phalcon\Mvc\Micro`](/5.16/api/phalcon_mvc/#mvcmicro)
- [`Phalcon\Mvc\View`](/5.16/api/phalcon_mvc/#mvcview)
- [`Phalcon\Mvc\View\Engine\AbstractEngine`](/5.16/api/phalcon_mvc/#mvcviewengineabstractengine)
- [`Phalcon\Mvc\View\Simple`](/5.16/api/phalcon_mvc/#mvcviewsimple)
...
Source: https://docs.phalcon.io/5.16/api/phalcon_di/index.mdx
