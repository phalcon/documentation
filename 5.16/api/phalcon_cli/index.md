...
- [`Phalcon\Contracts\Cli\Dispatcher`](/5.16/api/phalcon_contracts/#contractsclidispatcher)
...
- `stdClass`
- [`Phalcon\Di\Injectable`](/5.16/api/phalcon_di/#diinjectable)
- **`Phalcon\Cli\Task`** — implements [`Phalcon\Cli\TaskInterface`](#clitaskinterface), [`Phalcon\Events\EventsAwareInterface`](/5.16/api/phalcon_events/#eventseventsawareinterface)
- [`Phalcon\Queue\Cli\ConsumerTask`](/5.16/api/phalcon_queue/#queuecliconsumertask)
...
Source: https://docs.phalcon.io/5.16/api/phalcon_cli/index.mdx
