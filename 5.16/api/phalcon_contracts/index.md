...
- [`Phalcon\Assets\AssetInterface`](/5.16/api/phalcon_assets/#assetsassetinterface)
...
- [`Phalcon\Assets\FilterInterface`](/5.16/api/phalcon_assets/#assetsfilterinterface)
...
- [`Phalcon\Cache\CacheInterface`](/5.16/api/phalcon_cache/#cachecacheinterface)
...
- [`Phalcon\Cli\DispatcherInterface`](/5.16/api/phalcon_cli/#clidispatcherinterface)
...
- [`Phalcon\Container\Exceptions\ContainerThrowable`](/5.16/api/phalcon_container/#containerexceptionscontainerthrowable)
...
- [`Phalcon\Db\Adapter\AdapterInterface`](/5.16/api/phalcon_db/#dbadapteradapterinterface)
...
- [`Phalcon\Db\CheckInterface`](/5.16/api/phalcon_db/#dbcheckinterface)
...
- [`Phalcon\Db\ColumnInterface`](/5.16/api/phalcon_db/#dbcolumninterface)
...
- [`Phalcon\Db\DialectInterface`](/5.16/api/phalcon_db/#dbdialectinterface)
...
- [`Phalcon\Db\Geometry\GeometryInterface`](/5.16/api/phalcon_db/#dbgeometrygeometryinterface)
...
- [`Phalcon\Db\IndexInterface`](/5.16/api/phalcon_db/#dbindexinterface)
...
- [`Phalcon\Db\ReferenceInterface`](/5.16/api/phalcon_db/#dbreferenceinterface)
...
- [`Phalcon\Db\ResultInterface`](/5.16/api/phalcon_db/#dbresultinterface)
...
- [`Phalcon\Dispatcher\DispatcherInterface`](/5.16/api/phalcon_dispatcher/#dispatcherdispatcherinterface)
...
- [`Phalcon\Domain\Payload\ReadableInterface`](/5.16/api/phalcon_domain/#domainpayloadreadableinterface)
...
- [`Phalcon\Domain\Payload\WriteableInterface`](/5.16/api/phalcon_domain/#domainpayloadwriteableinterface)
...
- [`Phalcon\Encryption\Crypt\CryptInterface`](/5.16/api/phalcon_encryption/#encryptioncryptcryptinterface)
...
- [`Phalcon\Encryption\Crypt\Padding\PadInterface`](/5.16/api/phalcon_encryption/#encryptioncryptpaddingpadinterface)
...
- [`Phalcon\Encryption\Security\JWT\Signer\SignerInterface`](/5.16/api/phalcon_encryption/#encryptionsecurityjwtsignersignerinterface)
...
- [`Phalcon\Encryption\Security\Uuid\NodeProviderInterface`](/5.16/api/phalcon_encryption/#encryptionsecurityuuidnodeproviderinterface)
...
- [`Phalcon\Encryption\Security\Uuid\TimeBasedUuidInterface`](/5.16/api/phalcon_encryption/#encryptionsecurityuuidtimebaseduuidinterface)
...
- [`Phalcon\Encryption\Security\Uuid\UuidInterface`](/5.16/api/phalcon_encryption/#encryptionsecurityuuiduuidinterface)
...
- [`Phalcon\Events\EventInterface`](/5.16/api/phalcon_events/#eventseventinterface)
...
- [`Phalcon\Events\EventsAwareInterface`](/5.16/api/phalcon_events/#eventseventsawareinterface)
...
- [`Phalcon\Events\ManagerInterface`](/5.16/api/phalcon_events/#eventsmanagerinterface)
...
- [`Phalcon\Flash\FlashInterface`](/5.16/api/phalcon_flash/#flashflashinterface)
...
- [`Phalcon\Logger\Adapter\AdapterInterface`](/5.16/api/phalcon_logger/#loggeradapteradapterinterface)
...
- [`Phalcon\Logger\Formatter\FormatterInterface`](/5.16/api/phalcon_logger/#loggerformatterformatterinterface)
...
- [`Phalcon\Logger\LoggerInterface`](/5.16/api/phalcon_logger/#loggerloggerinterface)
...
- [`Phalcon\Mvc\DispatcherInterface`](/5.16/api/phalcon_mvc/#mvcdispatcherinterface)
...
- [`Phalcon\Paginator\Adapter\AdapterInterface`](/5.16/api/phalcon_paginator/#paginatoradapteradapterinterface)
...
- [`Phalcon\Paginator\RepositoryInterface`](/5.16/api/phalcon_paginator/#paginatorrepositoryinterface)
...
Source: https://docs.phalcon.io/5.16/api/phalcon_contracts/index.mdx
