...
- [`Phalcon\Cache\CacheFactory`](/5.16/api/phalcon_cache/#cachecachefactory)
- [`Phalcon\Factory\AbstractFactory`](#factoryabstractfactory)
- [`Phalcon\Logger\LoggerFactory`](/5.16/api/phalcon_logger/#loggerloggerfactory)
- [`Phalcon\Queue\QueueFactory`](/5.16/api/phalcon_queue/#queuequeuefactory)
...
- [`Phalcon\Annotations\AnnotationsFactory`](/5.16/api/phalcon_annotations/#annotationsannotationsfactory)
- [`Phalcon\Cache\AdapterFactory`](/5.16/api/phalcon_cache/#cacheadapterfactory)
- [`Phalcon\Config\ConfigFactory`](/5.16/api/phalcon_config/#configconfigfactory)
- [`Phalcon\Db\Adapter\PdoFactory`](/5.16/api/phalcon_db/#dbadapterpdofactory)
- [`Phalcon\Encryption\Crypt\PadFactory`](/5.16/api/phalcon_encryption/#encryptioncryptpadfactory)
- [`Phalcon\Filter\Validation\ValidatorFactory`](/5.16/api/phalcon_filter/#filtervalidationvalidatorfactory)
- [`Phalcon\Image\ImageFactory`](/5.16/api/phalcon_image/#imageimagefactory)
- [`Phalcon\Logger\AdapterFactory`](/5.16/api/phalcon_logger/#loggeradapterfactory)
- [`Phalcon\Paginator\PaginatorFactory`](/5.16/api/phalcon_paginator/#paginatorpaginatorfactory)
- [`Phalcon\Queue\AdapterFactory`](/5.16/api/phalcon_queue/#queueadapterfactory)
- [`Phalcon\Storage\AdapterFactory`](/5.16/api/phalcon_storage/#storageadapterfactory)
- [`Phalcon\Storage\SerializerFactory`](/5.16/api/phalcon_storage/#storageserializerfactory)
- [`Phalcon\Support\HelperFactory`](/5.16/api/phalcon_support/#supporthelperfactory)
- [`Phalcon\Translate\InterpolatorFactory`](/5.16/api/phalcon_translate/#translateinterpolatorfactory)
- [`Phalcon\Translate\TranslateFactory`](/5.16/api/phalcon_translate/#translatetranslatefactory)
...
Source: https://docs.phalcon.io/5.16/api/phalcon_factory/index.mdx
