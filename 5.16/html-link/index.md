...
:::info[NOTE]
This component does not generate any HTML links. It only stores the links. You will need to create your serializers that will parse these objects and generate the necessary output. The [Phalcon\Html\Link\Serializer\Header][html-link-serializer-header] serializer is available for you to use.
:::
...
[html-link-evolvablelink]: /5.16/api/phalcon_html/#htmllinkevolvablelink
[html-link-evolvablelinkprovider]: /5.16/api/phalcon_html/#htmllinkevolvablelink
[html-link-link]: /5.16/api/phalcon_html/#htmllinklink
[html-link-linkprovider]: /5.16/api/phalcon_html/#htmllinklinkprovider
[html-link-serializer-header]: /5.16/api/phalcon_html/#htmllinkserializerheader
[html-link-serializer-serializerinterface]: /5.16/api/phalcon_html/#htmllinkserializerserializerinterface
[php-fig]: https://www.php-fig.org/
[proxy-psr13]: https://github.com/phalcon/proxy-psr13
[psr-13]: https://www.php-fig.org/psr/psr-13/

Source: https://docs.phalcon.io/5.16/html-link/index.mdx
