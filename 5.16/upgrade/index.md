...
[phalcon-acl]: /5.16/acl/
[phalcon-annotations]: /5.16/annotations/
[phalcon-application]: /5.16/application/
[phalcon-application-cli]: /5.16/application-cli/
[phalcon-assets]: /5.16/assets/
[phalcon-autoload]: /5.16/autoload/
[phalcon-cache]: /5.16/cache/
[phalcon-config]: /5.16/config/
[phalcon-datamapper]: /5.16/datamapper/
[phalcon-db-layer]: /5.16/db-layer/
[phalcon-db-pagination]: /5.16/db-pagination/
[phalcon-di]: /5.16/di/
[phalcon-dispatcher]: /5.16/dispatcher/
[phalcon-domain]: /5.16/domain/
[phalcon-encryption-crypt]: /5.16/encryption-crypt/
[phalcon-encryption-security]: /5.16/encryption-security/
[phalcon-events]: /5.16/events/
[phalcon-filter-filter]: /5.16/filter-filter/
[phalcon-filter-validation]: /5.16/filter-validation/
[phalcon-flash]: /5.16/flash/
[phalcon-forms]: /5.16/forms/
[phalcon-html]: /5.16/html/
[phalcon-html-escaper]: /5.16/html-escaper/
[phalcon-html-link]: /5.16/html-link/
[phalcon-html-tagfactory]: /5.16/html-tagfactory/
[phalcon-logger]: /5.16/logger/
[phalcon-mvc]: /5.16/mvc/
[phalcon-mvc-url]: /5.16/mvc-url/
[phalcon-session]: /5.16/session/
[phalcon-storage]: /5.16/storage/
[phalcon-support-collection]: /5.16/support-collection/
[phalcon-support-debug]: /5.16/support-debug/
[phalcon-support-helper]: /5.16/support-helper/
[phalcon-support-registry]: /5.16/support-registry/
[phalcon-support-version]: /5.16/support-version/
[phalcon-tag]: /5.16/tag/
[phalcon-translate]: /5.16/translate/
[phalcon-volt]: /5.16/volt/
...
[support]: #support
[volt-tag-helpers]: /5.16/volt/#tag-helpers
[zephir-phar]: https://github.com/phalcon/zephir/releases

Source: https://docs.phalcon.io/5.16/upgrade/index.mdx
