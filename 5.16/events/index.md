...
[application-micro]: /5.16/application-micro/
[auth]: /5.16/auth/
[autoload]: /5.16/autoload/
[cache]: /5.16/cache/
[contracts-event]: /5.16/api/phalcon_contracts/#contractseventsevent
[contracts-eventsaware]: /5.16/api/phalcon_contracts/#contractseventseventsaware
[contracts-manager]: /5.16/api/phalcon_contracts/#contractseventsmanager
[contracts-stoppable]: /5.16/api/phalcon_contracts/#contractseventsstoppable
[db]: /5.16/api/phalcon_db/
[db-layer]: /5.16/db-layer/
[db-models]: /5.16/db-models/
[di-factorydefaul]: /5.16/api/phalcon_di/#difactorydefault
[di-injectable]: /5.16/api/phalcon_di/#diinjectable
[dispatcher]: /5.16/dispatcher/
[events-event]: /5.16/api/phalcon_events/#eventsevent
[events-eventinterface]: /5.16/api/phalcon_events/#eventseventinterface
[events-eventsawareinterface]: /5.16/api/phalcon_events/#eventseventsawareinterface
[events-exception]: /5.16/api/phalcon_events/#eventsexception
[events-manager]: /5.16/api/phalcon_events/#eventsmanager
[events-managerinterface]: /5.16/api/phalcon_events/#eventsmanagerinterface
[events-subscriber]: /5.16/api/phalcon_contracts/#contractseventssubscriber
...
[storage]: /5.16/storage/
[views]: /5.16/views/
[volt]: /5.16/volt/

Source: https://docs.phalcon.io/5.16/events/index.mdx
