...
- **`Phalcon\Auth\AuthUser`** — implements [`Phalcon\Contracts\Auth\AuthUser`](/5.15/api/phalcon_contracts/#contractsauthauthuser)
...
- **`Phalcon\Auth\Manager`** — implements [`Phalcon\Contracts\Auth\Manager`](/5.15/api/phalcon_contracts/#contractsauthmanager)
...
Source: https://docs.phalcon.io/5.15/api/phalcon_auth/index.mdx
