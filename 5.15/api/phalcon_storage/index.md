...
- **`Phalcon\Storage\Adapter\AbstractAdapter`** — implements [`Phalcon\Storage\Adapter\AdapterInterface`](#storageadapteradapterinterface), [`Phalcon\Events\EventsAwareInterface`](/5.15/api/phalcon_events/#eventseventsawareinterface)
...
<h4 id="storageadapterabstractadapter-getarrval"><code>getArrVal()</code></h4>
...
- [`Phalcon\Cache\Adapter\AdapterInterface`](/5.15/api/phalcon_cache/#cacheadapteradapterinterface)
...
- [`Phalcon\Cache\Adapter\Apcu`](/5.15/api/phalcon_cache/#cacheadapterapcu)
...
<h4 id="storageadapterapcu-phpapcudec"><code>phpApcuDec()</code></h4>
...
<h4 id="storageadapterapcu-phpapcudelete"><code>phpApcuDelete()</code></h4>

```php
protected function phpApcuDelete( mixed $key ): bool|array;
```

<h4 id="storageadapterapcu-phpapcuexists"><code>phpApcuExists()</code></h4>

```php
protected function phpApcuExists( mixed $key ): bool|array;
```

<h4 id="storageadapterapcu-phpapcufetch"><code>phpApcuFetch()</code></h4>

```php
protected function phpApcuFetch( mixed $key ): mixed;
```

<h4 id="storageadapterapcu-phpapcuinc"><code>phpApcuInc()</code></h4>
...
<h4 id="storageadapterapcu-phpapcuiterator"><code>phpApcuIterator()</code></h4>

```php
protected function phpApcuIterator( string $pattern ): APCUIterator|bool;
```

<h4 id="storageadapterapcu-phpapcustore"><code>phpApcuStore()</code></h4>
...
- [`Phalcon\Cache\Adapter\Libmemcached`](/5.15/api/phalcon_cache/#cacheadapterlibmemcached)
...
- [`Phalcon\Cache\Adapter\Memory`](/5.15/api/phalcon_cache/#cacheadaptermemory)
...
- [`Phalcon\Cache\Adapter\Redis`](/5.15/api/phalcon_cache/#cacheadapterredis)
...
- [`Phalcon\Cache\Adapter\RedisCluster`](/5.15/api/phalcon_cache/#cacheadapterrediscluster)
...
- [`Phalcon\Cache\Adapter\Stream`](/5.15/api/phalcon_cache/#cacheadapterstream)
...
<h4 id="storageadapterstream-phpfileexists"><code>phpFileExists()</code></h4>
...
<h4 id="storageadapterstream-phpfilegetcontents"><code>phpFileGetContents()</code></h4>

```php
protected function phpFileGetContents( string $filename ): string|bool;
```

<h4 id="storageadapterstream-phpfileputcontents"><code>phpFilePutContents()</code></h4>
...
<h4 id="storageadapterstream-phpfopen"><code>phpFopen()</code></h4>
...
<h4 id="storageadapterstream-phpunlink"><code>phpUnlink()</code></h4>
...
- [`Phalcon\Cache\Adapter\Weak`](/5.15/api/phalcon_cache/#cacheadapterweak)
...
<h4 id="storageserializerbase64-phpbase64decode"><code>phpBase64Decode()</code></h4>
...
<h4 id="storageserializerigbinary-phpigbinaryserialize"><code>phpIgbinarySerialize()</code></h4>
...
Source: https://docs.phalcon.io/5.15/api/phalcon_storage/index.mdx
