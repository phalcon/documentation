...
- [`Phalcon\Contracts\Encryption\Crypt\Crypt`](/5.15/api/phalcon_contracts/#contractsencryptioncryptcrypt)
...
- [`Phalcon\Contracts\Encryption\Crypt\Padding\Pad`](/5.15/api/phalcon_contracts/#contractsencryptioncryptpaddingpad)
...
- **`Phalcon\Encryption\Security`** — implements [`Phalcon\Contracts\Encryption\Security\Security`](/5.15/api/phalcon_contracts/#contractsencryptionsecuritysecurity)
...
- [`Phalcon\Contracts\Encryption\Security\JWT\Signer\Signer`](/5.15/api/phalcon_contracts/#contractsencryptionsecurityjwtsignersigner)
...
- [`Phalcon\Contracts\Encryption\Security\Uuid\NodeProvider`](/5.15/api/phalcon_contracts/#contractsencryptionsecurityuuidnodeprovider)
...
- [`Phalcon\Contracts\Encryption\Security\Uuid\TimeBasedUuid`](/5.15/api/phalcon_contracts/#contractsencryptionsecurityuuidtimebaseduuid)
...
- [`Phalcon\Contracts\Encryption\Security\Uuid\Uuid`](/5.15/api/phalcon_contracts/#contractsencryptionsecurityuuiduuid)
...
Source: https://docs.phalcon.io/5.15/api/phalcon_encryption/index.mdx
