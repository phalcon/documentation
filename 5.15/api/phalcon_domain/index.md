...
- [`Phalcon\Contracts\Domain\Payload\Readable`](/5.15/api/phalcon_contracts/#contractsdomainpayloadreadable)
- [`Phalcon\Domain\Payload\ReadableInterface`](#domainpayloadreadableinterface)
- **`Phalcon\Domain\Payload\PayloadInterface`** — extends [`Phalcon\Domain\Payload\ReadableInterface`](#domainpayloadreadableinterface), [`Phalcon\Domain\Payload\WriteableInterface`](#domainpayloadwriteableinterface), [`Phalcon\Contracts\Domain\Payload\Payload`](/5.15/api/phalcon_contracts/#contractsdomainpayloadpayload)
...
- [`Phalcon\Contracts\Domain\Payload\Writeable`](/5.15/api/phalcon_contracts/#contractsdomainpayloadwriteable)
...
Source: https://docs.phalcon.io/5.15/api/phalcon_domain/index.mdx
