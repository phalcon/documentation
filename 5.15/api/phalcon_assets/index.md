...
- [`Phalcon\Contracts\Assets\Asset`](/5.15/api/phalcon_contracts/#contractsassetsasset)
- **`Phalcon\Assets\AssetInterface`**
...
- [`Phalcon\Contracts\Assets\Filter`](/5.15/api/phalcon_contracts/#contractsassetsfilter)
- **`Phalcon\Assets\FilterInterface`**
...
Source: https://docs.phalcon.io/5.15/api/phalcon_assets/index.mdx
