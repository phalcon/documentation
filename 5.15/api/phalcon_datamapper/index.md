...
- **`Phalcon\DataMapper\Pdo\Profiler\MemoryLogger`** — implements [`Phalcon\Logger\LoggerInterface`](/5.15/api/phalcon_logger/#loggerloggerinterface)
...
Source: https://docs.phalcon.io/5.15/api/phalcon_datamapper/index.mdx
