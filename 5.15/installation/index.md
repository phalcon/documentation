...
* [fileinfo][fileinfo]
* [gettext][gettext]
* [gd2][gd2] (to use the [Phalcon\Image\Adapter\Gd](/5.15/api/phalcon_image/#imageadaptergd) class)
* [imagick][imagick] (to use the [Phalcon\Image\Adapter\Imagick](/5.15/api/phalcon_image/#imageadapterimagick) class)
* [json][json]
...
Source: https://docs.phalcon.io/5.15/installation/index.mdx
