...
Part of the HTTP cycle is returning responses to clients. [Phalcon\Http\Response](/3.4/api/phalcon_http/) is the Phalcon component designed to achieve this task. HTTP responses are usually composed by headers and body. The following is an example of basic usage:
...
A [Phalcon\Http\Response\Headers](/3.4/api/phalcon_http/) bag internally manages headers. This class retrieves the headers before sending it to client:
...
All internal URIs are generated using the [url](/3.4/url/) service (by default [Phalcon\Mvc\Url](/3.4/api/phalcon_mvc_url/)). This example demonstrates how you can redirect using a route you have defined in your application:
...
Source: https://docs.phalcon.io/3.4/response/index.mdx
