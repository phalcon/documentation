...
Use an autoload strategy that takes into account the namespaces, for example with [Phalcon\Loader](/3.4/api/phalcon_loader/):
...
If you are only working with the same namespace for every controller in your application, then you can define a default namespace in the [Dispatcher](/3.4/dispatcher/), by doing this, you don't need to specify a full class name in the router path:
...
Source: https://docs.phalcon.io/3.4/namespaces/index.mdx
