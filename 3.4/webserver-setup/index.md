...
If you created your application with [Phalcon-Devtools](/3.4/devtools-installation/) this file should already exist in the root directory of your project and you can start the server with the following command:
...
### Phalcon configuration
The following are potential configurations you can use to setup Apache with Phalcon. These notes are primarily focused on the configuration of the `mod_rewrite` module allowing to use friendly URLs and the [router component](/3.4/routing/). Commonly an application has the following structure:
...
Source: https://docs.phalcon.io/3.4/webserver-setup/index.mdx
