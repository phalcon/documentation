...
:::danger[NOTE]
Migrations are available in [Phalcon Developer Tools](/3.4/devtools-usage/) You need at least Phalcon Framework version 0.5.0 to use developer tools.
:::
...
|-----------------|--------------------------------------------------------------------------------------------------------------------------------------------|:--------:|
| `type`          | Column type. Must be a [Phalcon\Db\Column](/3.4/api/phalcon_db/) constant (see below)                                                                            | No       |
...
Source: https://docs.phalcon.io/3.4/db-migrations/index.mdx
