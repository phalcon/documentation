...
Then, using for example the component [Phalcon\Mvc\Url](/3.4/api/phalcon_mvc_url/) we can build routes from its name:
...
## Default Behavior
[Phalcon\Mvc\Router](/3.4/api/phalcon_mvc_router/) has a default behavior that provides a very simple routing that always expects a URI that matches the following pattern: `/:controller/:action/:params`
...
Source: https://docs.phalcon.io/3.4/routing/index.mdx
