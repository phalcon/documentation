...
Using [Phalcon\Mvc\View](/3.4/api/phalcon_mvc_view/) you can pass variables from the controller to the views. In the above example, four variables were passed to the view: `show_navigation`, `menu`, `title` and `post`:
...
To call a [Phalcon\Tag](/3.4/api/phalcon_tag/) helper, you only need to call an uncamelized version of the method:
...
Source: https://docs.phalcon.io/3.4/volt/index.mdx
