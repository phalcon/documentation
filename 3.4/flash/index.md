...
The attribute `flashSession` is how the flash was previously set into the dependency injection container. You need to start the [session](/3.4/session/) first to successfully use the `flashSession` messenger.

Source: https://docs.phalcon.io/3.4/flash/index.mdx
