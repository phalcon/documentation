...
## Random
The [Phalcon\Security\Random](/3.4/api/phalcon_security/) class makes it really easy to generate lots of types of random data.
...
Source: https://docs.phalcon.io/3.4/security/index.mdx
