---
title: "Improving Performance with Cache"
version: "3.4"
---
...
| Adapter                           | Description                                                                                                                                                    |
|-----------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Phalcon\Cache\Frontend\Output](/3.4/api/phalcon_cache/)   | Read input data from standard PHP output.                                                                                                                      |
| [Phalcon\Cache\Frontend\Data](/3.4/api/phalcon_cache/)     | It's used to cache any kind of PHP data (big arrays, objects, text, etc). Data is serialized before stored in the backend.                                     |
| [Phalcon\Cache\Frontend\Base64](/3.4/api/phalcon_cache/)   | It's used to cache binary data. The data is serialized using `base64_encode` before be stored in the backend.                                                  |
| [Phalcon\Cache\Frontend\Json](/3.4/api/phalcon_cache/)     | Data is encoded in JSON before be stored in the backend. Decoded after be retrieved. This frontend is useful to share data with other languages or frameworks. |
...
|--------------------------------------|------------------------------------------------      |-------------------------------------------|----------------------------------------------------|
| [Phalcon\Cache\Backend\Apc](/3.4/api/phalcon_cache/)          | Stores data to the Alternative PHP Cache (APC).      | [APC](https://php.net/apc)                 | [APC](https://pecl.php.net/package/APC)             |
...
| [Phalcon\Cache\Backend\File](/3.4/api/phalcon_cache/)         | Stores data to local plain files.                    |                                           |                                                    |
| [Phalcon\Cache\Backend\Libmemcached](/3.4/api/phalcon_cache/) | Stores data to a memcached server.                   | [Memcached](https://www.php.net/memcached) | [Memcached](https://pecl.php.net/package/memcached) |
| [Phalcon\Cache\Backend\Memcache](/3.4/api/phalcon_cache/)     | Stores data to a memcached server.                   | [Memcache](https://www.php.net/memcache)   | [Memcache](https://pecl.php.net/package/memcache)   |
| [Phalcon\Cache\Backend\Memory](/3.4/api/phalcon_cache/)       | Stores data in memory                                |                                           |                                                    |
| [Phalcon\Cache\Backend\Mongo](/3.4/api/phalcon_cache/)        | Stores data to Mongo Database.                       | [MongoDB](https://mongodb.org/)            | [Mongo](https://mongodb.org/)                       |
...
Source: https://docs.phalcon.io/3.4/cache/index.mdx
