...
If the called method has a `get` prefix [Phalcon\Mvc\Model](/3.4/api/phalcon_mvc_model/) will return a `findFirst()`/`find()` result. The following example compares retrieving related results with using magic methods and without:
...
Source: https://docs.phalcon.io/3.4/db-models-relationships/index.mdx
