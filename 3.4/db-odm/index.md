---
title: "ODM (Object-Document Mapper)"
version: "3.4"
---
...
In addition to its ability to [map tables](/3.4/db-models/) in relational databases, Phalcon can map documents from NoSQL databases. The ODM offers a CRUD functionality, events, validations among other services.
...
Each message consists of an instance of the class [Phalcon\Mvc\Model\Message](/3.4/api/phalcon_mvc_model_message/). The set of messages generated can be retrieved with the method getMessages(). Each message provides extended information like the field name that generated the message or the message type:
...
Additionally, this component is integrated with the [Phalcon Events Manager](/3.4/events/) ([Phalcon\Events\Manager](/3.4/api/phalcon_events/)), this means we can create listeners that run when an event is triggered.
...
:::warning[NOTE]
For more information on validators, see the [Validation documentation](/3.4/validation/) 
:::
...
Source: https://docs.phalcon.io/3.4/db-odm/index.mdx
