...
| Adapter                          | Description               |
|----------------------------------|---------------------------|
| [Phalcon\Logger\Adapter\File](/3.4/api/phalcon_logger/)    | Logs to a plain text file |
| [Phalcon\Logger\Adapter\Stream](/3.4/api/phalcon_logger/)  | Logs to a PHP Streams     |
...
| Adapter                            | Description                                              |
|------------------------------------|----------------------------------------------------------|
| [Phalcon\Logger\Formatter\Line](/3.4/api/phalcon_logger/)    | Formats the messages using a one-line string             |
...
Source: https://docs.phalcon.io/3.4/logging/index.mdx
