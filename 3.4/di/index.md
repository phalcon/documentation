...
[Phalcon\Di](/3.4/api/phalcon_di/) is a component implementing Dependency Injection and Location of services and it's itself a container for them.

Since Phalcon is highly decoupled, [Phalcon\Di](/3.4/api/phalcon_di/) is essential to integrate the different components of the framework. The developer can also use this component to inject dependencies and manage global instances of the different classes used in the application.
...
| ------------------ | ------------------------------------- | --------------------------------------- | :----: |
| assets             | Assets Manager                        | [Phalcon\Assets\Manager](/3.4/api/phalcon_assets/)                | Yes    |
| annotations        | Annotations Parser                    | [Phalcon\Annotations\Adapter\Memory](/3.4/api/phalcon_annotations/)    | Yes    |
| cookies            | HTTP Cookies Management Service       | [Phalcon\Http\Response\Cookies](/3.4/api/phalcon_http/)         | Yes    |
| crypt              | Encrypt/Decrypt data                  | [Phalcon\Crypt](/3.4/api/phalcon_crypt/)                         | Yes    |
| db                 | Low-Level Database Connection Service | [Phalcon\Db](/3.4/api/phalcon_db/)                            | Yes    |
| dispatcher         | Controllers Dispatching Service       | [Phalcon\Mvc\Dispatcher](/3.4/api/phalcon_mvc_dispatcher/)                | Yes    |
| eventsManager      | Events Management Service             | [Phalcon\Events\Manager](/3.4/api/phalcon_events/)                | Yes    |
| escaper            | Contextual Escaping                   | [Phalcon\Escaper](/3.4/api/phalcon_escaper/)                       | Yes    |
| flash              | Flash Messaging Service               | [Phalcon\Flash\Direct](/3.4/api/phalcon_flash/)                  | Yes    |
| flashSession       | Flash Session Messaging Service       | [Phalcon\Flash\Session](/3.4/api/phalcon_flash/)                 | Yes    |
| filter             | Input Filtering Service               | [Phalcon\Filter](/3.4/api/phalcon_filter/)                        | Yes    |
| modelsCache        | Cache backend for models cache        | None                                    | No     |
| modelsManager      | Models Management Service             | [Phalcon\Mvc\Model\Manager](/3.4/api/phalcon_mvc_model_manager/)             | Yes    |
| modelsMetadata     | Models Meta-Data Service              | [Phalcon\Mvc\Model\MetaData\Memory](/3.4/api/phalcon_mvc_model_metadata/)     | Yes    |
| request            | HTTP Request Environment Service      | [Phalcon\Http\Request](/3.4/api/phalcon_http/)                  | Yes    |
| response           | HTTP Response Environment Service     | [Phalcon\Http\Response](/3.4/api/phalcon_http/)                 | Yes    |
| router             | Routing Service                       | [Phalcon\Mvc\Router](/3.4/api/phalcon_mvc_router/)                    | Yes    |
| security           | Security helpers                      | [Phalcon\Security](/3.4/api/phalcon_security/)                      | Yes    |
| session            | Session Service                       | [Phalcon\Session\Adapter\Files](/3.4/api/phalcon_session/)         | Yes    |
| sessionBag         | Session Bag service                   | [Phalcon\Session\Bag](/3.4/api/phalcon_session/)                   | Yes    |
| tag                | HTML generation helpers               | [Phalcon\Tag](/3.4/api/phalcon_tag/)                           | Yes    |
...
Source: https://docs.phalcon.io/3.4/di/index.mdx
