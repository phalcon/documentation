...
Any exception thrown within the block is captured in the variable `$e`. A [Phalcon\Exception](/3.4/api/phalcon_exception/) extends the PHP [Exception class](https://www.php.net/manual/en/language.exceptions.php) and is used to understand whether the exception came from Phalcon or PHP itself.
...
Retrieving information from [Phalcon\Exception](/3.4/api/phalcon_exception/) is the same as PHP's [Exception class](https://www.php.net/manual/en/language.exceptions.php):
...
Source: https://docs.phalcon.io/3.4/debug/index.mdx
