...
Before submit **new functionality**, please open a [NFR](/3.4/new-feature-request/) as a new issue on GitHub to discuss the impact of including the functionality or changes in the core extension. Once the functionality is approved, make sure your PR contains the following:
...
[nfr]: /3.4/new-feature-request/

Source: https://docs.phalcon.io/3.4/contributions/index.mdx
