...
:::info[NOTE]
There are more examples on how to extend PHQL in the [PHQL](/4.2/db-phql/) document.
:::
...
## Events
The adapters also send events to an [Events Manager](/4.2/events/) if it is present. If an event returns `false` it can stop the current operation. The following events are supported:
...
## Logging
Using high-level abstraction components such as the `Phalcon\Db` adapters to access the database, makes it difficult to understand which statements are sent to the database system. The [Phalcon\Logger](/4.2/logger/) component interacts with the `Phalcon\Db` adapters offering logging capabilities on the database abstraction level.
...
[db-abstractdb]: /4.2/api/phalcon_db/#db-abstractdb
[db-adapter-abstractadapter]: /4.2/api/phalcon_db/#db-adapter-abstractadapter
[db-adapter-adapterinterface]: /4.2/api/phalcon_db/#db-adapter-adapterinterface
[db-adapter-pdo-abstractpdo]: /4.2/api/phalcon_db/#db-adapter-pdo-abstractpdo
[db-adapter-pdo-mysql]: /4.2/api/phalcon_db/#db-adapter-pdo-mysql
[db-adapter-pdo-postgresql]: /4.2/api/phalcon_db/#db-adapter-pdo-postgresql
[db-adapter-pdo-sqlite]: /4.2/api/phalcon_db/#db-adapter-pdo-sqlite
[db-adapter-pdofactory]: /4.2/api/phalcon_db/#db-adapter-pdofactory
[db-column]: /4.2/api/phalcon_db/#db-column
[db-columninterface]: /4.2/api/phalcon_db/#db-columninterface
[db-dialect]: /4.2/api/phalcon_db/#db-dialect
[db-dialect-mysql]: /4.2/api/phalcon_db/#db-dialect-mysql
[db-dialect-postgresql]: /4.2/api/phalcon_db/#db-dialect-postgresql
[db-dialect-sqlite]: /4.2/api/phalcon_db/#db-dialect-sqlite
[db-dialectinterface]: /4.2/api/phalcon_db/#db-dialectinterface
[db-enum]: /4.2/api/phalcon_db/#db-enum
[db-exception]: /4.2/api/phalcon_db/#db-exception
[db-index]: /4.2/api/phalcon_db/#db-index
[db-indexinterface]: /4.2/api/phalcon_db/#db-indexinterface
[db-profiler]: /4.2/api/phalcon_db/#db-profiler
[db-profiler-item]: /4.2/api/phalcon_db/#db-profiler-item
[db-rawvalue]: /4.2/api/phalcon_db/#db-rawvalue
[db-reference]: /4.2/api/phalcon_db/#db-reference
[db-referenceinterface]: /4.2/api/phalcon_db/#db-referenceinterface
[db-result-pdo]: /4.2/api/phalcon_db/#db-result-pdo
[db-resultinterface]: /4.2/api/phalcon_db/#db-resultinterface
[mvc-model]: /4.2/api/phalcon_mvc/#mvc-model

Source: https://docs.phalcon.io/4.2/db-layer/index.mdx
