...
You have complete control in how you create and customize the cache component before registering it. You can check the [cache](/4.2/cache/) document for various options and customizations available when creating the cache component.
...
## PHQL Queries
Regardless of the syntax we used to create them, all queries in the ORM are handled internally using [PHQL](/4.2/db-phql/). This language gives you much more freedom to create all kinds of queries. Of course these queries can be cached:
...
Source: https://docs.phalcon.io/4.2/db-models-cache/index.mdx
