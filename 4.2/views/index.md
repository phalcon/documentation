...
This component allows you to have control of when a view is rendered and its location. In addition, this component can leverage of view inheritance available in template engines such as [Volt](/4.2/volt/) and others.
...
Automatic rendering must be disabled in [Phalcon\Mvc\Application](/4.2/application/) (if needed):
...
### Picking Views
As mentioned above, when [Phalcon\Mvc\View][mvc-view] is managed by [Phalcon\Mvc\Application](/4.2/application/), the view rendered is the one related with the last controller and action executed. You could override this by using the `pick()` method:
...
## Template Engines
Template Engines help designers to create views without the use of a complicated syntax. Phalcon includes a powerful and fast templating engine called [Volt](/4.2/volt/) that help with view development while not sacrificing processing speed. 
...
### Volt
You might want to use [Volt](/4.2/volt/) as your template engine. To set it up you need to register the engine and pass it to the view component.
...
In the example above, we are utilizing the [Phalcon\Url](/4.2/url/) component in our javascript code, to correctly set up the URL in our application. The service is available in the view by accessing `$this->url`.
...
## Events
[Phalcon\Mvc\View][mvc-view] and [Phalcon\Mvc\View\Simple][mvc-view-simple] are able to send events to an [Events Manager](/4.2/events/) if it is present. Events are triggered using the type `view`. If an event returns `false` it can stop the active operation. The following events are supported:
...
Any exceptions thrown in the view components ([Phalcon\Mvc\View][mvc-view] or [Phalcon\Mvc\View\Simple][mvc-view-simple]) will be of type [Phalcon\Mvc\Exception][mvc-view-exception] or [Phalcon\View\Engine\Volt\Exception][mvc-view-engine-volt-exception] if you are using [Volt](/4.2/volt/). You can use this exception to selectively catch exceptions thrown only from this component.
...
[mvc-view]: /4.2/api/phalcon_mvc/#mvc-view
[mvc-view-engine-abstractengine]: /4.2/api/phalcon_mvc/#mvc-view-engine-abstractengine
[mvc-view-engine-engineinterface]: /4.2/api/phalcon_mvc/#mvc-view-engine-engineinterface
[mvc-view-engine-php]: /4.2/api/phalcon_mvc/#mvc-view-engine-php
[mvc-view-engine-volt]: /4.2/api/phalcon_mvc/#mvc-view-engine-volt
[mvc-view-engine-volt-compiler]: /4.2/api/phalcon_mvc/#mvc-view-engine-volt-compiler
[mvc-view-engine-volt-exception]: /4.2/api/phalcon_mvc/#mvc-view-engine-volt-exception
[mvc-view-exception]: /4.2/api/phalcon_mvc/#mvc-view-exception
[mvc-view-simple]: /4.2/api/phalcon_mvc/#mvc-view-simple
[mvc-viewbaseinterface]: /4.2/api/phalcon_mvc/#mvc-viewbaseinterface
[mvc-viewinterface]: /4.2/api/phalcon_mvc/#mvc-viewinterface
[mustache]: https://github.com/bobthecow/mustache.php
[smarty]: https://www.smarty.net/
[tidy]: https://www.php.net/manual/en/book.tidy.php
[twig]: https://twig.symfony.com/

Source: https://docs.phalcon.io/4.2/views/index.mdx
