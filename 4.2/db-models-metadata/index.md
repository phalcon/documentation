...
### Annotations 
This strategy makes use of [annotations](/4.2/annotations/) to describe the columns in a model. 
...
[mvc-model-metadata]: /4.2/api/phalcon_mvc/#mvc-model-metadata
[mvc-model-metadata-apcu]: /4.2/api/phalcon_mvc/#mvc-model-metadata-apcu
[mvc-model-metadata-libmemcached]: /4.2/api/phalcon_mvc/#mvc-model-metadata-libmemcached
[mvc-model-metadata-memory]: /4.2/api/phalcon_mvc/#mvc-model-metadata-memory
[mvc-model-metadata-redis]: /4.2/api/phalcon_mvc/#mvc-model-metadata-redis
[mvc-model-metadata-strategy-annotations]: /4.2/api/phalcon_mvc/#mvc-model-metadata-strategy-annotations
[mvc-model-metadata-strategy-introspection]: /4.2/api/phalcon_mvc/#mvc-model-metadata-strategy-introspection
[mvc-model-metadata-strategyinterface]: /4.2/api/phalcon_mvc/#mvc-model-metadata-strategyinterface
[mvc-model-metadata-stream]: /4.2/api/phalcon_mvc/#mvc-model-metadata-stream
[mvc-model-metadatainterface]: /4.2/api/phalcon_mvc/#mvc-model-metadatainterface
[cache-adapter-factory]: /4.2/cache/#adapter-factory

Source: https://docs.phalcon.io/4.2/db-models-metadata/index.mdx
