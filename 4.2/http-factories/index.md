...
[http-message-request]: /4.2/api/phalcon_http/#http-message-request
[http-message-requestfactory]: /4.2/api/phalcon_http/#http-message-requestfactory
[http-message-response]: /4.2/api/phalcon_http/#http-message-response
[http-message-responsefactory]: /4.2/api/phalcon_http/#http-message-responsefactory
[http-message-serverrequest]: /4.2/api/phalcon_http/#http-message-serverrequest
[http-message-serverrequestfactory]: /4.2/api/phalcon_http/#http-message-serverrequestfactory
[http-message-stream]: /4.2/api/phalcon_http/#http-message-stream
[http-message-streamfactory]: /4.2/api/phalcon_http/#http-message-streamfactory
[http-message-uploadedfile]: /4.2/api/phalcon_http/#http-message-uploadedfile
[http-message-uploadedfilefactory]: /4.2/api/phalcon_http/#http-message-uploadedfilefactory
[http-message-uri]: /4.2/api/phalcon_http/#http-message-uri
[http-message-urifactory]: /4.2/api/phalcon_http/#http-message-urifactory
[http-message-exception-invalidargumentexception]: /4.2/api/phalcon_http/#http-message-exception-invalidargumentexception
[http-message-stream-input]: /4.2/api/phalcon_http/#http-message-stream-input
[http-message-stream-memory]: /4.2/api/phalcon_http/#http-message-stream-memory
[http-message-stream-temp]: /4.2/api/phalcon_http/#http-message-stream-temp

Source: https://docs.phalcon.io/4.2/http-factories/index.mdx
