...
[Phalcon\Http\Request][http-request] allows you to access the values stored in the [$_GET][get], [$_POST][post] and [$_REQUEST][request] arrays and sanitize or filter them with the [filter](/4.2/filter/) service. 
...
[http-message-abstractcommon]: /4.2/api/phalcon_http/#http-message-abstractcommon
[http-message-abstractmessage]: /4.2/api/phalcon_http/#http-message-abstractmessage
[http-message-abstractrequest]: /4.2/api/phalcon_http/#http-message-abstractrequest
[http-message-exception-invalidargumentexception]: /4.2/api/phalcon_http/#http-message-exception-invalidargumentexception
[http-request]: /4.2/api/phalcon_http/#http-request
[http-request-exception]: /4.2/api/phalcon_http/#http-request-exception
[http-request-file]: /4.2/api/phalcon_http/#http-request-file
[http-request-fileinterface]: /4.2/api/phalcon_http/#http-request-fileinterface
[http-requestinterface]: /4.2/api/phalcon_http/#http-requestinterface
...
Source: https://docs.phalcon.io/4.2/request/index.mdx
