...
:::warning[NOTE]
This guide is not intended to be a complete documentation of the [intl][intl] extension. Please visit its the [documentation][intl-book] of the extension for a reference.
:::
...
Source: https://docs.phalcon.io/4.2/i18n/index.mdx
