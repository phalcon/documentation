...
### `load`
The Cache Factory also offers the `load` method, which accepts a configuration object. This object can be an array or a [Phalcon\Config](/4.2/config/) object, with directives that are used to set up the cache. The object requires the `adapter` element, as well as the `options` element with the necessary directives.
...
[cache-cache]: /4.2/api/phalcon_cache/#cache
[cache-adapter-adapterinterface]: /4.2/api/phalcon_cache/#cache-adapter-adapterinterface
[cache-adapter-apcu]: /4.2/api/phalcon_cache/#cache-adapter-apcu
[cache-adapter-libmemcached]: /4.2/api/phalcon_cache/#cache-adapter-libmemcached
[cache-adapter-memory]: /4.2/api/phalcon_cache/#cache-adapter-memory
[cache-adapter-redis]: /4.2/api/phalcon_cache/#cache-adapter-redis
[cache-adapter-stream]: /4.2/api/phalcon_cache/#cache-adapter-stream
[cache-adapterfactory]: /4.2/api/phalcon_cache/#cache-adapterfactory
[cache-cachefactory]: /4.2/api/phalcon_cache/#cache-cachefactory
[cache-exception-exception]: /4.2/api/phalcon_cache/#cache-exception-exception
[cache-exception-invalidargumentexception]: /4.2/api/phalcon_cache/#cache-exception-invalidargumentexception
[storage-adapter-abstractadapter]: /4.2/api/phalcon_storage/#storage-adapter-abstractadapter
[storage-adapter-adapterinterface]: /4.2/api/phalcon_storage/#storage-adapter-adapterinterface
[storage-adapter-apcu]: /4.2/api/phalcon_storage/#storage-adapter-apcu
[storage-adapter-libmemcached]: /4.2/api/phalcon_storage/#storage-adapter-libmemcached
[storage-adapter-memory]: /4.2/api/phalcon_storage/#storage-adapter-memory
[storage-adapter-redis]: /4.2/api/phalcon_storage/#storage-adapter-redis
[storage-adapter-stream]: /4.2/api/phalcon_storage/#storage-adapter-stream
[storage-adapterfactory]: /4.2/api/phalcon_storage/#storage-adapterfactory
[storage-exception]: /4.2/api/phalcon_storage/#storage-exception
[storage-serializer-abstractserializer]: /4.2/api/phalcon_storage/#storage-serializer-abstractserializer
[storage-serializer-base64]: /4.2/api/phalcon_storage/#storage-serializer-base64
[storage-serializer-igbinary]: /4.2/api/phalcon_storage/#storage-serializer-igbinary
[storage-serializer-json]: /4.2/api/phalcon_storage/#storage-serializer-json
[storage-serializer-msgpack]: /4.2/api/phalcon_storage/#storage-serializer-msgpack
[storage-serializer-none]: /4.2/api/phalcon_storage/#storage-serializer-none
[storage-serializer-php]: /4.2/api/phalcon_storage/#storage-serializer-php
[storage-serializer-serializerinterface]: /4.2/api/phalcon_storage/#storage-serializer-serializerinterface
[storage-serializerfactory]: /4.2/api/phalcon_storage/#storage-serializerfactory

Source: https://docs.phalcon.io/4.2/cache/index.mdx
