...
## Application
As the application is simple, we will not implement any full MVC environment to develop it. In this case, we will use a [micro application](/4.2/application-micro/) for our needs. The structure of the application is as follows:
...
## Run
You can of course set up your web server to run your application. For setup instructions you can check the [webserver setup](/4.2/webserver-setup/) document. If you want to use the built-in PHP server, you will need to create a file called `.htrouter` as follows: 
...
Source: https://docs.phalcon.io/4.2/tutorial-rest/index.mdx
