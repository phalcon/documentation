...
[security-jwt-builder]: /4.2/api/phalcon_security/#security-jwt-builder
[security-jwt-exceptions-unsupportedalgorithmexception]: /4.2/api/phalcon_security/#security-jwt-exceptions-unsupportedalgorithmexception
[security-jwt-exceptions-validatorexception]: /4.2/api/phalcon_security/#security-jwt-exceptions-validatorexception
[security-jwt-signer-abstractsigner]: /4.2/api/phalcon_security/#security-jwt-signer-abstractsigner
[security-jwt-signer-hmac]: /4.2/api/phalcon_security/#security-jwt-signer-hmac
[security-jwt-signer-none]: /4.2/api/phalcon_security/#security-jwt-signer-none
[security-jwt-signer-signerinterface]: /4.2/api/phalcon_security/#security-jwt-signer-signerinterface
[security-jwt-token-abstractitem]: /4.2/api/phalcon_security/#security-jwt-token-abstractitem
[security-jwt-token-enum]: /4.2/api/phalcon_security/#security-jwt-token-enum
[security-jwt-token-item]: /4.2/api/phalcon_security/#security-jwt-token-item
[security-jwt-token-parser]: /4.2/api/phalcon_security/#security-jwt-token-parser
[security-jwt-token-signature]: /4.2/api/phalcon_security/#security-jwt-token-signature
[security-jwt-token-token]: /4.2/api/phalcon_security/#security-jwt-token-token
[security-jwt-validator]: /4.2/api/phalcon_security/#security-jwt-validator

Source: https://docs.phalcon.io/4.2/security-jwt/index.mdx
