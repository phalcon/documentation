...
:::danger[NOTE]
You will need the PSR 1.0 extension installed.
:::
...
* [fileinfo][fileinfo]
* [gettext][gettext]
* [gd2][gd2] (to use the [Phalcon\Image\Adapter\Gd](/4.2/api/phalcon_image/#image-adapter-gd) class)
* [imagick][imagick] (to use the [Phalcon\Image\Adapter\Imagick](/4.2/api/phalcon_image/#image-adapter-imagick) class)
* [json][json]
...
Source: https://docs.phalcon.io/4.2/installation/index.mdx
