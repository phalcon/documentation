...
This component can be used in a plain HTML+PHP view or in a [Volt](/4.2/volt/) template.
...
If you have named routes, you can use the `for` keyword in your parameter array to reference it. [Phalcon\Tag][tag] will resolve the route internally and produce the correct URL using [Phalcon\Url](/4.2/url/).
...
Phalcon also provides a [form builder](/4.2/forms/) to create forms in an object-oriented manner.
...
You can also check out [Volt](/4.2/volt/) a faster template engine for PHP, where you can use a more developer friendly syntax for helpers provided by [Phalcon\Tag][tag].

[factorydefault]: /4.2/api/phalcon_di/#di-factorydefault
[injectable]: /4.2/api/phalcon_di/#di-injectable
[tag]: /4.2/api/phalcon_tag/

Source: https://docs.phalcon.io/4.2/tag/index.mdx
