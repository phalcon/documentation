...
[session-adapter-abstractadapter]: /4.2/api/phalcon_session/#session-adapter-abstractadapter
[session-adapter-libmemcached]: /4.2/api/phalcon_session/#session-adapter-libmemcached
[session-adapter-noop]: /4.2/api/phalcon_session/#session-adapter-noop
[session-adapter-redis]: /4.2/api/phalcon_session/#session-adapter-redis
[session-adapter-stream]: /4.2/api/phalcon_session/#session-adapter-stream
[session-bag]: /4.2/api/phalcon_session/#session-bag
[session-exception]: /4.2/api/phalcon_session/#session-exception
[session-manager]: /4.2/api/phalcon_session/#session-manager
[session-managerinterface]: /4.2/api/phalcon_session/#session-managerinterface
[sessionhandlerinterface]: https://www.php.net/manual/en/class.sessionhandlerinterface.php
[storage-adapter]: /4.2/api/phalcon_storage/#storage-adapterfactory
...
Source: https://docs.phalcon.io/4.2/session/index.mdx
