...
This method receives the notifications from the [Events Manager](/4.2/events/).
...
[mvc-model-behavior]: /4.2/api/phalcon_mvc/#mvc-model-behavior
[mvc-model-behavior-softdelete]: /4.2/api/phalcon_mvc/#mvc-model-behavior-softdelete
[mvc-model-behavior-timestampable]: /4.2/api/phalcon_mvc/#mvc-model-behavior-timestampable
[mvc-model-behaviorinterface]: /4.2/api/phalcon_mvc/#mvc-model-behaviorinterface
[time]: https://php.net/manual/en/function.time.php
[traits]: https://php.net/manual/en/language.oop5.traits.php

Source: https://docs.phalcon.io/4.2/db-models-behaviors/index.mdx
