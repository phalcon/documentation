...
|---------------------------------|--------------------------------------|---------------------------------------------------------|
| [ACL](/4.2/acl/)                      | `acl:afterCheckAccess`               | Acl                                                     |
| [ACL](/4.2/acl/)                      | `acl:beforeCheckAccess`              | Acl                                                     |
| [Application](/4.2/application/)      | `application:afterHandleRequest`     | Application, Controller                                 |
| [Application](/4.2/application/)      | `application:afterStartModule`       | Application, Module                                     |
| [Application](/4.2/application/)      | `application:beforeHandleRequest`    | Application, Dispatcher                                 |
| [Application](/4.2/application/)      | `application:beforeSendResponse`     | Application, Response                                   |
| [Application](/4.2/application/)      | `application:beforeStartModule`      | Application, Module                                     |
| [Application](/4.2/application/)      | `application:boot`                   | Application                                             |
| [Application](/4.2/application/)      | `application:viewRender`             | Application, View                                       |
| [CLI](/4.2/application-cli/)          | `dispatch:beforeException`           | Console, Exception                                      |
| [Console](/4.2/application-cli/)      | `console:afterHandleTask`            | Console, Task                                           |
| [Console](/4.2/application-cli/)      | `console:afterStartModule`           | Console, Module                                         |
| [Console](/4.2/application-cli/)      | `console:beforeHandleTask`           | Console, Dispatcher                                     |
| [Console](/4.2/application-cli/)      | `console:beforeStartModule`          | Console, Module                                         |
| [Console](/4.2/application-cli/)      | `console:boot`                       | Console                                                 |
| [Db](/4.2/db-layer/)                  | `db:afterQuery`                      | Db                                                      |
| [Db](/4.2/db-layer/)                  | `db:beforeQuery`                     | Db                                                      |
| [Db](/4.2/db-layer/)                  | `db:beginTransaction`                | Db                                                      |
| [Db](/4.2/db-layer/)                  | `db:createSavepoint`                 | Db, Savepoint Name                                      |
| [Db](/4.2/db-layer/)                  | `db:commitTransaction`               | Db                                                      |
| [Db](/4.2/db-layer/)                  | `db:releaseSavepoint`                | Db, Savepoint Name                                      |
| [Db](/4.2/db-layer/)                  | `db:rollbackTransaction`             | Db                                                      |
| [Db](/4.2/db-layer/)                  | `db:rollbackSavepoint`               | Db, Savepoint Name                                      |
| [Dispatcher](/4.2/dispatcher/)        | `dispatch:afterBinding`              | Dispatcher                                              |
| [Dispatcher](/4.2/dispatcher/)        | `dispatch:afterDispatch`             | Dispatcher                                              |
| [Dispatcher](/4.2/dispatcher/)        | `dispatch:afterDispatchLoop`         | Dispatcher                                              |
| [Dispatcher](/4.2/dispatcher/)        | `dispatch:afterExecuteRoute`         | Dispatcher                                              |
| [Dispatcher](/4.2/dispatcher/)        | `dispatch:afterInitialize`           | Dispatcher                                              |
| [Dispatcher](/4.2/dispatcher/)        | `dispatch:beforeDispatch`            | Dispatcher                                              |
| [Dispatcher](/4.2/dispatcher/)        | `dispatch:beforeDispatchLoop`        | Dispatcher                                              |
| [Dispatcher](/4.2/dispatcher/)        | `dispatch:beforeException`           | Dispatcher, Exception                                   |
| [Dispatcher](/4.2/dispatcher/)        | `dispatch:beforeExecuteRoute`        | Dispatcher                                              |
| [Dispatcher](/4.2/dispatcher/)        | `dispatch:beforeForward`             | Dispatcher, array  (MVC Dispatcher)                     |
| [Dispatcher](/4.2/dispatcher/)        | `dispatch:beforeNotFoundAction`      | Dispatcher                                              |
| [Loader](/4.2/loader/)                | `loader:afterCheckClass`             | Loader, Class Name                                      |
| [Loader](/4.2/loader/)                | `loader:beforeCheckClass`            | Loader, Class Name                                      |
| [Loader](/4.2/loader/)                | `loader:beforeCheckPath`             | Loader                                                  |
| [Loader](/4.2/loader/)                | `loader:pathFound`                   | Loader, File Path                                       |
| [Micro](/4.2/application-micro/)      | `micro:afterBinding`                 | Micro                                                   |
| [Micro](/4.2/application-micro/)      | `micro:afterHandleRoute`             | Micro, return value mixed                               |
| [Micro](/4.2/application-micro/)      | `micro:afterExecuteRoute`            | Micro                                                   |
| [Micro](/4.2/application-micro/)      | `micro:beforeException`              | Micro, Exception                                        |
| [Micro](/4.2/application-micro/)      | `micro:beforeExecuteRoute`           | Micro                                                   |
| [Micro](/4.2/application-micro/)      | `micro:beforeHandleRoute`            | Micro                                                   |
| [Micro](/4.2/application-micro/)      | `micro:beforeNotFound`               | Micro                                                   |
| [Model](/4.2/db-models/)              | `model:afterCreate`                  | Model                                                   |
| [Model](/4.2/db-models/)              | `model:afterDelete`                  | Model                                                   |
| [Model](/4.2/db-models/)              | `model:afterFetch`                   | Model                                                   |
| [Model](/4.2/db-models/)              | `model:afterSave`                    | Model                                                   |
| [Model](/4.2/db-models/)              | `model:afterUpdate`                  | Model                                                   |
| [Model](/4.2/db-models/)              | `model:afterValidation`              | Model                                                   |
| [Model](/4.2/db-models/)              | `model:afterValidationOnCreate`      | Model                                                   |
| [Model](/4.2/db-models/)              | `model:afterValidationOnUpdate`      | Model                                                   |
| [Model](/4.2/db-models/)              | `model:beforeDelete`                 | Model                                                   |
| [Model](/4.2/db-models/)              | `model:beforeCreate`                 | Model                                                   |
| [Model](/4.2/db-models/)              | `model:beforeSave`                   | Model                                                   |
| [Model](/4.2/db-models/)              | `model:beforeUpdate`                 | Model                                                   |
| [Model](/4.2/db-models/)              | `model:beforeValidation`             | Model                                                   |
| [Model](/4.2/db-models/)              | `model:beforeValidationOnCreate`     | Model                                                   |
| [Model](/4.2/db-models/)              | `model:beforeValidationOnUpdate`     | Model                                                   |
| [Model](/4.2/db-models/)              | `model:notDeleted`                   | Model                                                   |
| [Model](/4.2/db-models/)              | `model:notSaved`                     | Model                                                   |
| [Model](/4.2/db-models/)              | `model:onValidationFails`            | Model                                                   |
| [Model](/4.2/db-models/)              | `model:prepareSave`                  | Model                                                   |
| [Model](/4.2/db-models/)              | `model:validation`                   | Model                                                   |
| [Models Manager](/4.2/db-models/)     | `modelsManager:afterInitialize`      | Manager, Model                                          |
| [Request](/4.2/request/)              | `request:afterAuthorizationResolve`  | Request, ['server' => Server array]                     |
| [Request](/4.2/request/)              | `request:beforeAuthorizationResolve` | Request, ['headers' => [Headers], 'server' => [Server]] |
| [Response](/4.2/response/)            | `response:afterSendHeaders`          | Response                                                |
| [Response](/4.2/response/)            | `response:beforeSendHeaders`         | Response                                                |
| [Router](/4.2/routing/)               | `router:afterCheckRoutes`            | Router                                                  |
| [Router](/4.2/routing/)               | `router:beforeCheckRoutes`           | Router                                                  |
| [Router](/4.2/routing/)               | `router:beforeCheckRoute`            | Router, Route                                           |
| [Router](/4.2/routing/)               | `router:beforeMount`                 | Router, Group                                           |
| [Router](/4.2/routing/)               | `router:matchedRoute`                | Router, Route                                           |
| [Router](/4.2/routing/)               | `router:notMatchedRoute`             | Router, Route                                           |
| [View](/4.2/views/)                    | `view:afterCompile`                  | Volt                                                    |
| [View](/4.2/views/)                    | `view:afterRender`                   | View                                                    |
| [View](/4.2/views/)                    | `view:afterRenderView`               | View                                                    |
| [View](/4.2/views/)                    | `view:beforeCompile`                 | Volt                                                    |
| [View](/4.2/views/)                    | `view:beforeRender`                  | View                                                    |
| [View](/4.2/views/)                    | `view:beforeRenderView`              | View, View Engine Path                                  |
| [View](/4.2/views/)                    | `view:notFoundView`                  | View, View Engine Path                                  |
| [Volt](/4.2/volt/)                    | `compileFilter`                      | Volt, [name, arguments, function arguments]             |
...
[events-event]: /4.2/api/phalcon_events/#events-event
[events-eventinterface]: /4.2/api/phalcon_events/#events-eventinterface
[events-eventsawareinterface]: /4.2/api/phalcon_events/#events-eventsawareinterface
[events-exception]: /4.2/api/phalcon_events/#events-exception
[events-manager]: /4.2/api/phalcon_events/#events-manager
[events-managerinterface]: /4.2/api/phalcon_events/#events-managerinterface
[mvc-controller]: /4.2/api/phalcon_mvc/#mvc-controller
[mvc-model]: /4.2/api/phalcon_mvc/#mvc-model
[splpriorityqueue]: https://www.php.net/manual/en/class.splpriorityqueue.php

Source: https://docs.phalcon.io/4.2/events/index.mdx
