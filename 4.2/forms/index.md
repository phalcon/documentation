...
Each element in the form can be rendered as required by the developer. Internally, [Phalcon\Tag](/4.2/tag/) is used to produce the correct HTML for each element and you can pass additional HTML attributes as the second parameter of `render()`:
...
## Entities
An entity such as a [Phalcon\Mvc\Model](/4.2/db-models/), a PHP class or even a `\stdClass` object can be passed to the form in order to set default values, or to assign the values from the form to the object.
...
:::info[NOTE]
For more information regarding filters, you can check our [Filter document](/4.2/filter/)
:::

## Validation
Phalcon forms are integrated with the [validation](/4.2/validation/) component to offer instant validation. Built-in or custom validators could be set to each element:
...
[forms-element-abstractelement]: /4.2/api/phalcon_forms/#forms-element-abstractelement
[forms-element-check]: /4.2/api/phalcon_forms/#forms-element-check
[forms-element-date]: /4.2/api/phalcon_forms/#forms-element-date
[forms-element-elementinterface]: /4.2/api/phalcon_forms/#forms-element-elementinterface
[forms-element-email]: /4.2/api/phalcon_forms/#forms-element-email
[forms-element-file]: /4.2/api/phalcon_forms/#forms-element-file
[forms-element-hidden]: /4.2/api/phalcon_forms/#forms-element-hidden
[forms-element-numeric]: /4.2/api/phalcon_forms/#forms-element-numeric
[forms-element-password]: /4.2/api/phalcon_forms/#forms-element-password
[forms-element-radio]: /4.2/api/phalcon_forms/#forms-element-radio
[forms-element-select]: /4.2/api/phalcon_forms/#forms-element-select
[forms-element-submit]: /4.2/api/phalcon_forms/#forms-element-submit
[forms-element-text]: /4.2/api/phalcon_forms/#forms-element-text
[forms-element-textarea]: /4.2/api/phalcon_forms/#forms-element-textarea
[forms-exception]: /4.2/api/phalcon_forms/#forms-exception
[forms-form]: /4.2/api/phalcon_forms/#forms-form
[forms-manager]: /4.2/api/phalcon_forms/#forms-manager
[html-attributes]: /4.2/api/phalcon_html/#html-attributes

Source: https://docs.phalcon.io/4.2/forms/index.mdx
