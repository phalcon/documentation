...
If you use the [Phalcon\Di\FactoryDefault][factorydefault] container, the [Phalcon\Security][security] is already registered for you. However you might want to override the default registration in order to set your own `workFactor()`. Alternatively if you are not using the [Phalcon\Di\FactoryDefault][factorydefault] and instead are using the [Phalcon\Di](/4.2/di/) the registration is the same. By doing so, you will be able to access your configuration object from controllers, models, views and any component that implements `Injectable`.
...
[security-exception]: /4.2/api/phalcon_security/#security-exception
[security-random]: /4.2/api/phalcon_security/#security-random
[security]: /4.2/api/phalcon_security/#security
...
Source: https://docs.phalcon.io/4.2/security/index.mdx
