...
:::warning[NOTE]
Models are intended to work with the database on a high layer of abstraction. If you need to work with databases at a lower level check out the [Phalcon\Db](/4.2/api/phalcon_db/) component documentation.
:::
...
All the queries are internally handled as [PHQL](/4.2/db-phql/) queries. PHQL is a high-level, object-oriented and SQL-like language. This language offers more features to perform queries such as joining other models, group records, aggregations etc.
...
There are cases where we need to manipulate the data after it has been fetched from the database so that our model contains what we need in the application layer. As seen in the [events](/4.2/events/) document, models act as listeners so we can implement some events as methods in the model.
...
## Events
As mentioned before [Phalcon\Mvc\Model][mvc-model] acts as a listener to events. Therefore, all the events that the model is listening to can be implemented as methods in the model itself. You can check the [events](/4.2/events/) document for additional information.
...
## Transactions
[Transactions](/4.2/db-models-transactions/) are necessary to ensure data integrity, when we need to insert or update data in more than one table during the same operation. [Phalcon\Mvc\Model][mvc-model] exposes the `setTransaction` method that allows you to bind each model to an active transaction.
...
The following example shows you how you can print any messages generated by an unsuccessful `save` operation in the model, and show these messages in the [flash](/4.2/flash/) messenger. To do this, we use the `notSaved` event:
...
[db-rawvalue]: /4.2/api/phalcon_db/#db-rawvalue
[DRY]: https://en.wikipedia.org/wiki/Don%27t_repeat_yourself
[mvc-model]: /4.2/api/phalcon_mvc/#mvc-model
[mvc-model-binder]: /4.2/api/phalcon_mvc/#mvc-model-binder
[mvc-model-binder-bindableinterface]: /4.2/api/phalcon_mvc/#mvc-model-binder-bindableinterface
[mvc-model-binderinterface]: /4.2/api/phalcon_mvc/#mvc-model-binderinterface
[mvc-model-criteria]: /4.2/api/phalcon_mvc/#mvc-model-criteria
[mvc-model-criteriainterface]: /4.2/api/phalcon_mvc/#mvc-model-criteriainterface
[mvc-model-exception]: /4.2/api/phalcon_mvc/#mvc-model-exception
[mvc-model-manager]: /4.2/api/phalcon_mvc/#mvc-model-manager
[mvc-model-managerinterface]: /4.2/api/phalcon_mvc/#mvc-model-managerinterface
[mvc-model-query]: /4.2/api/phalcon_mvc/#mvc-model-query
[mvc-model-query-builder]: /4.2/api/phalcon_mvc/#mvc-model-query-builder
[mvc-model-query-builderinterface]: /4.2/api/phalcon_mvc/#mvc-model-query-builderinterface
[mvc-model-query-lang]: /4.2/api/phalcon_mvc/#mvc-model-query-lang
[mvc-model-query-status]: /4.2/api/phalcon_mvc/#mvc-model-query-status
[mvc-model-query-statusinterface]: /4.2/api/phalcon_mvc/#mvc-model-query-statusinterface
[mvc-model-queryinterface]: /4.2/api/phalcon_mvc/#mvc-model-queryinterface
[mvc-model-relation]: /4.2/api/phalcon_mvc/#mvc-model-relation
[mvc-model-relationinterface]: /4.2/api/phalcon_mvc/#mvc-model-relationinterface
[mvc-model-resultinterface]: /4.2/api/phalcon_mvc/#mvc-model-resultinterface
[mvc-model-resultset]: /4.2/api/phalcon_mvc/#mvc-model-resultset
[mvc-model-resultset-complex]: /4.2/api/phalcon_mvc/#mvc-model-resultset-complex
[mvc-model-resultset-simple]: /4.2/api/phalcon_mvc/#mvc-model-resultset-simple
[mvc-model-resultsetinterface]: /4.2/api/phalcon_mvc/#mvc-model-resultsetinterface
[mvc-model-row]: /4.2/api/phalcon_mvc/#mvc-model-row
[mvc-model-validationfailed]: /4.2/api/phalcon_mvc/#mvc-model-validationfailed
[mvc-modelinterface]: /4.2/api/phalcon_mvc/#mvc-modelinterface
[pdo-statements]: https://php.net/manual/en/pdo.prepared-statements.php

Source: https://docs.phalcon.io/4.2/db-models/index.mdx
