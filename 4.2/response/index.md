...
:::info[NOTE]
If your DI container contains the `session` service, the cookies will be stored in the session automatically. If not, they will not be stored, and you are responsible to persist them if you wish to.
:::
...
All internal URIs are generated using the [url](/4.2/url/) service (by default [Phalcon\Url][url]). This example demonstrates how you can redirect using a route you have defined in your application:
...
[http-cookie]: /4.2/api/phalcon_http/#http-cookie
[http-cookie-exception]: /4.2/api/phalcon_http/#http-cookie-exception
[http-cookieinterface]: /4.2/api/phalcon_http/#http-cookieinterface
[http-response]: /4.2/api/phalcon_http/#http-response
[http-response-cookies]: /4.2/api/phalcon_http/#http-response-cookies
[http-response-cookiesinterface]: /4.2/api/phalcon_http/#http-response-cookiesinterface
[http-response-exception]: /4.2/api/phalcon_http/#http-response-exception
[http-response-headers]: /4.2/api/phalcon_http/#http-response-headers
[http-response-headersinterface]: /4.2/api/phalcon_http/#http-response-headersinterface
...
[http-message-response]: /4.2/api/phalcon_http/#http-message-response

Source: https://docs.phalcon.io/4.2/response/index.mdx
