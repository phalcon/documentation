...
Note that this feature also works on the [Phalcon\Http\Request](/4.2/api/phalcon_http/#http-request) object, when calling methods to retrieve data from `GET` and `POST`, namely `getQuery()` and `getPost()`.
...
[filter-exception]: /4.2/api/phalcon_filter/#filter-exception
[filter-filter]: /4.2/api/phalcon_filter/#filter
[filter-filterfactory]: /4.2/api/phalcon_filter/#filter-filterfactory
[filter-filterinterface]: /4.2/api/phalcon_filter/#filter-filterinterface
[filter-sanitize-absint]: /4.2/api/phalcon_filter/#filter-sanitize-absint
[filter-sanitize-alnum]: /4.2/api/phalcon_filter/#filter-sanitize-alnum
[filter-sanitize-alpha]: /4.2/api/phalcon_filter/#filter-sanitize-alpha
[filter-sanitize-boolval]: /4.2/api/phalcon_filter/#filter-sanitize-boolval
[filter-sanitize-email]: /4.2/api/phalcon_filter/#filter-sanitize-email
[filter-sanitize-floatval]: /4.2/api/phalcon_filter/#filter-sanitize-floatval
[filter-sanitize-intval]: /4.2/api/phalcon_filter/#filter-sanitize-intval
[filter-sanitize-lower]: /4.2/api/phalcon_filter/#filter-sanitize-lower
[filter-sanitize-lowerfirst]: /4.2/api/phalcon_filter/#filter-sanitize-lowerfirst
[filter-sanitize-regex]: /4.2/api/phalcon_filter/#filter-sanitize-regex
[filter-sanitize-remove]: /4.2/api/phalcon_filter/#filter-sanitize-remove
[filter-sanitize-replace]: /4.2/api/phalcon_filter/#filter-sanitize-replace
[filter-sanitize-special]: /4.2/api/phalcon_filter/#filter-sanitize-special
[filter-sanitize-specialfull]: /4.2/api/phalcon_filter/#filter-sanitize-specialfull
[filter-sanitize-stringval]: /4.2/api/phalcon_filter/#filter-sanitize-stringval
[filter-sanitize-striptags]: /4.2/api/phalcon_filter/#filter-sanitize-striptags
[filter-sanitize-trim]: /4.2/api/phalcon_filter/#filter-sanitize-trim
[filter-sanitize-upper]: /4.2/api/phalcon_filter/#filter-sanitize-upper
[filter-sanitize-upperfirst]: /4.2/api/phalcon_filter/#filter-sanitize-upperfirst
[filter-sanitize-upperwords]: /4.2/api/phalcon_filter/#filter-sanitize-upperwords
[filter-sanitize-url]: /4.2/api/phalcon_filter/#filter-sanitize-url
[factorydefault]: /4.2/api/phalcon_di/#di-factorydefault

Source: https://docs.phalcon.io/4.2/filter/index.mdx
