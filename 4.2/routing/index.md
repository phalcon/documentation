...
### Converters
Converters are snippets of code that allow you to convert the parameters of a route prior to it being sent to the [dispatcher](/4.2/dispatcher/)
...
Then, using for example the component [Phalcon\Url](/4.2/url/) we can build routes from the defined name:
...
## Events
Similar to other Phalcon components, [Phalcon\Mvc\Router][mvc-router] also has events, when an [Events Manager](/4.2/events/) is present. The available events are:
...
## Annotations 
This component provides a variant that is integrated with the [annotations](/4.2/annotations/) service. Using this strategy you can write the routes directly in the controllers instead of adding them in router component directly.
...
[mvc-router-annotations]: /4.2/api/phalcon_mvc/#mvc-router-annotations
[mvc-router-exception]: /4.2/api/phalcon_mvc/#mvc-router-exception
[mvc-router-group]: /4.2/api/phalcon_mvc/#mvc-router-group
[mvc-router-groupinterface]: /4.2/api/phalcon_mvc/#mvc-router-groupinterface
[mvc-router-route]: /4.2/api/phalcon_mvc/#mvc-router-route
[mvc-router-routeinterface]: /4.2/api/phalcon_mvc/#mvc-router-routeinterface
[mvc-routerinterface]: /4.2/api/phalcon_mvc/#mvc-routerinterface
[pcre]: https://www.php.net/manual/en/book.pcre.php
[transformers]: https://transformers.hasbro.com/en-us

Source: https://docs.phalcon.io/4.2/routing/index.mdx
