...
### Load
Loads Paginator Adapter class using `adapter` option. The configuration passed can be an array or a [Phalcon\Config](/4.2/config/) object with the necessary entries for the class to be instantiated.
...
[paginator-adapter-abstractadapter]: /4.2/api/phalcon_paginator/#paginator-adapter-abstractadapter
[paginator-adapter-adapterinterface]: /4.2/api/phalcon_paginator/#paginator-adapter-adapterinterface
[paginator-adapter-model]: /4.2/api/phalcon_paginator/#paginator-adapter-model
[paginator-adapter-nativearray]: /4.2/api/phalcon_paginator/#paginator-adapter-nativearray
[paginator-adapter-querybuilder]: /4.2/api/phalcon_paginator/#paginator-adapter-querybuilder
[paginator-exception]: /4.2/api/phalcon_paginator/#paginator-exception
[paginator-paginatorfactory]: /4.2/api/phalcon_paginator/#paginator-paginatorfactory
[paginator-repository]: /4.2/api/phalcon_paginator/#paginator-repository
[paginator-repositoryinterface]: /4.2/api/phalcon_paginator/#paginator-repositoryinterface

Source: https://docs.phalcon.io/4.2/pagination/index.mdx
