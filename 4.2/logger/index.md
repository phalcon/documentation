...
### `load()`
[Phalcon\Logger\LoggerFactory][logger-loggerfactory] offers the `load` method, that constructs a logger based on supplied configuration. The configuration can be an array or a [Phalcon\Config](/4.2/config/) object. 
...
[logger-logger]: /4.2/api/phalcon_logger/#logger-logger
[logger-adapter-noop]: /4.2/api/phalcon_logger/#logger-adapter-noop
[logger-adapter-stream]: /4.2/api/phalcon_logger/#logger-adapter-stream
[logger-adapter-syslog]: /4.2/api/phalcon_logger/#logger-adapter-syslog
[logger-loggerfactory]: /4.2/api/phalcon_logger/#logger-loggerfactory
[logger-adapterfactory]: /4.2/api/phalcon_logger/#logger-adapterfactory
[logger-formatter-line]: /4.2/api/phalcon_logger/#logger-formatter-line
[logger-formatter-json]: /4.2/api/phalcon_logger/#logger-formatter-json
[logger-formatter-syslog]: /4.2/api/phalcon_logger/#logger-formatter-syslog
[logger-formatter-formatterinterface]: /4.2/api/phalcon_logger/#logger-formatter-formatterinterface
[logger-adapter-adapterinterface]: /4.2/api/phalcon_logger/#logger-adapter-adapterinterface
[logger-formatter-abstractformatter]: /4.2/api/phalcon_logger/#logger-formatter-abstractformatter
[logger-adapter-abstractadapter]: /4.2/api/phalcon_logger/#logger-adapter-abstractadapter
[logger-exception]: /4.2/api/phalcon_logger/#logger-exception
[logger-item]: /4.2/api/phalcon_logger/#logger-item
[psr-3]: https://www.php-fig.org/psr/psr-3/
[stream-wrappers]: https://php.net/manual/en/wrappers.php

Source: https://docs.phalcon.io/4.2/logger/index.mdx
