---
title: "Access Control Lists (acl.md)"
version: "4.2"
---
...
## Events
[Phalcon\Acl][acl-acl] can work in conjunction with the [Events Manager](/4.2/events/) if present, to fire events to your application. Events are triggered using the type `acl`. Events that return `false` can stop the active role. The following events are available:
...
[acl-acl]: /4.2/api/phalcon_acl/
[acl-adapter-abstractadapter]: /4.2/api/phalcon_acl/#acl-adapter-abstractadapter
[acl-adapter-adapterinterface]: /4.2/api/phalcon_acl/#acl-adapter-adapterinterface
[acl-adapter-memory]: /4.2/api/phalcon_acl/#acl-adapter-memory
[acl-component]: /4.2/api/phalcon_acl/#acl-component
[acl-componentaware]: /4.2/api/phalcon_acl/#acl-componentaware
[acl-componentinterface]: /4.2/api/phalcon_acl/#acl-componentinterface
[acl-enum]: /4.2/api/phalcon_acl/#acl-enum
[acl-exception]: /4.2/api/phalcon_acl/#acl-exception
[acl-role]: /4.2/api/phalcon_acl/#acl-role
[acl-roleaware]: /4.2/api/phalcon_acl/#acl-roleaware
[acl-roleinterface]: /4.2/api/phalcon_acl/#acl-roleinterface
[codeception]: https://codeception.com
[whitelist]: https://en.wikipedia.org/wiki/Whitelisting

Source: https://docs.phalcon.io/4.2/acl/index.mdx
