...
:::info[NOTE]
Check our [routing](/4.2/routing/) document for more information for the [Phalcon\Mvc\Router][mvc-router]
:::
...
### Rewrite Rules
In order for routes to work, your web server needs to be configured with specific instructions. Please refer to the [webserver setup](/4.2/webserver-setup/) document for more information.
...
Lastly you need the [Phalcon\Url](/4.2/url/) component to generate URLs for the named routes.
...
## Events
A [Phalcon\Mvc\Micro][mvc-micro] application works closely with an [Events Manager](/4.2/events/) if it is present, to trigger events that can be used throughout our application. The type of those events is `micro`. These events trigger in our application and can be attached to relevant handlers that will perform actions needed by our application.
...
[http-response]: /4.2/api/phalcon_http/#http-response
[http-responseinterface]: /4.2/api/phalcon_http/#http-responseinterface
[mvc-application]: /4.2/api/phalcon_mvc/#mvc-application
[mvc-application-exception]: /4.2/api/phalcon_mvc/#mvc-application-exception
[mvc-controller]: /4.2/api/phalcon_mvc/#mvc-controller
[mvc-model-binder]: /4.2/api/phalcon_mvc/#mvc-model-binder
[mvc-micro]: /4.2/api/phalcon_mvc/#mvc-micro
[mvc-micro-collection]: /4.2/api/phalcon_mvc/#mvc-micro-collection
[mvc-micro-collectioninterface]: /4.2/api/phalcon_mvc/#mvc-micro-collectioninterface
[mvc-micro-exception]: /4.2/api/phalcon_mvc/#mvc-micro-exception
[mvc-micro-lazyloader]: /4.2/api/phalcon_mvc/#mvc-micro-lazyloader
[mvc-micro-middlewareinterface]: /4.2/api/phalcon_mvc/#mvc-micro-middlewareinterface
[mvc-router]: /4.2/api/phalcon_mvc/#mvc-router
[mvc-view]: /4.2/api/phalcon_mvc/#mvc-view
[mvc-view-simple]: /4.2/api/phalcon_mvc/#mvc-view-simple
[psr-15]: https://www.php-fig.org/psr/psr-15/

Source: https://docs.phalcon.io/4.2/application-micro/index.mdx
