...
The special `validation` event allows us to call built-in validators on the record. Phalcon exposes additional built-in validators that can be used at this stage of validation. All validators available are under the [Phalcon\Validation](/4.2/validation/) namespace.
...
:::warning[NOTE]
For more information on validators, see the [Validation documentation](/4.2/validation/)
:::
...
## Custom
The [validation](/4.2/validation/) document explains in detail how you can create your own validators. You can use such validators and reuse them among several models. A validator also can be as simple as:
...
Source: https://docs.phalcon.io/4.2/db-models-validation/index.mdx
