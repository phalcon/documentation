...
### Routing
If you are using the [Router](/4.2/routing/) with its default behavior, your application is able to match routes based on the following pattern: 
...
You can also use `$_SERVER['REQUEST_URI']`. This requires a bit more work, since we need to utilize the [Router](/4.2/routing/) component to populate the `$_SERVER['REQUEST_URI']`. Our routes setup needs to change to:
...
[url]: /4.2/api/phalcon_url/#url
[url-exception]: /4.2/api/phalcon_url/#url-exception
[urlinterface]: /4.2/api/phalcon_url/#urlinterface
[factorydefault]: /4.2/api/phalcon_di/#di-factorydefault

Source: https://docs.phalcon.io/4.2/url/index.mdx
