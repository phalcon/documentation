...
[mvc-model-transaction]: /4.2/api/phalcon_mvc/#mvc-model-transaction
[mvc-model-transaction-exception]: /4.2/api/phalcon_mvc/#mvc-model-transaction-exception
[mvc-model-transaction-failed]: /4.2/api/phalcon_mvc/#mvc-model-transaction-failed
[mvc-model-transaction-manager]: /4.2/api/phalcon_mvc/#mvc-model-transaction-manager
[mvc-model-transaction-managerinterface]: /4.2/api/phalcon_mvc/#mvc-model-transaction-managerinterface
[mvc-model-transactioninterface]: /4.2/api/phalcon_mvc/#mvc-model-transactioninterface

Source: https://docs.phalcon.io/4.2/db-models-transactions/index.mdx
