...
:::info[NOTE]
This setting can be set globally for all models. Please refer to the [models](/4.2/db-models/) document for a how to and additional settings.
:::
...
## Caching
PHQL queries can be cached. You can also check the [Models Caching](/4.2/db-models-cache/) document for more information.
...
[db-models]: /4.2/db-models/

Source: https://docs.phalcon.io/4.2/db-phql/index.mdx
