...
### Callback                        
By using [Phalcon\Validation\Validator\Callback][validation-validator-callback] you can execute custom function which must return boolean or new validator class which will be used to validate the same field. By returning `true` validation will be successful, returning `false` will mean validation failed. When executing this validator Phalcon will pass data depending what it is - if it's an entity (i.e. a model, a `stdClass` etc.) then entity will be passed, otherwise data (i.e an array like `$_POST`). There is example:
...
Filtering and sanitizing is performed using the [filter](/4.2/filter/) component. You can add more filters to this component or use the built-in ones.
...
[messages-message]: /4.2/api/phalcon_messages/#messages-message
[messages-messages]: /4.2/api/phalcon_messages/#messages-messages
[validation]: /4.2/api/phalcon_validation/#validation
[validation-abstractcombinedfieldsvalidator]: /4.2/api/phalcon_validation/#validation-abstractcombinedfieldsvalidator
[validation-abstractvalidator]: /4.2/api/phalcon_validation/#validation-abstractvalidator
[validation-abstractvalidatorcomposite]: /4.2/api/phalcon_validation/#validation-abstractvalidatorcomposite
[validation-exception]: /4.2/api/phalcon_validation/#validation-exception
[validation-validationinterface]: /4.2/api/phalcon_validation/#validation-validationinterface
[validation-validator-alnum]: /4.2/api/phalcon_validation/#validation-validator-alnum
[validation-validator-alpha]: /4.2/api/phalcon_validation/#validation-validator-alpha
[validation-validator-between]: /4.2/api/phalcon_validation/#validation-validator-between
[validation-validator-callback]: /4.2/api/phalcon_validation/#validation-validator-callback
[validation-validator-confirmation]: /4.2/api/phalcon_validation/#validation-validator-confirmation
[validation-validator-creditcard]: /4.2/api/phalcon_validation/#validation-validator-creditcard
[validation-validator-date]: /4.2/api/phalcon_validation/#validation-validator-date
[validation-validator-digit]: /4.2/api/phalcon_validation/#validation-validator-digit
[validation-validator-email]: /4.2/api/phalcon_validation/#validation-validator-email
[validation-validator-exception]: /4.2/api/phalcon_validation/#validation-validator-exception
[validation-validator-exclusionin]: /4.2/api/phalcon_validation/#validation-validator-exclusionin
[validation-validator-file]: /4.2/api/phalcon_validation/#validation-validator-file
[validation-validator-file-abstractfile]: /4.2/api/phalcon_validation/#validation-validator-file-abstractfile
[validation-validator-file-mimetype]: /4.2/api/phalcon_validation/#validation-validator-file-mimetype
[validation-validator-file-resolution-equal]: /4.2/api/phalcon_validation/#validation-validator-file-resolution-equal
[validation-validator-file-resolution-max]: /4.2/api/phalcon_validation/#validation-validator-file-resolution-max
[validation-validator-file-resolution-min]: /4.2/api/phalcon_validation/#validation-validator-file-resolution-min
[validation-validator-file-size-equal]: /4.2/api/phalcon_validation/#validation-validator-file-size-equal
[validation-validator-file-size-max]: /4.2/api/phalcon_validation/#validation-validator-file-size-max
[validation-validator-file-size-min]: /4.2/api/phalcon_validation/#validation-validator-file-size-min
[validation-validator-identical]: /4.2/api/phalcon_validation/#validation-validator-identical
[validation-validator-inclusionin]: /4.2/api/phalcon_validation/#validation-validator-inclusionin
[validation-validator-ip]: /4.2/api/phalcon_validation/#validation-validator-ip
[validation-validator-numericality]: /4.2/api/phalcon_validation/#validation-validator-numericality
[validation-validator-presenceof]: /4.2/api/phalcon_validation/#validation-validator-presenceof
[validation-validator-regex]: /4.2/api/phalcon_validation/#validation-validator-regex
[validation-validator-stringlength]: /4.2/api/phalcon_validation/#validation-validator-stringlength
[validation-validator-stringlength-max]: /4.2/api/phalcon_validation/#validation-validator-stringlength-max
[validation-validator-stringlength-min]: /4.2/api/phalcon_validation/#validation-validator-stringlength-min
[validation-validator-uniqueness]: /4.2/api/phalcon_validation/#validation-validator-uniqueness
[validation-validator-url]: /4.2/api/phalcon_validation/#validation-validator-url
[validation-validatorcompositeinterface]: /4.2/api/phalcon_validation/#validation-validatorcompositeinterface
[validation-validatorfactory]: /4.2/api/phalcon_validation/#validation-validatorfactory
[validation-validatorinterface]: /4.2/api/phalcon_validation/#validation-validatorinterface

Source: https://docs.phalcon.io/4.2/validation/index.mdx
