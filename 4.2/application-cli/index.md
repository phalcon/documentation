...
For more information regarding routes and the route classes, you can check the [Routing](/4.2/routing/) page.

## Events
CLI applications are also [events](/4.2/events/) aware. You can use the `setEventsManager` and `getEventsManager` methods to access the events manager. 
...
[cli-console]: /4.2/api/phalcon_cli/#cli-console
[cli-console-exception]: /4.2/api/phalcon_cli/#cli-console-exception
[cli-dispatcher]: /4.2/api/phalcon_cli/#cli-dispatcher
[cli-dispatcher-exception]: /4.2/api/phalcon_cli/#cli-dispatcher-exception
[cli-dispatcherinterface]: /4.2/api/phalcon_cli/#cli-dispatcherinterface
[cli-router]: /4.2/api/phalcon_cli/#cli-router
[cli-router-exception]: /4.2/api/phalcon_cli/#cli-router-exception
[cli-router-route]: /4.2/api/phalcon_cli/#cli-router-route
[cli-router-routeinterface]: /4.2/api/phalcon_cli/#cli-router-routeinterface
[cli-routerinterface]: /4.2/api/phalcon_cli/#cli-routerinterface
[cli-task]: /4.2/api/phalcon_cli/#cli-task
[cli-taskinterface]: /4.2/api/phalcon_cli/#cli-taskinterface
[di]: /4.2/api/phalcon_di/#di
[di-factorydefault-cli]: /4.2/api/phalcon_di/#di-factorydefault-cli

Source: https://docs.phalcon.io/4.2/application-cli/index.mdx
