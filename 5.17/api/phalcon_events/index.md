...
- [`Phalcon\Acl\Adapter\AbstractAdapter`](/5.17/api/phalcon_acl/#acladapterabstractadapter)
- [`Phalcon\Auth\Guard\AbstractGuard`](/5.17/api/phalcon_auth/#authguardabstractguard)
- [`Phalcon\Autoload\Loader`](/5.17/api/phalcon_autoload/#autoloadloader)
- [`Phalcon\Queue\Consumer\QueueConsumer`](/5.17/api/phalcon_queue/#queueconsumerqueueconsumer)
...
- **`Phalcon\Events\Event`** - implements [`Phalcon\Events\EventInterface`](#eventseventinterface), [`Phalcon\Contracts\Events\Stoppable`](/5.17/api/phalcon_contracts/#contractseventsstoppable)
...
- [`Phalcon\Contracts\Events\Event`](/5.17/api/phalcon_contracts/#contractseventsevent)
- **`Phalcon\Events\EventInterface`**
...
- [`Phalcon\Contracts\Events\EventsAware`](/5.17/api/phalcon_contracts/#contractseventseventsaware)
- **`Phalcon\Events\EventsAwareInterface`**
...
- [`Phalcon\Contracts\Events\Manager`](/5.17/api/phalcon_contracts/#contractseventsmanager)
- **`Phalcon\Events\ManagerInterface`**
...
Source: https://docs.phalcon.io/5.17/api/phalcon_events/index.mdx
