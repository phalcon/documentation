...
- **`Phalcon\Application\AbstractApplication`** - implements [`Phalcon\Events\EventsAwareInterface`](/5.17/api/phalcon_events/#eventseventsawareinterface)
- [`Phalcon\Cli\Console`](/5.17/api/phalcon_cli/#cliconsole)
- [`Phalcon\Mvc\Application`](/5.17/api/phalcon_mvc/#mvcapplication)
...
- [`Phalcon\Cli\Console\Exception`](/5.17/api/phalcon_cli/#cliconsoleexception)
- [`Phalcon\Mvc\Application\Exception`](/5.17/api/phalcon_mvc/#mvcapplicationexception)
...
Source: https://docs.phalcon.io/5.17/api/phalcon_application/index.mdx
