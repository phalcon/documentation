...
Phalcon v5.17 supports only PHP 8.1 and above.
...
* [fileinfo][fileinfo]
* [gettext][gettext]
* [gd2][gd2] (to use the [Phalcon\Image\Adapter\Gd](/5.17/api/phalcon_image/#imageadaptergd) class)
* [imagick][imagick] (to use the [Phalcon\Image\Adapter\Imagick](/5.17/api/phalcon_image/#imageadapterimagick) class)
* [json][json]
...
:::warning[WARNING]
To install phalcon with PIE you will need at least 4GB of RAM, otherwise the build will fail.
:::
...
Installing Phalcon after that is done with:
...
Source: https://docs.phalcon.io/5.17/installation/index.mdx
