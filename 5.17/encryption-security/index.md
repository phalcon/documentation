...
[security]: /5.17/api/phalcon_encryption/#encryptionsecurity
[security-exception]: /5.17/api/phalcon_encryption/#encryptionsecurityexception
[security-random]: /5.17/api/phalcon_encryption/#encryptionsecurityrandom
[security-uuid]: /5.17/api/phalcon_encryption/#encryptionsecurityuuid
[security-uuid-interface]: /5.17/api/phalcon_encryption/#encryptionsecurityuuiduuidinterface
[sha1]: https://php.net/manual/en/function.sha1.php
[wiki-csrf]: https://en.wikipedia.org/wiki/Cross-site_request_forgery

Source: https://docs.phalcon.io/5.17/encryption-security/index.mdx
