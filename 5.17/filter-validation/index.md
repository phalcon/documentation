...
[messages-message]: /5.17/api/phalcon_messages/#messagesmessage
[messages-messages]: /5.17/api/phalcon_messages/#messagesmessages
[validation]: /5.17/api/phalcon_filter/#filtervalidation
[validation-abstractcombinedfieldsvalidator]: /5.17/api/phalcon_filter/#filtervalidationabstractcombinedfieldsvalidator
[validation-abstractvalidator]: /5.17/api/phalcon_filter/#filtervalidationabstractvalidator
[validation-abstractvalidatorcomposite]: /5.17/api/phalcon_filter/#filtervalidationabstractvalidatorcomposite
[validation-exception]: /5.17/api/phalcon_filter/#filtervalidationexception
[validation-validationinterface]: /5.17/api/phalcon_filter/#filtervalidationvalidationinterface
[validation-validator-alnum]: /5.17/api/phalcon_filter/#filtervalidationvalidatoralnum
[validation-validator-alpha]: /5.17/api/phalcon_filter/#filtervalidationvalidatoralpha
[validation-validator-between]: /5.17/api/phalcon_filter/#filtervalidationvalidatorbetween
[validation-validator-callback]: /5.17/api/phalcon_filter/#filtervalidationvalidatorcallback
[validation-validator-confirmation]: /5.17/api/phalcon_filter/#filtervalidationvalidatorconfirmation
[validation-validator-creditcard]: /5.17/api/phalcon_filter/#filtervalidationvalidatorcreditcard
[validation-validator-date]: /5.17/api/phalcon_filter/#filtervalidationvalidatordate
[validation-validator-digit]: /5.17/api/phalcon_filter/#filtervalidationvalidatordigit
[validation-validator-email]: /5.17/api/phalcon_filter/#filtervalidationvalidatoremail
[validation-validator-exception]: /5.17/api/phalcon_filter/#filtervalidationvalidatorexception
[validation-validator-exclusionin]: /5.17/api/phalcon_filter/#filtervalidationvalidatorexclusionin
[validation-validator-file]: /5.17/api/phalcon_filter/#filtervalidationvalidatorfile
[validation-validator-file-abstractfile]: /5.17/api/phalcon_filter/#filtervalidationvalidatorfileabstractfile
[validation-validator-file-mimetype]: /5.17/api/phalcon_filter/#filtervalidationvalidatorfilemimetype
[validation-validator-file-resolution-aspectratio]: /5.17/api/phalcon_filter/#filtervalidationvalidatorfileresolutionaspectratio
[validation-validator-file-resolution-equal]: /5.17/api/phalcon_filter/#filtervalidationvalidatorfileresolutionequal
[validation-validator-file-resolution-max]: /5.17/api/phalcon_filter/#filtervalidationvalidatorfileresolutionmax
[validation-validator-file-resolution-min]: /5.17/api/phalcon_filter/#filtervalidationvalidatorfileresolutionmin
[validation-validator-file-size-equal]: /5.17/api/phalcon_filter/#filtervalidationvalidatorfilesizeequal
[validation-validator-file-size-max]: /5.17/api/phalcon_filter/#filtervalidationvalidatorfilesizemax
[validation-validator-file-size-min]: /5.17/api/phalcon_filter/#filtervalidationvalidatorfilesizemin
[validation-validator-files]: /5.17/api/phalcon_filter/#filtervalidationvalidatorfiles
[validation-validator-identical]: /5.17/api/phalcon_filter/#filtervalidationvalidatoridentical
[validation-validator-inclusionin]: /5.17/api/phalcon_filter/#filtervalidationvalidatorinclusionin
[validation-validator-ip]: /5.17/api/phalcon_filter/#filtervalidationvalidatorip
[validation-validator-numericality]: /5.17/api/phalcon_filter/#filtervalidationvalidatornumericality
[validation-validator-presenceof]: /5.17/api/phalcon_filter/#filtervalidationvalidatorpresenceof
[validation-validator-regex]: /5.17/api/phalcon_filter/#filtervalidationvalidatorregex
[validation-validator-stringlength]: /5.17/api/phalcon_filter/#filtervalidationvalidatorstringlength
[validation-validator-stringlength-max]: /5.17/api/phalcon_filter/#filtervalidationvalidatorstringlengthmax
[validation-validator-stringlength-min]: /5.17/api/phalcon_filter/#filtervalidationvalidatorstringlengthmin
[validation-validator-uniqueness]: /5.17/api/phalcon_filter/#filtervalidationvalidatoruniqueness
[validation-validator-url]: /5.17/api/phalcon_filter/#filtervalidationvalidatorurl
[validation-validatorcompositeinterface]: /5.17/api/phalcon_filter/#filtervalidationvalidatorcompositeinterface
[validation-validatorfactory]: /5.17/api/phalcon_filter/#filtervalidationvalidatorfactory
[validation-validatorinterface]: /5.17/api/phalcon_filter/#filtervalidationvalidatorinterface

Source: https://docs.phalcon.io/5.17/filter-validation/index.mdx
