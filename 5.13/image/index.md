...
As of 5.13.1 the component raises granular subclasses of `Phalcon\Image\Exception` so callers can catch a specific
...
[image-adapter-abstractadapter]: /5.13/api/phalcon_image/#imageadapterabstractadapter

[image-adapter-adapterinterface]: /5.13/api/phalcon_image/#imageadapteradapterinterface

[image-adapter-gd]: /5.13/api/phalcon_image/#imageadaptergd

[image-adapter-imagick]: /5.13/api/phalcon_image/#imageadapterimagick

[image-enum]: /5.13/api/phalcon_image/#imageenum

[image-exception]: /5.13/api/phalcon_image/#imageexception

[image-imagefactory]: /5.13/api/phalcon_image/#imageimagefactory

[imagick-liquidrescale]: https://www.php.net/manual/en/imagick.liquidrescaleimage.php

[config]: /5.13/config/

Source: https://docs.phalcon.io/5.13/image/index.mdx
