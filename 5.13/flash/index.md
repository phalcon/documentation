...
|---------------------------------------------------------|---------------------------|----------------------------------------------------------------------------------------|
| `Phalcon\Flash\Exceptions\EscaperServiceUnavailable`    | `Phalcon\Flash\Exception` | The component requires the `escaper` service but the DI container has none registered. |
...
[flash-abstractflash]: /5.13/api/phalcon_flash/#flashabstractflash

[flash-direct]: /5.13/api/phalcon_flash/#flashdirect

[flash-exception]: /5.13/api/phalcon_flash/#flashexception

[flash-flashinterface]: /5.13/api/phalcon_flash/#flashflashinterface

[flash-session]: /5.13/api/phalcon_flash/#flashsession
...
Source: https://docs.phalcon.io/5.13/flash/index.mdx
