...
only collects this information and then forwards it to the [Phalcon\Mvc\Dispatcher](/5.13/dispatcher/) which executes them.
...
the [dispatcher](/5.13/dispatcher/)
...
an [Events Manager](/5.13/events/) is present. The available events are:
...
[config-factory]: /5.13/api/phalcon_config/#configconfigfactory

[config-interface]: /5.13/api/phalcon_config/#configconfiginterface

[mvc-router]: /5.13/api/phalcon_mvc/#mvcrouter

[mvc-router-annotations]: /5.13/api/phalcon_mvc/#mvcrouterannotations

[mvc-router-exception]: /5.13/api/phalcon_mvc/#mvcrouterexception

[mvc-router-factory]: /5.13/api/phalcon_mvc/#mvcrouterrouterfactory

[mvc-router-group]: /5.13/api/phalcon_mvc/#mvcroutergroup

[mvc-router-groupinterface]: /5.13/api/phalcon_mvc/#mvcroutergroupinterface

[mvc-router-route]: /5.13/api/phalcon_mvc/#mvcrouterroute

[mvc-router-routeinterface]: /5.13/api/phalcon_mvc/#mvcrouterrouteinterface

[mvc-routerinterface]: /5.13/api/phalcon_mvc/#mvcrouterinterface
...
Source: https://docs.phalcon.io/5.13/routing/index.mdx
