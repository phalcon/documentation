...
As of 5.13.1 the component raises granular subclasses of `Phalcon\Logger\Exception` so callers can catch a specific
...
[config]: /5.13/api/phalcon_config/#configconfig

[factorydefault]: /5.13/api/phalcon_di/#difactorydefault

[logger-logger]: /5.13/api/phalcon_logger/#loggerlogger

[logger-abstractlogger]: /5.13/api/phalcon_logger/#loggerabstractlogger

[logger-adapter-noop]: /5.13/api/phalcon_logger/#loggeradapternoop

[logger-adapter-stream]: /5.13/api/phalcon_logger/#loggeradapterstream

[logger-adapter-syslog]: /5.13/api/phalcon_logger/#loggeradaptersyslog

[logger-loggerfactory]: /5.13/api/phalcon_logger/#loggerloggerfactory

[logger-adapterfactory]: /5.13/api/phalcon_logger/#loggeradapterfactory

[logger-formatter-line]: /5.13/api/phalcon_logger/#loggerformatterline

[logger-formatter-json]: /5.13/api/phalcon_logger/#loggerformatterjson

[logger-formatter-formatterinterface]: /5.13/api/phalcon_logger/#loggerformatterformatterinterface

[logger-adapter-adapterinterface]: /5.13/api/phalcon_logger/#loggeradapteradapterinterface

[logger-formatter-abstractformatter]: /5.13/api/phalcon_logger/#loggerformatterabstractformatter

[logger-adapter-abstractadapter]: /5.13/api/phalcon_logger/#loggeradapterabstractadapter

[logger-exception]: /5.13/api/phalcon_logger/#loggerexception

[logger-item]: /5.13/api/phalcon_logger/#loggeritem
...
Source: https://docs.phalcon.io/5.13/logger/index.mdx
