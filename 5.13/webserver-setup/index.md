...
the [Phalcon Devtools](/5.13/devtools/), then you can start the web server with the following command:
...
the [router component](/5.13/routing/). A common directory structure for an application is:
...
Source: https://docs.phalcon.io/5.13/webserver-setup/index.mdx
