...
As of 5.13.1 the component raises granular subclasses of `Phalcon\Support\Exception` so callers can catch a specific
...
[contracts-support-collection]: /5.13/api/phalcon_contracts/#contractssupportcollection

Source: https://docs.phalcon.io/5.13/support-collection/index.mdx
