...
|-------------------------------------------------------------------|-------------------------------------|--------------------------------------------------------------------------------------|
| `Phalcon\Application\Exceptions\ModuleNotRegistered`              | `Phalcon\Application\Exception`     | A module name passed to `getModule()` was never registered with `registerModules()`. |
...
[application-abstractapplication]: /5.13/api/phalcon_application/#applicationabstractapplication

[application-exception]: /5.13/api/phalcon_application/#applicationexception
...
[mvc-moduledefinitioninterface]: /5.13/api/phalcon_mvc/#mvcmoduledefinitioninterface

[mvc-examples]: https://github.com/phalcon/mvc

[events]: /5.13/events/

Source: https://docs.phalcon.io/5.13/application/index.mdx
