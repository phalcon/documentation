...
|------------|-------------------------------------------------------|
| Docker Hub | `docker pull phalconphp/cphalcon:v5.13.0-php8.4`      |   
| GitHub     | `docker pull ghcr.io/phalcon/cphalcon:v5.13.0-php8.4` |
...
```dockerfile
FROM phalconphp/cphalcon:v5.13.0-php8.4
...
Source: https://docs.phalcon.io/5.13/environments-docker/index.mdx
