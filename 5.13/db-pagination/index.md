...
As of 5.13.1 the component raises granular subclasses of `Phalcon\Paginator\Exception` so callers can catch a specific
...
[paginator-adapter-abstractadapter]: /5.13/api/phalcon_paginator/#paginatoradapterabstractadapter

[paginator-adapter-adapterinterface]: /5.13/api/phalcon_paginator/#paginatoradapteradapterinterface

[paginator-adapter-model]: /5.13/api/phalcon_paginator/#paginatoradaptermodel

[paginator-adapter-nativearray]: /5.13/api/phalcon_paginator/#paginatoradapternativearray

[paginator-adapter-querybuilder]: /5.13/api/phalcon_paginator/#paginatoradapterquerybuilder

[paginator-adapter-querybuildercursor]: /5.13/api/phalcon_paginator/#paginatoradapterquerybuildercursor

[paginator-exception]: /5.13/api/phalcon_paginator/#paginatorexception

[paginator-paginatorfactory]: /5.13/api/phalcon_paginator/#paginatorpaginatorfactory

[paginator-repository]: /5.13/api/phalcon_paginator/#paginatorrepository

[paginator-repositoryinterface]: /5.13/api/phalcon_paginator/#paginatorrepositoryinterface

[config]: /5.13/config/

Source: https://docs.phalcon.io/5.13/db-pagination/index.mdx
