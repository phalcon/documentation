...
As of 5.13.1 the component raises granular subclasses of `Phalcon\Mvc\Url\Exception` so callers can catch a specific
...
[url-exception]: /5.13/api/phalcon_mvc/#mvcurlexception

[url-interface]: /5.13/api/phalcon_mvc/#mvcurlurlinterface
...
Source: https://docs.phalcon.io/5.13/mvc-url/index.mdx
