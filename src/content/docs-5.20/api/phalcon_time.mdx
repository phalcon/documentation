...
<SourceLink href="https://github.com/phalcon/cphalcon/blob/5.0.x/phalcon/Time/Clock/ClockInterface.zep" />
...
<SourceLink href="https://github.com/phalcon/cphalcon/blob/5.0.x/phalcon/Time/Clock/Exception.zep" />
...
<ApiBadge variant="class">Class</ApiBadge>
<SourceLink href="https://github.com/phalcon/cphalcon/blob/5.0.x/phalcon/Time/Clock/Exceptions/InvalidModifier.zep" />
...
<ApiUses>`Phalcon\Time\Clock\Exception` · `Throwable`</ApiUses>
...
<SourceLink href="https://github.com/phalcon/cphalcon/blob/5.0.x/phalcon/Time/Clock/FrozenClock.zep" />
...
<ApiUses>`DateTimeImmutable` · `DateTimeZone` · `Phalcon\Time\Clock\Exceptions\InvalidModifier` · `Throwable`</ApiUses>
...
<ApiBadge variant="final">Final</ApiBadge>
<SourceLink href="https://github.com/phalcon/cphalcon/blob/5.0.x/phalcon/Time/Clock/SystemClock.zep" />
...
<ApiUses>`DateTimeImmutable` · `DateTimeZone`</ApiUses>
