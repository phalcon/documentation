...
<SourceLink href="https://github.com/phalcon/phalcon/blob/v6.0.x/src/Autoload/Exception.php" />
...
<ApiBadge variant="class">Class</ApiBadge>
<SourceLink href="https://github.com/phalcon/phalcon/blob/v6.0.x/src/Autoload/Exceptions/LoaderDirectoriesNotArray.php" />
...
<ApiBadge variant="class">Class</ApiBadge>
<SourceLink href="https://github.com/phalcon/phalcon/blob/v6.0.x/src/Autoload/Exceptions/LoaderMethodNotCallable.php" />
...
<ApiBadge variant="class">Class</ApiBadge>
<SourceLink href="https://github.com/phalcon/phalcon/blob/v6.0.x/src/Autoload/Loader.php" />
...
<ApiUses>`Phalcon\Autoload\Exceptions\LoaderDirectoriesNotArray` · `Phalcon\Autoload\Exceptions\LoaderMethodNotCallable` · `Phalcon\Contracts\Autoload\AutoloadTypes` · `Phalcon\Events\Exception` · `Phalcon\Events\Traits\EventsAwareTrait` · `Phalcon\Traits\Support\Helper\Str\StartsWithTrait`</ApiUses>
