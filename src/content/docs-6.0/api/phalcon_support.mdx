...
<ApiUsedBy>[`Phalcon\Mvc\Model\MetaData\Stream`](/6.0/api/phalcon_mvc/#mvcmodelmetadatastream) · [`Phalcon\Mvc\View\Engine\Volt\Compiler`](/6.0/api/phalcon_mvc/#mvcviewenginevoltcompiler) · [`Phalcon\Storage\Adapter\Stream`](/6.0/api/phalcon_storage/#storageadapterstream)</ApiUsedBy>
