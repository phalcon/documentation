...
<SourceLink href="https://github.com/phalcon/phalcon/blob/v6.0.x/src/Flash/Traits/FlashGettersTrait.php" />
...
<ApiUses>`Phalcon\Html\Escaper\EscaperInterface` · `Phalcon\Session\ManagerInterface`</ApiUses>

<ApiUsedBy>[`Phalcon\Flash\AbstractFlash`](#flashabstractflash)</ApiUsedBy>
