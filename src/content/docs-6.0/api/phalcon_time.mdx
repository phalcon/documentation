...
<SourceLink href="https://github.com/phalcon/phalcon/blob/v6.0.x/src/Time/Clock/ClockInterface.php" />
...
<SourceLink href="https://github.com/phalcon/phalcon/blob/v6.0.x/src/Time/Clock/Exception.php" />
...
<ApiBadge variant="class">Class</ApiBadge>
<SourceLink href="https://github.com/phalcon/phalcon/blob/v6.0.x/src/Time/Clock/Exceptions/InvalidModifier.php" />
...
<SourceLink href="https://github.com/phalcon/phalcon/blob/v6.0.x/src/Time/Clock/FrozenClock.php" />
...
<ApiBadge variant="final">Final</ApiBadge>
<SourceLink href="https://github.com/phalcon/phalcon/blob/v6.0.x/src/Time/Clock/SystemClock.php" />
