...
[mvc-model-exceptions-invalideagerparameter]: /5.22/api/phalcon_mvc/#mvcmodelexceptionsinvalideagerparameter
[mvc-model-exceptions-invalideagerpath]: /5.22/api/phalcon_mvc/#mvcmodelexceptionsinvalideagerpath
[mvc-model-exceptions-missingeagerkeycolumn]: /5.22/api/phalcon_mvc/#mvcmodelexceptionsmissingeagerkeycolumn
[mvc-model-exceptions-unknowneagerrelation]: /5.22/api/phalcon_mvc/#mvcmodelexceptionsunknowneagerrelation
[mvc-model-exceptions-unsupportedeagerhydration]: /5.22/api/phalcon_mvc/#mvcmodelexceptionsunsupportedeagerhydration
[mvc-model-exceptions-unsupportedeageroption]: /5.22/api/phalcon_mvc/#mvcmodelexceptionsunsupportedeageroption
[mvc-model-relation]: /5.22/api/phalcon_mvc/#mvcmodelrelation
[mvc-model-row]: /5.22/api/phalcon_mvc/#mvcmodelrow

Source: https://docs.phalcon.io/5.22/db-models-relationships/index.mdx
