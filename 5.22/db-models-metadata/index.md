...
As of 5.22 the same columns can be described with PHP attributes. `Phalcon\Annotations\Models\MetaData` holds one class for each annotation of the table above. The strategy reads the two forms and produces the same metadata.
...
Four parameter names are different, because a PHP parameter name cannot be snake_case under PSR-12, and `default` is a reserved word of the Zephir language that builds the extension. The strategy reads the two spellings of each pair, so an existing docblock keeps its behavior.
...
[annotations]: /5.22/annotations/
[apcu]: https://www.php.net/manual/en/book.apcu.php
[cache-adapter-factory]: /5.22/cache/#adapter-factory
[memcached]: https://www.memcached.org
[mvc-model]: /5.22/api/phalcon_mvc/#mvcmodel
[mvc-model-metadata]: /5.22/api/phalcon_mvc/#mvcmodelmetadata
[mvc-model-metadata-apcu]: /5.22/api/phalcon_mvc/#mvcmodelmetadataapcu
[mvc-model-metadata-libmemcached]: /5.22/api/phalcon_mvc/#mvcmodelmetadatalibmemcached
[mvc-model-metadata-memory]: /5.22/api/phalcon_mvc/#mvcmodelmetadatamemory
[mvc-model-metadata-redis]: /5.22/api/phalcon_mvc/#mvcmodelmetadataredis
[mvc-model-metadata-strategy-annotations]: /5.22/api/phalcon_mvc/#mvcmodelmetadatastrategyannotations
[mvc-model-metadata-strategy-introspection]: /5.22/api/phalcon_mvc/#mvcmodelmetadatastrategyintrospection
[mvc-model-metadata-strategyinterface]: /5.22/api/phalcon_mvc/#mvcmodelmetadatastrategystrategyinterface
[mvc-model-metadata-stream]: /5.22/api/phalcon_mvc/#mvcmodelmetadatastream
[mvc-model-metadatainterface]: /5.22/api/phalcon_mvc/#mvcmodelmetadatainterface
[redis]: https://redis.io

Source: https://docs.phalcon.io/5.22/db-models-metadata/index.mdx
