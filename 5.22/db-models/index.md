...
The value-object classes are described under [Spatial / Geometry Columns](/5.22/db-layer/) in the database-layer documentation.
...
[db-models-relationships]: /5.22/db-models-relationships/
[models-relationships-eager]: /5.22/db-models-relationships/#eager-loading
[cache]: /5.22/cache/
[creating-models]: #creating-models
[db]: /5.22/db-layer/
[db-models-transactions]: /5.22/db-models-transactions/
[db-phql]: /5.22/db-phql/
[db-rawvalue]: /5.22/api/phalcon_db/#dbrawvalue
[DRY]: https://en.wikipedia.org/wiki/Don%27t_repeat_yourself
[events]: /5.22/events/
[finding-records]: #finding-records
[flash]: /5.22/flash/
[mvc-model]: /5.22/api/phalcon_mvc/#mvcmodel
[mvc-model-binder]: /5.22/api/phalcon_mvc/#mvcmodelbinder
[mvc-model-binder-bindableinterface]: /5.22/api/phalcon_mvc/#mvcmodelbinderbindableinterface
[mvc-model-binderinterface]: /5.22/api/phalcon_mvc/#mvcmodelbinderinterface
[mvc-model-criteria]: /5.22/api/phalcon_mvc/#mvcmodelcriteria
[mvc-model-criteriainterface]: /5.22/api/phalcon_mvc/#mvcmodelcriteriainterface
[mvc-model-exception]: /5.22/api/phalcon_mvc/#mvcmodelexception
[mvc-model-manager]: /5.22/api/phalcon_mvc/#mvcmodelmanager
[mvc-model-managerinterface]: /5.22/api/phalcon_mvc/#mvcmodelmanagerinterface
[mvc-model-query]: /5.22/api/phalcon_mvc/#mvcmodelquery
[mvc-model-query-builder]: /5.22/api/phalcon_mvc/#mvcmodelquerybuilder
[mvc-model-query-builderinterface]: /5.22/api/phalcon_mvc/#mvcmodelquerybuilderinterface
[mvc-model-query-lang]: /5.22/api/phalcon_mvc/#mvcmodelquerylang
[mvc-model-query-status]: /5.22/api/phalcon_mvc/#mvcmodelquerystatus
[mvc-model-query-statusinterface]: /5.22/api/phalcon_mvc/#mvcmodelquerystatusinterface
[mvc-model-queryinterface]: /5.22/api/phalcon_mvc/#mvcmodelqueryinterface
[mvc-model-relation]: /5.22/api/phalcon_mvc/#mvcmodelrelation
[mvc-model-relationinterface]: /5.22/api/phalcon_mvc/#mvcmodelrelationinterface
[mvc-model-resultinterface]: /5.22/api/phalcon_mvc/#mvcmodelresultinterface
[mvc-model-resultset]: /5.22/api/phalcon_mvc/#mvcmodelresultset
[mvc-model-resultset-complex]: /5.22/api/phalcon_mvc/#mvcmodelresultsetcomplex
[mvc-model-resultset-simple]: /5.22/api/phalcon_mvc/#mvcmodelresultsetsimple
[mvc-model-resultsetinterface]: /5.22/api/phalcon_mvc/#mvcmodelresultsetinterface
[mvc-model-row]: /5.22/api/phalcon_mvc/#mvcmodelrow
[mvc-model-validationfailed]: /5.22/api/phalcon_mvc/#mvcmodelvalidationfailed
[mvc-modelinterface]: /5.22/api/phalcon_mvc/#mvcmodelinterface
[pdo-statements]: https://php.net/manual/en/pdo.prepared-statements.php
[transactions]: #transactions

Source: https://docs.phalcon.io/5.22/db-models/index.mdx
