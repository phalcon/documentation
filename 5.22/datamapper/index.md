...
[datamapper-pdo-connection]: /5.22/api/phalcon_datamapper/#datamapperpdoconnection
[datamapper-pdo-connection-abstractconnection]: /5.22/api/phalcon_datamapper/#datamapperpdoconnectionabstractconnection
[datamapper-pdo-connection-connectioninterface]: /5.22/api/phalcon_datamapper/#datamapperpdoconnectionconnectioninterface
[datamapper-pdo-connection-decorated]: /5.22/api/phalcon_datamapper/#datamapperpdoconnectiondecorated
[datamapper-pdo-connection-pdointerface]: /5.22/api/phalcon_datamapper/#datamapperpdoconnectionpdointerface
[datamapper-pdo-connectionlocator]: /5.22/api/phalcon_datamapper/#datamapperpdoconnectionlocator
[datamapper-pdo-connectionlocatorinterface]: /5.22/api/phalcon_datamapper/#datamapperpdoconnectionlocatorinterface
[datamapper-pdo-events]: /5.22/api/phalcon_datamapper/#datamapperpdoevents
[datamapper-pdo-exception-cannotdisconnect]: /5.22/api/phalcon_datamapper/#datamapperpdoexceptioncannotdisconnect
[datamapper-pdo-exception-connectionnotfound]: /5.22/api/phalcon_datamapper/#datamapperpdoexceptionconnectionnotfound
[datamapper-pdo-exception-exception]: /5.22/api/phalcon_datamapper/#datamapperpdoexceptionexception
[datamapper-pdo-exception-operationcancelled]: /5.22/api/phalcon_datamapper/#datamapperpdoexceptionoperationcancelled
[datamapper-pdo-profiler-memorylogger]: /5.22/api/phalcon_datamapper/#datamapperpdoprofilermemorylogger
[datamapper-pdo-profiler-profiler]: /5.22/api/phalcon_datamapper/#datamapperpdoprofilerprofiler
[datamapper-pdo-profiler-profilerinterface]: /5.22/api/phalcon_datamapper/#datamapperpdoprofilerprofilerinterface
[datamapper-query-abstractconditions]: /5.22/api/phalcon_datamapper/#datamapperqueryabstractconditions
[datamapper-query-abstractquery]: /5.22/api/phalcon_datamapper/#datamapperqueryabstractquery
[datamapper-query-bind]: /5.22/api/phalcon_datamapper/#datamapperquerybind
[datamapper-query-delete]: /5.22/api/phalcon_datamapper/#datamapperquerydelete
[datamapper-query-insert]: /5.22/api/phalcon_datamapper/#datamapperqueryinsert
[datamapper-query-queryfactory]: /5.22/api/phalcon_datamapper/#datamapperqueryqueryfactory
[datamapper-query-select]: /5.22/api/phalcon_datamapper/#datamapperqueryselect
[datamapper-query-update]: /5.22/api/phalcon_datamapper/#datamapperqueryupdate
[eaa]: https://martinfowler.com/books/eaa.html
[events-manager]: /5.22/api/phalcon_events/#eventsmanager
[logger]: /5.22/logger/

Source: https://docs.phalcon.io/5.22/datamapper/index.mdx
