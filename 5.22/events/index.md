...
[application-micro]: /5.22/application-micro/
[auth]: /5.22/auth/
[autoload]: /5.22/autoload/
[cache]: /5.22/cache/
[contracts-event]: /5.22/api/phalcon_contracts/#contractseventsevent
[contracts-eventsaware]: /5.22/api/phalcon_contracts/#contractseventseventsaware
[contracts-manager]: /5.22/api/phalcon_contracts/#contractseventsmanager
[contracts-stoppable]: /5.22/api/phalcon_contracts/#contractseventsstoppable
[datamapper]: /5.22/datamapper/
[db]: /5.22/api/phalcon_db/
[db-layer]: /5.22/db-layer/
[db-models]: /5.22/db-models/
[di-factorydefaul]: /5.22/api/phalcon_di/#difactorydefault
[di-injectable]: /5.22/api/phalcon_di/#diinjectable
[dispatcher]: /5.22/dispatcher/
[events-event]: /5.22/api/phalcon_events/#eventsevent
[events-eventinterface]: /5.22/api/phalcon_events/#eventseventinterface
[events-eventsawareinterface]: /5.22/api/phalcon_events/#eventseventsawareinterface
[events-exception]: /5.22/api/phalcon_events/#eventsexception
[events-manager]: /5.22/api/phalcon_events/#eventsmanager
[events-managerinterface]: /5.22/api/phalcon_events/#eventsmanagerinterface
[events-subscriber]: /5.22/api/phalcon_contracts/#contractseventssubscriber
...
[storage]: /5.22/storage/
[views]: /5.22/views/
[volt]: /5.22/volt/

Source: https://docs.phalcon.io/5.22/events/index.mdx
