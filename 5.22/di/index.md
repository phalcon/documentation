...
[container]: /5.22/container/
[db-layer]: /5.22/db-layer/
[db-models]: /5.22/db-models/
[db-models-metadata]: /5.22/db-models-metadata/
[db-models-transactions]: /5.22/db-models-transactions/
[di]: /5.22/api/phalcon_di/#didi
[di-abstractinjectionaware]: /5.22/api/phalcon_di/#diabstractinjectionaware
[di-diinterface]: /5.22/api/phalcon_di/#didiinterface
[di-exception]: /5.22/api/phalcon_di/#diexception
[di-exception-serviceresolutionexception]: /5.22/api/phalcon_di/#diexceptionserviceresolutionexception
...
[di-serviceinterface]: /5.22/api/phalcon_di/#diserviceinterface
[di-serviceproviderinterface]: /5.22/api/phalcon_di/#diserviceproviderinterface
[dispatcher]: /5.22/dispatcher/
[encryption-crypt]: /5.22/encryption-crypt/
[encryption-security]: /5.22/encryption-security/
[events]: /5.22/events/
[filter-filter]: /5.22/filter-filter/
[flash]: /5.22/flash/
[html-escaper]: /5.22/html-escaper/
[ioc]: https://en.wikipedia.org/wiki/Inversion_of_control
[mvc-url]: /5.22/mvc-url/
[request]: /5.22/request/
[response]: /5.22/response/
[response-cookies]: /5.22/response/#cookies
[routing]: /5.22/routing/
[session-bag]: /5.22/session/#bag
[singletons]: https://en.wikipedia.org/wiki/Singleton_pattern
[support-helper]: /5.22/support-helper/
[tagfactory]: /5.22/html-tagfactory/
[yaml]: https://php.net/manual/book.yaml.php

Source: https://docs.phalcon.io/5.22/di/index.mdx
