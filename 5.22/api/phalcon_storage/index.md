...
- **`Phalcon\Storage\Adapter\AbstractAdapter`** - implements [`Phalcon\Storage\Adapter\AdapterInterface`](#storageadapteradapterinterface), [`Phalcon\Events\EventsAwareInterface`](/5.22/api/phalcon_events/#eventseventsawareinterface)
...
- [`Phalcon\Cache\Adapter\AdapterInterface`](/5.22/api/phalcon_cache/#cacheadapteradapterinterface)
...
- [`Phalcon\Cache\Adapter\Apcu`](/5.22/api/phalcon_cache/#cacheadapterapcu)
...
- [`Phalcon\Cache\Adapter\Libmemcached`](/5.22/api/phalcon_cache/#cacheadapterlibmemcached)
...
- [`Phalcon\Cache\Adapter\Memory`](/5.22/api/phalcon_cache/#cacheadaptermemory)
...
- [`Phalcon\Cache\Adapter\Redis`](/5.22/api/phalcon_cache/#cacheadapterredis)
...
- [`Phalcon\Cache\Adapter\RedisCluster`](/5.22/api/phalcon_cache/#cacheadapterrediscluster)
...
- [`Phalcon\Cache\Adapter\Stream`](/5.22/api/phalcon_cache/#cacheadapterstream)
...
- [`Phalcon\Cache\Adapter\Weak`](/5.22/api/phalcon_cache/#cacheadapterweak)
...
Source: https://docs.phalcon.io/5.22/api/phalcon_storage/index.mdx
