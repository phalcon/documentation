...
- **`Phalcon\Acl\Adapter\AbstractAdapter`** - implements [`Phalcon\Acl\Adapter\AdapterInterface`](#acladapteradapterinterface), [`Phalcon\Events\EventsAwareInterface`](/5.22/api/phalcon_events/#eventseventsawareinterface)
...
- [`Phalcon\Contracts\Acl\Adapter\Adapter`](/5.22/api/phalcon_contracts/#contractsacladapteradapter)
...
- [`Phalcon\Acl\Adapter\AbstractAdapter`](#acladapterabstractadapter)
- [`Phalcon\Acl\Adapter\Memory`](#acladaptermemory)
- **`Phalcon\Acl\Adapter\Storage`** - implements [`Phalcon\Contracts\Acl\Adapter\Persistable`](/5.22/api/phalcon_contracts/#contractsacladapterpersistable)
...
- [`Phalcon\Contracts\Acl\ComponentAware`](/5.22/api/phalcon_contracts/#contractsaclcomponentaware)
...
- [`Phalcon\Contracts\Acl\Component`](/5.22/api/phalcon_contracts/#contractsaclcomponent)
...
- [`Phalcon\Contracts\Acl\RoleAware`](/5.22/api/phalcon_contracts/#contractsaclroleaware)
...
- [`Phalcon\Contracts\Acl\Role`](/5.22/api/phalcon_contracts/#contractsaclrole)
...
Source: https://docs.phalcon.io/5.22/api/phalcon_acl/index.mdx
