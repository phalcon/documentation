...
- [`Phalcon\Contracts\Db\Adapter\Adapter`](/5.22/api/phalcon_contracts/#contractsdbadapteradapter)
- **`Phalcon\Db\Adapter\AdapterInterface`**
...
- [`Phalcon\Contracts\Db\Check`](/5.22/api/phalcon_contracts/#contractsdbcheck)
- **`Phalcon\Db\CheckInterface`**
...
- [`Phalcon\Contracts\Db\Column`](/5.22/api/phalcon_contracts/#contractsdbcolumn)
- **`Phalcon\Db\ColumnInterface`**
...
- [`Phalcon\Contracts\Db\Dialect`](/5.22/api/phalcon_contracts/#contractsdbdialect)
- **`Phalcon\Db\DialectInterface`**
...
- [`Phalcon\Contracts\Db\Geometry\Geometry`](/5.22/api/phalcon_contracts/#contractsdbgeometrygeometry)
- **`Phalcon\Db\Geometry\GeometryInterface`**
...
- [`Phalcon\Contracts\Db\Index`](/5.22/api/phalcon_contracts/#contractsdbindex)
- **`Phalcon\Db\IndexInterface`**
...
- [`Phalcon\Contracts\Db\Reference`](/5.22/api/phalcon_contracts/#contractsdbreference)
- **`Phalcon\Db\ReferenceInterface`**
...
- [`Phalcon\Contracts\Db\Result`](/5.22/api/phalcon_contracts/#contractsdbresult)
- **`Phalcon\Db\ResultInterface`**
...
Source: https://docs.phalcon.io/5.22/api/phalcon_db/index.mdx
