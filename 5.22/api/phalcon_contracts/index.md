...
- [`Phalcon\Acl\Adapter\AdapterInterface`](/5.22/api/phalcon_acl/#acladapteradapterinterface)
...
- [`Phalcon\Acl\ComponentInterface`](/5.22/api/phalcon_acl/#aclcomponentinterface)
...
- [`Phalcon\Acl\ComponentAwareInterface`](/5.22/api/phalcon_acl/#aclcomponentawareinterface)
...
- [`Phalcon\Acl\RoleInterface`](/5.22/api/phalcon_acl/#aclroleinterface)
...
- [`Phalcon\Acl\RoleAwareInterface`](/5.22/api/phalcon_acl/#aclroleawareinterface)
...
- [`Phalcon\Assets\AssetInterface`](/5.22/api/phalcon_assets/#assetsassetinterface)
...
- [`Phalcon\Assets\FilterInterface`](/5.22/api/phalcon_assets/#assetsfilterinterface)
...
- [`Phalcon\Cache\CacheInterface`](/5.22/api/phalcon_cache/#cachecacheinterface)
...
- [`Phalcon\Cli\DispatcherInterface`](/5.22/api/phalcon_cli/#clidispatcherinterface)
...
- [`Phalcon\Container\Exceptions\ContainerThrowable`](/5.22/api/phalcon_container/#containerexceptionscontainerthrowable)
...
- [`Phalcon\Db\CheckInterface`](/5.22/api/phalcon_db/#dbcheckinterface)
...
- [`Phalcon\Db\Geometry\GeometryInterface`](/5.22/api/phalcon_db/#dbgeometrygeometryinterface)
...
- [`Phalcon\Db\ResultInterface`](/5.22/api/phalcon_db/#dbresultinterface)
...
- [`Phalcon\Dispatcher\DispatcherInterface`](/5.22/api/phalcon_dispatcher/#dispatcherdispatcherinterface)
...
- [`Phalcon\Domain\Payload\ReadableInterface`](/5.22/api/phalcon_domain/#domainpayloadreadableinterface)
...
- [`Phalcon\Domain\Payload\WriteableInterface`](/5.22/api/phalcon_domain/#domainpayloadwriteableinterface)
...
- [`Phalcon\Encryption\Crypt\CryptInterface`](/5.22/api/phalcon_encryption/#encryptioncryptcryptinterface)
...
- [`Phalcon\Encryption\Crypt\Padding\PadInterface`](/5.22/api/phalcon_encryption/#encryptioncryptpaddingpadinterface)
...
- [`Phalcon\Encryption\Security\JWT\Signer\SignerInterface`](/5.22/api/phalcon_encryption/#encryptionsecurityjwtsignersignerinterface)
...
- [`Phalcon\Encryption\Security\Uuid\NodeProviderInterface`](/5.22/api/phalcon_encryption/#encryptionsecurityuuidnodeproviderinterface)
...
- [`Phalcon\Encryption\Security\Uuid\TimeBasedUuidInterface`](/5.22/api/phalcon_encryption/#encryptionsecurityuuidtimebaseduuidinterface)
...
- [`Phalcon\Encryption\Security\Uuid\UuidInterface`](/5.22/api/phalcon_encryption/#encryptionsecurityuuiduuidinterface)
...
- [`Phalcon\Events\EventInterface`](/5.22/api/phalcon_events/#eventseventinterface)
...
- [`Phalcon\Events\EventsAwareInterface`](/5.22/api/phalcon_events/#eventseventsawareinterface)
...
- [`Phalcon\Events\ManagerInterface`](/5.22/api/phalcon_events/#eventsmanagerinterface)
...
- [`Phalcon\Flash\FlashInterface`](/5.22/api/phalcon_flash/#flashflashinterface)
...
- [`Phalcon\Http\RequestInterface`](/5.22/api/phalcon_http/#httprequestinterface)
...
- [`Phalcon\Logger\Adapter\AdapterInterface`](/5.22/api/phalcon_logger/#loggeradapteradapterinterface)
...
- [`Phalcon\Logger\Formatter\FormatterInterface`](/5.22/api/phalcon_logger/#loggerformatterformatterinterface)
...
- [`Phalcon\Logger\LoggerInterface`](/5.22/api/phalcon_logger/#loggerloggerinterface)
...
- [`Phalcon\Mvc\DispatcherInterface`](/5.22/api/phalcon_mvc/#mvcdispatcherinterface)
...
- [`Phalcon\Paginator\Adapter\AdapterInterface`](/5.22/api/phalcon_paginator/#paginatoradapteradapterinterface)
...
- [`Phalcon\Paginator\RepositoryInterface`](/5.22/api/phalcon_paginator/#paginatorrepositoryinterface)
...
Source: https://docs.phalcon.io/5.22/api/phalcon_contracts/index.mdx
