...
- [`Phalcon\Contracts\Paginator\Adapter`](/5.22/api/phalcon_contracts/#contractspaginatoradapter)
...
- [`Phalcon\Contracts\Paginator\Repository`](/5.22/api/phalcon_contracts/#contractspaginatorrepository)
- **`Phalcon\Paginator\RepositoryInterface`**

`Phalcon\Contracts\Paginator\Repository`

Source: https://docs.phalcon.io/5.22/api/phalcon_paginator/index.mdx
