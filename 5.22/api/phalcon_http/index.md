...
- `\stdClass`
- [`Phalcon\Di\AbstractInjectionAware`](/5.22/api/phalcon_di/#diabstractinjectionaware)
- **`Phalcon\Http\Request`** - implements [`Phalcon\Http\RequestInterface`](#httprequestinterface), [`Phalcon\Http\Message\RequestMethodInterface`](#httpmessagerequestmethodinterface), [`Phalcon\Contracts\Http\AttributeRequest`](/5.22/api/phalcon_contracts/#contractshttpattributerequest)
...
- [`Phalcon\Contracts\Http\AttributeRequest`](/5.22/api/phalcon_contracts/#contractshttpattributerequest)
...
Source: https://docs.phalcon.io/5.22/api/phalcon_http/index.mdx
