...
- **`Phalcon\ADR\Application`** - implements [`Phalcon\Contracts\ADR\Application`](/5.22/api/phalcon_contracts/#contractsadrapplication)
...
- **`Phalcon\ADR\Container\AdrProvider`** - implements [`Phalcon\Contracts\Container\Service\Provider`](/5.22/api/phalcon_contracts/#contractscontainerserviceprovider)
...
- **`Phalcon\ADR\Dispatcher`** - implements [`Phalcon\Contracts\ADR\Dispatcher`](/5.22/api/phalcon_contracts/#contractsadrdispatcher)
...
- **`Phalcon\ADR\Emitter\SapiEmitter`** - implements [`Phalcon\Contracts\ADR\Emitter\Emitter`](/5.22/api/phalcon_contracts/#contractsadremitteremitter)
...
- **`Phalcon\ADR\EventfulHandler`** - implements [`Phalcon\Contracts\ADR\Handler`](/5.22/api/phalcon_contracts/#contractsadrhandler)
...
- `\Exception`
- **`Phalcon\ADR\Exceptions\Exception`** - implements [`Phalcon\Contracts\ADR\Exceptions\ADRThrowable`](/5.22/api/phalcon_contracts/#contractsadrexceptionsadrthrowable)
...
- **`Phalcon\ADR\Front\AbstractHttpFront`** - implements [`Phalcon\Contracts\Front\FrontController`](/5.22/api/phalcon_contracts/#contractsfrontfrontcontroller)
...
- **`Phalcon\ADR\Middleware\CorsMiddleware`** - implements [`Phalcon\Contracts\ADR\Middleware`](/5.22/api/phalcon_contracts/#contractsadrmiddleware)
...
- **`Phalcon\ADR\Middleware\RequestIdMiddleware`** - implements [`Phalcon\Contracts\ADR\Middleware`](/5.22/api/phalcon_contracts/#contractsadrmiddleware)
...
- **`Phalcon\ADR\Middleware\TimingMiddleware`** - implements [`Phalcon\Contracts\ADR\Middleware`](/5.22/api/phalcon_contracts/#contractsadrmiddleware)
...
- **`Phalcon\ADR\Payload\Payload`** - implements [`Phalcon\Contracts\ADR\Payload\Payload`](/5.22/api/phalcon_contracts/#contractsadrpayloadpayload)
...
- **`Phalcon\ADR\Responder\ChainResponder`** - implements [`Phalcon\Contracts\ADR\Responder\Responder`](/5.22/api/phalcon_contracts/#contractsadrresponderresponder)
...
- **`Phalcon\ADR\Responder\Formatter\JsonFormatter`** - implements [`Phalcon\Contracts\ADR\Responder\Formatter\Formatter`](/5.22/api/phalcon_contracts/#contractsadrresponderformatterformatter)
...
- **`Phalcon\ADR\Responder\RedirectResponder`** - implements [`Phalcon\Contracts\ADR\Responder\Responder`](/5.22/api/phalcon_contracts/#contractsadrresponderresponder)
...
- **`Phalcon\ADR\Responder\ViewResponder`** - implements [`Phalcon\Contracts\ADR\Responder\Responder`](/5.22/api/phalcon_contracts/#contractsadrresponderresponder)
...
- **`Phalcon\ADR\Router\AttributeFilter`** - implements [`Phalcon\Contracts\ADR\Router\AttributeFilter`](/5.22/api/phalcon_contracts/#contractsadrrouterattributefilter)
...
- **`Phalcon\ADR\Router\RouterMatch`** - implements [`Phalcon\Contracts\ADR\Router\RouterMatch`](/5.22/api/phalcon_contracts/#contractsadrrouterroutermatch)
...
Source: https://docs.phalcon.io/5.22/api/phalcon_adr/index.mdx
