...
Each file validator checks the upload before it checks the file:

- An upload larger than the PHP size limits fails with the `messageIniSize` message.
- The value must be one uploaded-file array from `$_FILES`. Its `error` must be `UPLOAD_ERR_OK`, and its `tmp_name` must be a file that PHP received through HTTP POST. If not, validation fails with the `messageFileEmpty` message. As of 5.21, a missing file and a plain string also fail this check.
- The uploaded-file array must have the `name`, `type` and `size` keys. If not, validation fails with the `messageValid` message.

As of 5.21, the resolution validators (`AspectRatio`, `Equal`, `Max` and `Min`) also reject a file that `getimagesize()` cannot read as an image. They use the `messageValid` message.

Set these messages with the `messageFileEmpty`, `messageIniSize` and `messageValid` options of the `File` validator:
...
new File(
    [
        "maxResolution"    => "800x600",
        "messageFileEmpty" => "Upload a file for :field",
        "messageIniSize"   => "The file in :field is too large",
        "messageValid"     => "The file in :field is not a valid image",
    ]
)
);
```

On the other file validators, use `setMessageFileEmpty()`, `setMessageIniSize()` and `setMessageValid()`.
...
[filter-filter]: /5.22/filter-filter/
[messages-message]: /5.22/api/phalcon_messages/#messagesmessage
[messages-messages]: /5.22/api/phalcon_messages/#messagesmessages
[validation]: /5.22/api/phalcon_filter/#filtervalidation
[validation-abstractcombinedfieldsvalidator]: /5.22/api/phalcon_filter/#filtervalidationabstractcombinedfieldsvalidator
[validation-abstractvalidator]: /5.22/api/phalcon_filter/#filtervalidationabstractvalidator
[validation-abstractvalidatorcomposite]: /5.22/api/phalcon_filter/#filtervalidationabstractvalidatorcomposite
[validation-exception]: /5.22/api/phalcon_filter/#filtervalidationexception
[validation-validationinterface]: /5.22/api/phalcon_filter/#filtervalidationvalidationinterface
[validation-validator-alnum]: /5.22/api/phalcon_filter/#filtervalidationvalidatoralnum
[validation-validator-alpha]: /5.22/api/phalcon_filter/#filtervalidationvalidatoralpha
[validation-validator-between]: /5.22/api/phalcon_filter/#filtervalidationvalidatorbetween
[validation-validator-callback]: /5.22/api/phalcon_filter/#filtervalidationvalidatorcallback
[validation-validator-confirmation]: /5.22/api/phalcon_filter/#filtervalidationvalidatorconfirmation
[validation-validator-creditcard]: /5.22/api/phalcon_filter/#filtervalidationvalidatorcreditcard
[validation-validator-date]: /5.22/api/phalcon_filter/#filtervalidationvalidatordate
[validation-validator-digit]: /5.22/api/phalcon_filter/#filtervalidationvalidatordigit
[validation-validator-email]: /5.22/api/phalcon_filter/#filtervalidationvalidatoremail
[validation-validator-exception]: /5.22/api/phalcon_filter/#filtervalidationvalidatorexception
[validation-validator-exclusionin]: /5.22/api/phalcon_filter/#filtervalidationvalidatorexclusionin
[validation-validator-file]: /5.22/api/phalcon_filter/#filtervalidationvalidatorfile
[validation-validator-file-abstractfile]: /5.22/api/phalcon_filter/#filtervalidationvalidatorfileabstractfile
[validation-validator-file-mimetype]: /5.22/api/phalcon_filter/#filtervalidationvalidatorfilemimetype
[validation-validator-file-resolution-aspectratio]: /5.22/api/phalcon_filter/#filtervalidationvalidatorfileresolutionaspectratio
[validation-validator-file-resolution-equal]: /5.22/api/phalcon_filter/#filtervalidationvalidatorfileresolutionequal
[validation-validator-file-resolution-max]: /5.22/api/phalcon_filter/#filtervalidationvalidatorfileresolutionmax
[validation-validator-file-resolution-min]: /5.22/api/phalcon_filter/#filtervalidationvalidatorfileresolutionmin
[validation-validator-file-size-equal]: /5.22/api/phalcon_filter/#filtervalidationvalidatorfilesizeequal
[validation-validator-file-size-max]: /5.22/api/phalcon_filter/#filtervalidationvalidatorfilesizemax
[validation-validator-file-size-min]: /5.22/api/phalcon_filter/#filtervalidationvalidatorfilesizemin
[validation-validator-files]: /5.22/api/phalcon_filter/#filtervalidationvalidatorfiles
[validation-validator-identical]: /5.22/api/phalcon_filter/#filtervalidationvalidatoridentical
[validation-validator-inclusionin]: /5.22/api/phalcon_filter/#filtervalidationvalidatorinclusionin
[validation-validator-ip]: /5.22/api/phalcon_filter/#filtervalidationvalidatorip
[validation-validator-numericality]: /5.22/api/phalcon_filter/#filtervalidationvalidatornumericality
[validation-validator-presenceof]: /5.22/api/phalcon_filter/#filtervalidationvalidatorpresenceof
[validation-validator-regex]: /5.22/api/phalcon_filter/#filtervalidationvalidatorregex
[validation-validator-stringlength]: /5.22/api/phalcon_filter/#filtervalidationvalidatorstringlength
[validation-validator-stringlength-max]: /5.22/api/phalcon_filter/#filtervalidationvalidatorstringlengthmax
[validation-validator-stringlength-min]: /5.22/api/phalcon_filter/#filtervalidationvalidatorstringlengthmin
[validation-validator-uniqueness]: /5.22/api/phalcon_filter/#filtervalidationvalidatoruniqueness
[validation-validator-url]: /5.22/api/phalcon_filter/#filtervalidationvalidatorurl
[validation-validatorcompositeinterface]: /5.22/api/phalcon_filter/#filtervalidationvalidatorcompositeinterface
[validation-validatorfactory]: /5.22/api/phalcon_filter/#filtervalidationvalidatorfactory
[validation-validatorinterface]: /5.22/api/phalcon_filter/#filtervalidationvalidatorinterface

Source: https://docs.phalcon.io/5.22/filter-validation/index.mdx
