...
You are not required to implement all the files mentioned above. [Phalcon\Mvc\View][mvc-view] will move to the next view level in the hierarchy of files. If all three view files are implemented, they will be processed as follows:
...
Template Engines help designers to create views without the use of complicated syntax. Phalcon includes a fast templating engine called [Volt][volt] that helps with view development while not sacrificing processing speed.
...
[mvc-view-engine-abstractengine]: /5.20/api/phalcon_mvc/#mvcviewengineabstractengine
[mvc-view-engine-engineinterface]: /5.20/api/phalcon_mvc/#mvcviewengineengineinterface
[mvc-view-engine-php]: /5.20/api/phalcon_mvc/#mvcviewenginephp
[mvc-view-engine-volt]: /5.20/api/phalcon_mvc/#mvcviewenginevolt
...
[mvc-view-exception]: /5.20/api/phalcon_mvc/#mvcviewexception
[mvc-view-simple]: /5.20/api/phalcon_mvc/#mvcviewsimple
[mvc-viewbaseinterface]: /5.20/api/phalcon_mvc/#mvcviewbaseinterface
[mvc-viewinterface]: /5.20/api/phalcon_mvc/#mvcviewinterface
[smarty]: https://www.smarty.net/
[tidy]: https://www.php.net/manual/en/book.tidy.php
[twig]: https://twig.symfony.com/
[volt]: /5.20/volt/

Source: https://docs.phalcon.io/5.20/views/index.mdx
