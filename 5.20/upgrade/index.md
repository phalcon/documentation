...
[phalcon-acl]: /5.20/acl/
[phalcon-annotations]: /5.20/annotations/
[phalcon-application]: /5.20/application/
[phalcon-application-cli]: /5.20/application-cli/
[phalcon-assets]: /5.20/assets/
[phalcon-autoload]: /5.20/autoload/
[phalcon-cache]: /5.20/cache/
[phalcon-config]: /5.20/config/
[phalcon-datamapper]: /5.20/datamapper/
[phalcon-db-layer]: /5.20/db-layer/
[phalcon-db-pagination]: /5.20/db-pagination/
[phalcon-di]: /5.20/di/
[phalcon-dispatcher]: /5.20/dispatcher/
[phalcon-domain]: /5.20/domain/
[phalcon-encryption-crypt]: /5.20/encryption-crypt/
[phalcon-encryption-security]: /5.20/encryption-security/
[phalcon-events]: /5.20/events/
[phalcon-filter-filter]: /5.20/filter-filter/
[phalcon-filter-validation]: /5.20/filter-validation/
[phalcon-flash]: /5.20/flash/
[phalcon-forms]: /5.20/forms/
[phalcon-html]: /5.20/html/
[phalcon-html-escaper]: /5.20/html-escaper/
[phalcon-html-link]: /5.20/html-link/
[phalcon-html-tagfactory]: /5.20/html-tagfactory/
[phalcon-logger]: /5.20/logger/
[phalcon-mvc]: /5.20/mvc/
[phalcon-mvc-url]: /5.20/mvc-url/
[phalcon-session]: /5.20/session/
[phalcon-storage]: /5.20/storage/
[phalcon-support-collection]: /5.20/support-collection/
[phalcon-support-debug]: /5.20/support-debug/
[phalcon-support-helper]: /5.20/support-helper/
[phalcon-support-registry]: /5.20/support-registry/
[phalcon-support-version]: /5.20/support-version/
[phalcon-tag]: /5.20/tag/
[phalcon-translate]: /5.20/translate/
[phalcon-volt]: /5.20/volt/
...
[support]: #support
[volt-tag-helpers]: /5.20/volt/#tag-helpers
[zephir-phar]: https://github.com/phalcon/zephir/releases

Source: https://docs.phalcon.io/5.20/upgrade/index.mdx
