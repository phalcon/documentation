...
You can redirect one matched route to another using the [Phalcon\Http\Response][http-response] object, like in a full application.
...
When using controllers as handlers, you can perform the redirect the same way:
...
JSON can be sent back the same way using the [Phalcon\Http\Response][http-response] object.
...
| `afterExecuteRoute`  | Handler finished running                                     |    No    |
| `afterHandleRoute`   | Route finished executing                                     |   Yes    |
...
You can check whether a user has been authenticated or not using the `beforeExecuteRoute` event. The following example demonstrates such a scenario:
...
The component raises granular subclasses of `Phalcon\Mvc\Micro\Exception` so callers can catch a specific failure mode. Existing `catch (Phalcon\Mvc\Micro\Exception $e)` blocks continue to work unchanged.
...
[events]: /5.20/events/
[events-manager]: /5.20/api/phalcon_events/#eventsmanager
[http-response]: /5.20/api/phalcon_http/#httpresponse
[http-responseinterface]: /5.20/api/phalcon_http/#httpresponseinterface
[mvc-controller]: /5.20/api/phalcon_mvc/#mvccontroller
[mvc-micro]: /5.20/api/phalcon_mvc/#mvcmicro
[mvc-micro-collection]: /5.20/api/phalcon_mvc/#mvcmicrocollection
[mvc-micro-exception]: /5.20/api/phalcon_mvc/#mvcmicroexception
[mvc-micro-middlewareinterface]: /5.20/api/phalcon_mvc/#mvcmicromiddlewareinterface
[mvc-model-binder]: /5.20/api/phalcon_mvc/#mvcmodelbinder
[mvc-router]: /5.20/api/phalcon_mvc/#mvcrouter
[mvc-url]: /5.20/mvc-url/
[mvc-view]: /5.20/api/phalcon_mvc/#mvcview
[mvc-view-simple]: /5.20/api/phalcon_mvc/#mvcviewsimple
[psr-15]: https://www.php-fig.org/psr/psr-15/
[routing]: /5.20/routing/
[webserver-setup]: /5.20/webserver-setup/

Source: https://docs.phalcon.io/5.20/application-micro/index.mdx
