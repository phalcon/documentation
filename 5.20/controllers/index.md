...
If you want to execute some initialization logic right after the controller object is constructed then you can implement the `onConstruct()` method:
...
Additional URI parameters are defined as action parameters so that they can be accessed using local variables. A controller can optionally extend [Phalcon\Mvc\Controller][mvc-controller]. By doing this, the controller can access the application services.
...
If you have already registered a [Request][request] and [Response][response] services to your DI container or have instantiated the [Phalcon\Di\FactoryDefault][di-factorydefault] one, you can access these objects as properties in your controller.
...
Services can act as controllers. Controllers are classes that are always requested from the DI container. As a result, any other class registered with the correct name can replace a controller:
...
[dispatcher]: /5.20/dispatcher/
[events]: /5.20/events/
[mvc-controller]: /5.20/api/phalcon_mvc/#mvccontroller
[mvc-controller-bindmodelinterface]: /5.20/api/phalcon_mvc/#mvccontrollerbindmodelinterface
[mvc-controllerinterface]: /5.20/api/phalcon_mvc/#mvccontrollerinterface
[request]: /5.20/request/
[response]: /5.20/response/
[routing]: /5.20/routing/
[session-bag]: /5.20/api/phalcon_session/#sessionbag
[views]: /5.20/views/

Source: https://docs.phalcon.io/5.20/controllers/index.mdx
