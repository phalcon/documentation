...
If your application has its entry point in `/public/index.php` or your project has been created by the [Phalcon Devtools](/5.20/devtools/), then you can start the web server with the following command:
...
The following are potential configurations you can use to set up Apache with Phalcon. These notes are primarily focused on the configuration of the `mod_rewrite` module allowing to use of friendly URLs and the [router component](/5.20/routing/). A common directory structure for an application is:
...
Source: https://docs.phalcon.io/5.20/webserver-setup/index.mdx
