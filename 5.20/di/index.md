...
[container]: /5.20/container/
[db-layer]: /5.20/db-layer/
[db-models]: /5.20/db-models/
[db-models-metadata]: /5.20/db-models-metadata/
[db-models-transactions]: /5.20/db-models-transactions/
[di]: /5.20/api/phalcon_di/#didi
[di-abstractinjectionaware]: /5.20/api/phalcon_di/#diabstractinjectionaware
[di-diinterface]: /5.20/api/phalcon_di/#didiinterface
[di-exception]: /5.20/api/phalcon_di/#diexception
[di-exception-serviceresolutionexception]: /5.20/api/phalcon_di/#diexceptionserviceresolutionexception
...
[di-serviceinterface]: /5.20/api/phalcon_di/#diserviceinterface
[di-serviceproviderinterface]: /5.20/api/phalcon_di/#diserviceproviderinterface
[dispatcher]: /5.20/dispatcher/
[encryption-crypt]: /5.20/encryption-crypt/
[encryption-security]: /5.20/encryption-security/
[events]: /5.20/events/
[filter-filter]: /5.20/filter-filter/
[flash]: /5.20/flash/
[html-escaper]: /5.20/html-escaper/
[ioc]: https://en.wikipedia.org/wiki/Inversion_of_control
[mvc-url]: /5.20/mvc-url/
[request]: /5.20/request/
[response]: /5.20/response/
[response-cookies]: /5.20/response/#cookies
[routing]: /5.20/routing/
[session-bag]: /5.20/session/#bag
[singletons]: https://en.wikipedia.org/wiki/Singleton_pattern
[support-helper]: /5.20/support-helper/
[tagfactory]: /5.20/html-tagfactory/
[yaml]: https://php.net/manual/book.yaml.php

Source: https://docs.phalcon.io/5.20/di/index.mdx
