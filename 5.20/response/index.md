...
| Method                                                   | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|----------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `delete( string $name ): bool`                           | Deletes a cookie by name, expiring it in the client. It checks the internal collection first and falls back to the `$_COOKIE` superglobal, so a cookie that arrived with the request can be deleted as well; it returns `false` when the name is in neither. The cookie is expired with the `path` and `domain` it was originally sent with, so one set under a different path or domain is left in place. The `$_COOKIE` superglobal itself is **not modified** for the current request.                                                     |
...
The `setFileToSend()` helper method allows you to set a file to be sent back to the caller using the response object. This is particularly useful when we want to introduce download file functionality in our application.
...
[di-injectionawareinterface]: /5.20/api/phalcon_di/#diinjectionawareinterface
[events-eventsawareinterface]: /5.20/api/phalcon_events/#eventseventsawareinterface
[http-cookie]: /5.20/api/phalcon_http/#httpcookie
[http-cookie-exception]: /5.20/api/phalcon_http/#httpcookieexception
[http-cookieinterface]: /5.20/api/phalcon_http/#httpcookiecookieinterface
[http-response]: /5.20/api/phalcon_http/#httpresponse
[http-response-cookies]: /5.20/api/phalcon_http/#httpresponsecookies
[http-response-cookiesinterface]: /5.20/api/phalcon_http/#httpresponsecookiesinterface
[http-response-exception]: /5.20/api/phalcon_http/#httpresponseexception
[http-response-headers]: /5.20/api/phalcon_http/#httpresponseheaders
[http-response-headersinterface]: /5.20/api/phalcon_http/#httpresponseheadersinterface
...
[url]: /5.20/api/phalcon_mvc/#mvcurl

Source: https://docs.phalcon.io/5.20/response/index.mdx
