...
[application-micro]: /5.20/application-micro/
[auth]: /5.20/auth/
[autoload]: /5.20/autoload/
[cache]: /5.20/cache/
[contracts-event]: /5.20/api/phalcon_contracts/#contractseventsevent
[contracts-eventsaware]: /5.20/api/phalcon_contracts/#contractseventseventsaware
[contracts-manager]: /5.20/api/phalcon_contracts/#contractseventsmanager
[contracts-stoppable]: /5.20/api/phalcon_contracts/#contractseventsstoppable
[datamapper]: /5.20/datamapper/
[db]: /5.20/api/phalcon_db/
[db-layer]: /5.20/db-layer/
[db-models]: /5.20/db-models/
[di-factorydefaul]: /5.20/api/phalcon_di/#difactorydefault
[di-injectable]: /5.20/api/phalcon_di/#diinjectable
[dispatcher]: /5.20/dispatcher/
[events-event]: /5.20/api/phalcon_events/#eventsevent
[events-eventinterface]: /5.20/api/phalcon_events/#eventseventinterface
[events-eventsawareinterface]: /5.20/api/phalcon_events/#eventseventsawareinterface
[events-exception]: /5.20/api/phalcon_events/#eventsexception
[events-manager]: /5.20/api/phalcon_events/#eventsmanager
[events-managerinterface]: /5.20/api/phalcon_events/#eventsmanagerinterface
[events-subscriber]: /5.20/api/phalcon_contracts/#contractseventssubscriber
...
[storage]: /5.20/storage/
[views]: /5.20/views/
[volt]: /5.20/volt/

Source: https://docs.phalcon.io/5.20/events/index.mdx
