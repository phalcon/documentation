...
- **`Phalcon\Acl\Adapter\AbstractAdapter`** - implements [`Phalcon\Acl\Adapter\AdapterInterface`](#acladapteradapterinterface), [`Phalcon\Events\EventsAwareInterface`](/5.20/api/phalcon_events/#eventseventsawareinterface)
...
- [`Phalcon\Contracts\Acl\Adapter\Adapter`](/5.20/api/phalcon_contracts/#contractsacladapteradapter)
...
- [`Phalcon\Acl\Adapter\AbstractAdapter`](#acladapterabstractadapter)
- [`Phalcon\Acl\Adapter\Memory`](#acladaptermemory)
- **`Phalcon\Acl\Adapter\Storage`** - implements [`Phalcon\Contracts\Acl\Adapter\Persistable`](/5.20/api/phalcon_contracts/#contractsacladapterpersistable)
...
- [`Phalcon\Contracts\Acl\ComponentAware`](/5.20/api/phalcon_contracts/#contractsaclcomponentaware)
...
- [`Phalcon\Contracts\Acl\Component`](/5.20/api/phalcon_contracts/#contractsaclcomponent)
...
<span class="badge badge--class">Class</span>
<a class="src-btn" href="https://github.com/phalcon/cphalcon/blob/5.0.x/phalcon/Acl/Exceptions/ForbiddenDelimiter.zep">Source on GitHub</a>
...
- [`Phalcon\Contracts\Acl\RoleAware`](/5.20/api/phalcon_contracts/#contractsaclroleaware)
...
- [`Phalcon\Contracts\Acl\Role`](/5.20/api/phalcon_contracts/#contractsaclrole)
...
Source: https://docs.phalcon.io/5.20/api/phalcon_acl/index.mdx
