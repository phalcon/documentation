...
- **`Phalcon\Forms\Loader\ArrayLoader`** - implements [`Phalcon\Contracts\Forms\Schema`](/5.21/api/phalcon_contracts/#contractsformsschema)
...
- **`Phalcon\Forms\Loader\JsonLoader`** - implements [`Phalcon\Contracts\Forms\Schema`](/5.21/api/phalcon_contracts/#contractsformsschema)
...
- **`Phalcon\Forms\Loader\YamlLoader`** - implements [`Phalcon\Contracts\Forms\Schema`](/5.21/api/phalcon_contracts/#contractsformsschema)
...
Source: https://docs.phalcon.io/5.21/api/phalcon_forms/index.mdx
