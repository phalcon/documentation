...
- **`Phalcon\ADR\Application`** - implements [`Phalcon\Contracts\ADR\Application`](/5.21/api/phalcon_contracts/#contractsadrapplication)
...
- **`Phalcon\ADR\Container\AdrProvider`** - implements [`Phalcon\Contracts\Container\Service\Provider`](/5.21/api/phalcon_contracts/#contractscontainerserviceprovider)
...
- **`Phalcon\ADR\Dispatcher`** - implements [`Phalcon\Contracts\ADR\Dispatcher`](/5.21/api/phalcon_contracts/#contractsadrdispatcher)
...
- **`Phalcon\ADR\Emitter\SapiEmitter`** - implements [`Phalcon\Contracts\ADR\Emitter\Emitter`](/5.21/api/phalcon_contracts/#contractsadremitteremitter)
...
- **`Phalcon\ADR\EventfulHandler`** - implements [`Phalcon\Contracts\ADR\Handler`](/5.21/api/phalcon_contracts/#contractsadrhandler)
...
- `\Exception`
- **`Phalcon\ADR\Exceptions\Exception`** - implements [`Phalcon\Contracts\ADR\Exceptions\ADRThrowable`](/5.21/api/phalcon_contracts/#contractsadrexceptionsadrthrowable)
...
- **`Phalcon\ADR\Front\AbstractHttpFront`** - implements [`Phalcon\Contracts\Front\FrontController`](/5.21/api/phalcon_contracts/#contractsfrontfrontcontroller)
...
`Phalcon\Contracts\ADR\ADRTypes` · `Phalcon\Contracts\Http\AttributeRequest` · `Phalcon\Http\Request\Bag\AttributeBag`
...
- **`Phalcon\ADR\Middleware\CorsMiddleware`** - implements [`Phalcon\Contracts\ADR\Middleware`](/5.21/api/phalcon_contracts/#contractsadrmiddleware)
...
- **`Phalcon\ADR\Middleware\MethodOverrideMiddleware`** - implements [`Phalcon\Contracts\ADR\Middleware`](/5.21/api/phalcon_contracts/#contractsadrmiddleware)
...
- **`Phalcon\ADR\Middleware\RequestIdMiddleware`** - implements [`Phalcon\Contracts\ADR\Middleware`](/5.21/api/phalcon_contracts/#contractsadrmiddleware)

`Phalcon\Contracts\ADR\Handler` · `Phalcon\Contracts\ADR\Middleware` · `Phalcon\Contracts\Http\AttributeRequest` · `Phalcon\Http\Request\Bag\AttributeBag` · `Phalcon\Http\ResponseInterface`
...
- **`Phalcon\ADR\Middleware\TimingMiddleware`** - implements [`Phalcon\Contracts\ADR\Middleware`](/5.21/api/phalcon_contracts/#contractsadrmiddleware)
...
- **`Phalcon\ADR\Payload\Payload`** - implements [`Phalcon\Contracts\ADR\Payload\Payload`](/5.21/api/phalcon_contracts/#contractsadrpayloadpayload)
...
- **`Phalcon\ADR\Pipeline`** - implements [`Phalcon\Contracts\ADR\Handler`](/5.21/api/phalcon_contracts/#contractsadrhandler)
...
- **`Phalcon\ADR\Responder\ChainResponder`** - implements [`Phalcon\Contracts\ADR\Responder\Responder`](/5.21/api/phalcon_contracts/#contractsadrresponderresponder)
...
- **`Phalcon\ADR\Responder\FormatResponder`** - implements [`Phalcon\Contracts\ADR\Responder\Responder`](/5.21/api/phalcon_contracts/#contractsadrresponderresponder)
...
- **`Phalcon\ADR\Responder\Formatter\JsonFormatter`** - implements [`Phalcon\Contracts\ADR\Responder\Formatter\Formatter`](/5.21/api/phalcon_contracts/#contractsadrresponderformatterformatter)
...
- **`Phalcon\ADR\Responder\Formatter\TextFormatter`** - implements [`Phalcon\Contracts\ADR\Responder\Formatter\Formatter`](/5.21/api/phalcon_contracts/#contractsadrresponderformatterformatter)
...
- **`Phalcon\ADR\Responder\RedirectResponder`** - implements [`Phalcon\Contracts\ADR\Responder\Responder`](/5.21/api/phalcon_contracts/#contractsadrresponderresponder)
...
- **`Phalcon\ADR\Responder\StatusResponder`** - implements [`Phalcon\Contracts\ADR\Responder\Responder`](/5.21/api/phalcon_contracts/#contractsadrresponderresponder)
...
- **`Phalcon\ADR\Responder\ViewResponder`** - implements [`Phalcon\Contracts\ADR\Responder\Responder`](/5.21/api/phalcon_contracts/#contractsadrresponderresponder)
...
- **`Phalcon\ADR\Router\AttributeFilter`** - implements [`Phalcon\Contracts\ADR\Router\AttributeFilter`](/5.21/api/phalcon_contracts/#contractsadrrouterattributefilter)
...
- **`Phalcon\ADR\Router\Router`** - implements [`Phalcon\Contracts\ADR\Router\Router`](/5.21/api/phalcon_contracts/#contractsadrrouterrouter)
...
- **`Phalcon\ADR\Router\RouterMatch`** - implements [`Phalcon\Contracts\ADR\Router\RouterMatch`](/5.21/api/phalcon_contracts/#contractsadrrouterroutermatch)
...
Source: https://docs.phalcon.io/5.21/api/phalcon_adr/index.mdx
