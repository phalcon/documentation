...
- [`Phalcon\Contracts\Logger\Adapter\Adapter`](/5.21/api/phalcon_contracts/#contractsloggeradapteradapter)
...
- [`Phalcon\Contracts\Logger\Formatter\Formatter`](/5.21/api/phalcon_contracts/#contractsloggerformatterformatter)
...
- [`Phalcon\Contracts\Logger\Logger`](/5.21/api/phalcon_contracts/#contractsloggerlogger)
- **`Phalcon\Logger\LoggerInterface`**

`Phalcon\Contracts\Logger\Logger`

Source: https://docs.phalcon.io/5.21/api/phalcon_logger/index.mdx
