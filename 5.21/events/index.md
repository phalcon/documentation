...
[application-micro]: /5.21/application-micro/
[auth]: /5.21/auth/
[autoload]: /5.21/autoload/
[cache]: /5.21/cache/
[contracts-event]: /5.21/api/phalcon_contracts/#contractseventsevent
[contracts-eventsaware]: /5.21/api/phalcon_contracts/#contractseventseventsaware
[contracts-manager]: /5.21/api/phalcon_contracts/#contractseventsmanager
[contracts-stoppable]: /5.21/api/phalcon_contracts/#contractseventsstoppable
[datamapper]: /5.21/datamapper/
[db]: /5.21/api/phalcon_db/
[db-layer]: /5.21/db-layer/
[db-models]: /5.21/db-models/
[di-factorydefaul]: /5.21/api/phalcon_di/#difactorydefault
[di-injectable]: /5.21/api/phalcon_di/#diinjectable
[dispatcher]: /5.21/dispatcher/
[events-event]: /5.21/api/phalcon_events/#eventsevent
[events-eventinterface]: /5.21/api/phalcon_events/#eventseventinterface
[events-eventsawareinterface]: /5.21/api/phalcon_events/#eventseventsawareinterface
[events-exception]: /5.21/api/phalcon_events/#eventsexception
[events-manager]: /5.21/api/phalcon_events/#eventsmanager
[events-managerinterface]: /5.21/api/phalcon_events/#eventsmanagerinterface
[events-subscriber]: /5.21/api/phalcon_contracts/#contractseventssubscriber
...
[storage]: /5.21/storage/
[views]: /5.21/views/
[volt]: /5.21/volt/

Source: https://docs.phalcon.io/5.21/events/index.mdx
