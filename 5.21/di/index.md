...
[container]: /5.21/container/
[db-layer]: /5.21/db-layer/
[db-models]: /5.21/db-models/
[db-models-metadata]: /5.21/db-models-metadata/
[db-models-transactions]: /5.21/db-models-transactions/
[di]: /5.21/api/phalcon_di/#didi
[di-abstractinjectionaware]: /5.21/api/phalcon_di/#diabstractinjectionaware
[di-diinterface]: /5.21/api/phalcon_di/#didiinterface
[di-exception]: /5.21/api/phalcon_di/#diexception
[di-exception-serviceresolutionexception]: /5.21/api/phalcon_di/#diexceptionserviceresolutionexception
...
[di-serviceinterface]: /5.21/api/phalcon_di/#diserviceinterface
[di-serviceproviderinterface]: /5.21/api/phalcon_di/#diserviceproviderinterface
[dispatcher]: /5.21/dispatcher/
[encryption-crypt]: /5.21/encryption-crypt/
[encryption-security]: /5.21/encryption-security/
[events]: /5.21/events/
[filter-filter]: /5.21/filter-filter/
[flash]: /5.21/flash/
[html-escaper]: /5.21/html-escaper/
[ioc]: https://en.wikipedia.org/wiki/Inversion_of_control
[mvc-url]: /5.21/mvc-url/
[request]: /5.21/request/
[response]: /5.21/response/
[response-cookies]: /5.21/response/#cookies
[routing]: /5.21/routing/
[session-bag]: /5.21/session/#bag
[singletons]: https://en.wikipedia.org/wiki/Singleton_pattern
[support-helper]: /5.21/support-helper/
[tagfactory]: /5.21/html-tagfactory/
[yaml]: https://php.net/manual/book.yaml.php

Source: https://docs.phalcon.io/5.21/di/index.mdx
