...
[collection]: /5.21/support-collection/
[config]: /5.21/api/phalcon_config/
[config-config]: /5.21/api/phalcon_config/#configconfig
[config-configfactory]: /5.21/api/phalcon_config/#configconfigfactory
[config-exception]: /5.21/api/phalcon_config/#configexception
[di]: /5.21/di/
[dotenv]: https://github.com/josegonzalez/php-dotenv
[grouped]: /5.21/api/phalcon_config/#configadaptergrouped
[ini]: /5.21/api/phalcon_config/#configadapterini
[json]: /5.21/api/phalcon_config/#configadapterjson
...
[php]: /5.21/api/phalcon_config/#configadapterphp
[support-collection]: /5.21/support-collection/
[yaml]: /5.21/api/phalcon_config/#configadapteryaml
[yaml-parse-file]: https://www.php.net/manual/en/function.yaml-parse-file.php

Source: https://docs.phalcon.io/5.21/config/index.mdx
