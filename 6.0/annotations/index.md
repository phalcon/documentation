...
The `Phalcon\Annotations` namespace holds general-purpose components that read and cache annotations in PHP applications. An annotation comes from a docblock or from a PHP attribute. See [Readers](#readers).

:::note[The docblock reader needs an additional package]
The docblock parser of this version is [phalcon/annotations][phalcon-annotations-package], a PHP port of the parser that the C extension holds. Install it before the docblock reader is used:

```bash
composer require phalcon/annotations
```

[Phalcon\Annotations\AttributesReader][annotations-attributesreader] reads PHP attributes through Reflection and does not need the package.
:::
...
| Reader                                                                | Reads                              | Needs                                             |
|-----------------------------------------------------------------------|------------------------------------|---------------------------------------------------|
| [Phalcon\Annotations\Reader][annotations-reader]                      | docblocks, with the syntax above   | the [phalcon/annotations][phalcon-annotations-package] package |
| [Phalcon\Annotations\AttributesReader][annotations-attributesreader]  | PHP attributes, through Reflection | nothing                                           |
...
Both readers work on every PHP version that Phalcon supports, because PHP attributes exist from PHP 8.0 and the minimum version of Phalcon is PHP 8.1.

[Phalcon\Annotations\Reader][annotations-reader] is the default. An application that does not select a reader keeps the behavior it has today. An application that uses attributes only can select [Phalcon\Annotations\AttributesReader][annotations-attributesreader] and leave the package out.
...
[annotations-adapter-abstractadapter]: /6.0/api/phalcon_annotations/#annotationsadapterabstractadapter
[annotations-adapter-adapterinterface]: /6.0/api/phalcon_annotations/#annotationsadapteradapterinterface
[annotations-adapter-apcu]: /6.0/api/phalcon_annotations/#annotationsadapterapcu
[annotations-adapter-memory]: /6.0/api/phalcon_annotations/#annotationsadaptermemory
[annotations-adapter-stream]: /6.0/api/phalcon_annotations/#annotationsadapterstream
[annotations-annotation]: /6.0/api/phalcon_annotations/#annotationsannotation
[annotations-annotationsfactory]: /6.0/api/phalcon_annotations/#annotationsannotationsfactory
[annotations-attributesreader]: /6.0/api/phalcon_annotations/#annotationsattributesreader
[annotations-collection]: /6.0/api/phalcon_annotations/#annotationscollection
[annotations-exception]: /6.0/api/phalcon_annotations/#annotationsexception
[annotations-models-metadata-column]: /6.0/api/phalcon_annotations/#annotationsmodelsmetadatacolumn
[annotations-models-metadata-identity]: /6.0/api/phalcon_annotations/#annotationsmodelsmetadataidentity
[annotations-models-metadata-primary]: /6.0/api/phalcon_annotations/#annotationsmodelsmetadataprimary
[annotations-models-metadata-source]: /6.0/api/phalcon_annotations/#annotationsmodelsmetadatasource
[annotations-reader]: /6.0/api/phalcon_annotations/#annotationsreader
[annotations-readerinterface]: /6.0/api/phalcon_annotations/#annotationsreaderinterface
[annotations-reflection]: /6.0/api/phalcon_annotations/#annotationsreflection
[annotations-router-connect]: /6.0/api/phalcon_annotations/#annotationsrouterconnect
[annotations-router-delete]: /6.0/api/phalcon_annotations/#annotationsrouterdelete
[annotations-router-get]: /6.0/api/phalcon_annotations/#annotationsrouterget
[annotations-router-head]: /6.0/api/phalcon_annotations/#annotationsrouterhead
[annotations-router-options]: /6.0/api/phalcon_annotations/#annotationsrouteroptions
[annotations-router-patch]: /6.0/api/phalcon_annotations/#annotationsrouterpatch
[annotations-router-post]: /6.0/api/phalcon_annotations/#annotationsrouterpost
[annotations-router-purge]: /6.0/api/phalcon_annotations/#annotationsrouterpurge
[annotations-router-put]: /6.0/api/phalcon_annotations/#annotationsrouterput
[annotations-router-route]: /6.0/api/phalcon_annotations/#annotationsrouterroute
[annotations-router-routeprefix]: /6.0/api/phalcon_annotations/#annotationsrouterrouteprefix
[annotations-router-trace]: /6.0/api/phalcon_annotations/#annotationsroutertrace
[config]: /6.0/config/
[phalcon-annotations-package]: https://github.com/phalcon/annotations

Source: https://docs.phalcon.io/6.0/annotations/index.mdx
