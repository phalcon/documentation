...
[datamapper-pdo-connection]: /6.0/api/phalcon_datamapper/#datamapperpdoconnection
[datamapper-pdo-connection-abstractconnection]: /6.0/api/phalcon_datamapper/#datamapperpdoconnectionabstractconnection
[datamapper-pdo-connection-connectioninterface]: /6.0/api/phalcon_datamapper/#datamapperpdoconnectionconnectioninterface
[datamapper-pdo-connection-decorated]: /6.0/api/phalcon_datamapper/#datamapperpdoconnectiondecorated
[datamapper-pdo-connection-pdointerface]: /6.0/api/phalcon_datamapper/#datamapperpdoconnectionpdointerface
[datamapper-pdo-connectionlocator]: /6.0/api/phalcon_datamapper/#datamapperpdoconnectionlocator
[datamapper-pdo-connectionlocatorinterface]: /6.0/api/phalcon_datamapper/#datamapperpdoconnectionlocatorinterface
[datamapper-pdo-events]: /6.0/api/phalcon_datamapper/#datamapperpdoevents
[datamapper-pdo-exception-cannotdisconnect]: /6.0/api/phalcon_datamapper/#datamapperpdoexceptioncannotdisconnect
[datamapper-pdo-exception-connectionnotfound]: /6.0/api/phalcon_datamapper/#datamapperpdoexceptionconnectionnotfound
[datamapper-pdo-exception-exception]: /6.0/api/phalcon_datamapper/#datamapperpdoexceptionexception
[datamapper-pdo-exception-operationcancelled]: /6.0/api/phalcon_datamapper/#datamapperpdoexceptionoperationcancelled
[datamapper-pdo-profiler-memorylogger]: /6.0/api/phalcon_datamapper/#datamapperpdoprofilermemorylogger
[datamapper-pdo-profiler-profiler]: /6.0/api/phalcon_datamapper/#datamapperpdoprofilerprofiler
[datamapper-pdo-profiler-profilerinterface]: /6.0/api/phalcon_datamapper/#datamapperpdoprofilerprofilerinterface
[datamapper-query-abstractconditions]: /6.0/api/phalcon_datamapper/#datamapperqueryabstractconditions
[datamapper-query-abstractquery]: /6.0/api/phalcon_datamapper/#datamapperqueryabstractquery
[datamapper-query-bind]: /6.0/api/phalcon_datamapper/#datamapperquerybind
[datamapper-query-delete]: /6.0/api/phalcon_datamapper/#datamapperquerydelete
[datamapper-query-insert]: /6.0/api/phalcon_datamapper/#datamapperqueryinsert
[datamapper-query-queryfactory]: /6.0/api/phalcon_datamapper/#datamapperqueryqueryfactory
[datamapper-query-select]: /6.0/api/phalcon_datamapper/#datamapperqueryselect
[datamapper-query-update]: /6.0/api/phalcon_datamapper/#datamapperqueryupdate
[eaa]: https://martinfowler.com/books/eaa.html
[events-manager]: /6.0/api/phalcon_events/#eventsmanager
[logger]: /6.0/logger/

Source: https://docs.phalcon.io/6.0/datamapper/index.mdx
