...
[session-adapter-abstractadapter]: /6.0/api/phalcon_session/#sessionadapterabstractadapter
[session-adapter-libmemcached]: /6.0/api/phalcon_session/#sessionadapterlibmemcached
[session-adapter-noop]: /6.0/api/phalcon_session/#sessionadapternoop
[session-adapter-redis]: /6.0/api/phalcon_session/#sessionadapterredis
[session-adapter-stream]: /6.0/api/phalcon_session/#sessionadapterstream
[session-bag]: /6.0/api/phalcon_session/#sessionbag
[session-exception]: /6.0/api/phalcon_session/#sessionexception
[session-manager]: /6.0/api/phalcon_session/#sessionmanager
[session-managerinterface]: /6.0/api/phalcon_session/#sessionmanagerinterface
...
[storage-adapter]: /6.0/api/phalcon_storage/#storageadapterabstractadapter
...
Source: https://docs.phalcon.io/6.0/session/index.mdx
