...
[Phalcon\Autoload\Loader][loader] is an autoloader that implements [PSR-4][psr-4]. Just like any autoloader, depending on its setup, it will try to find the files your code is looking for based on file, class, namespace, etc.
...
Unregistering the autoloader is similar. All you need to do is call `unregister()`.
...
then the loader, as defined above, does not need to know about the `MyApp\Components` namespace location, or have it defined in the ` ()` declaration.
...
Any exceptions thrown in the `Phalcon\Autoload` component will be of type [Phalcon\Autoload\Exception][loader-exception]. You can use this exception to selectively catch exceptions thrown only from this component.
...
[events]: /6.0/api/phalcon_events/#eventsmanager
[eventsawareinterface]: /6.0/api/phalcon_events/#eventseventsawareinterface
...
[loader]: /6.0/api/phalcon_autoload/#autoloadloader
[loader-exception]: /6.0/api/phalcon_autoload/#autoloadexception
...
Source: https://docs.phalcon.io/6.0/autoload/index.mdx
