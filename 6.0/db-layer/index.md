...
Models hydrate spatial columns into these objects on read when `orm.cast_on_hydrate` is enabled. See [Spatial Column Hydration](/6.0/db-models/) in the models documentation.
...
[db-adapter-abstractadapter]: /6.0/api/phalcon_db/#dbadapterabstractadapter
[db-adapter-adapterinterface]: /6.0/api/phalcon_db/#dbadapteradapterinterface
[db-adapter-pdo-abstractpdo]: /6.0/api/phalcon_db/#dbadapterpdoabstractpdo
[db-adapter-pdo-mysql]: /6.0/api/phalcon_db/#dbadapterpdomysql
[db-adapter-pdo-postgresql]: /6.0/api/phalcon_db/#dbadapterpdopostgresql
[db-adapter-pdo-sqlite]: /6.0/api/phalcon_db/#dbadapterpdosqlite
[db-adapter-pdofactory]: /6.0/api/phalcon_db/#dbadapterpdofactory
[db-column]: /6.0/api/phalcon_db/#dbcolumn
[db-columninterface]: /6.0/api/phalcon_db/#dbcolumninterface
[db-dialect]: /6.0/api/phalcon_db/#dbdialect
[db-dialect-mysql]: /6.0/api/phalcon_db/#dbdialectmysql
[db-dialect-postgresql]: /6.0/api/phalcon_db/#dbdialectpostgresql
[db-dialect-sqlite]: /6.0/api/phalcon_db/#dbdialectsqlite
[db-dialectinterface]: /6.0/api/phalcon_db/#dbdialectinterface
[db-enum]: /6.0/api/phalcon_db/#dbenum
[db-exception]: /6.0/api/phalcon_db/#dbexception
[db-index]: /6.0/api/phalcon_db/#dbindex
[db-indexinterface]: /6.0/api/phalcon_db/#dbindexinterface
[db-phql]: /6.0/db-phql/
[db-profiler]: /6.0/api/phalcon_db/#dbprofiler
[db-profiler-item]: /6.0/api/phalcon_db/#dbprofileritem
[db-rawvalue]: /6.0/api/phalcon_db/#dbrawvalue
[db-reference]: /6.0/api/phalcon_db/#dbreference
[db-referenceinterface]: /6.0/api/phalcon_db/#dbreferenceinterface
[db-result-pdo]: /6.0/api/phalcon_db/#dbresultpdoresult
[db-resultinterface]: /6.0/api/phalcon_db/#dbresultinterface
[events]: /6.0/events/
[logger]: /6.0/logger/
...
Source: https://docs.phalcon.io/6.0/db-layer/index.mdx
