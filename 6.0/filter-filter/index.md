...
[filter-exception]: /6.0/api/phalcon_filter/#filterexception
[filter-filter]: /6.0/api/phalcon_filter/
[filter-filterfactory]: /6.0/api/phalcon_filter/#filterfilterfactory
[filter-filterinterface]: /6.0/api/phalcon_filter/#filterfilterinterface
[filter-sanitize-absint]: /6.0/api/phalcon_filter/#filtersanitizeabsint
[filter-sanitize-alnum]: /6.0/api/phalcon_filter/#filtersanitizealnum
[filter-sanitize-alpha]: /6.0/api/phalcon_filter/#filtersanitizealpha
[filter-sanitize-boolval]: /6.0/api/phalcon_filter/#filtersanitizeboolval
[filter-sanitize-email]: /6.0/api/phalcon_filter/#filtersanitizeemail
[filter-sanitize-floatval]: /6.0/api/phalcon_filter/#filtersanitizefloatval
[filter-sanitize-intval]: /6.0/api/phalcon_filter/#filtersanitizeintval
[filter-sanitize-ip]: /6.0/api/phalcon_filter/#filtersanitizeip
[filter-sanitize-lower]: /6.0/api/phalcon_filter/#filtersanitizelower
[filter-sanitize-lowerfirst]: /6.0/api/phalcon_filter/#filtersanitizelowerfirst
[filter-sanitize-regex]: /6.0/api/phalcon_filter/#filtersanitizeregex
[filter-sanitize-remove]: /6.0/api/phalcon_filter/#filtersanitizeremove
[filter-sanitize-replace]: /6.0/api/phalcon_filter/#filtersanitizereplace
[filter-sanitize-special]: /6.0/api/phalcon_filter/#filtersanitizespecial
[filter-sanitize-specialfull]: /6.0/api/phalcon_filter/#filtersanitizespecialfull
[filter-sanitize-stringval]: /6.0/api/phalcon_filter/#filtersanitizestringval
[filter-sanitize-striptags]: /6.0/api/phalcon_filter/#filtersanitizestriptags
[filter-sanitize-trim]: /6.0/api/phalcon_filter/#filtersanitizetrim
[filter-sanitize-upper]: /6.0/api/phalcon_filter/#filtersanitizeupper
[filter-sanitize-upperfirst]: /6.0/api/phalcon_filter/#filtersanitizeupperfirst
[filter-sanitize-upperwords]: /6.0/api/phalcon_filter/#filtersanitizeupperwords
[filter-sanitize-url]: /6.0/api/phalcon_filter/#filtersanitizeurl
[filter_var]: https://www.php.net/manual/en/function.filter-var.php
[htmlspecialchars]: https://www.php.net/manual/en/function.htmlspecialchars.php
[http-request]: /6.0/api/phalcon_http/#httprequest
...
Source: https://docs.phalcon.io/6.0/filter-filter/index.mdx
