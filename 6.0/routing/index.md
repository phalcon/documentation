...
Converters are snippets of code that allow you to convert the parameters of a route prior to it being sent to the [dispatcher](/6.0/dispatcher/)
...
Similar to other Phalcon components, [Phalcon\Mvc\Router][mvc-router] also has events, when an [Events Manager](/6.0/events/) is present. The available events are:
...
The same routes can be written as PHP attributes. `Phalcon\Annotations\Router` holds one class for each annotation of the table above. The router reads the two forms in the same way and produces the same routes.
...
[config-factory]: /6.0/api/phalcon_config/#configconfigfactory
[config-interface]: /6.0/api/phalcon_config/#configconfiginterface
...
[mvc-router-exception]: /6.0/api/phalcon_mvc/#mvcrouterexception
[mvc-router-factory]: /6.0/api/phalcon_mvc/#mvcrouterrouterfactory
[mvc-router-group]: /6.0/api/phalcon_mvc/#mvcroutergroup
[mvc-router-groupinterface]: /6.0/api/phalcon_mvc/#mvcroutergroupinterface
[mvc-router-route]: /6.0/api/phalcon_mvc/#mvcrouterroute
[mvc-router-routeinterface]: /6.0/api/phalcon_mvc/#mvcrouterrouteinterface
[mvc-routerinterface]: /6.0/api/phalcon_mvc/#mvcrouterinterface
[mvc-url]: /6.0/mvc/
[pcre]: https://www.php.net/manual/en/book.pcre.php
[transformers]: https://transformers.hasbro.com/en-us

Source: https://docs.phalcon.io/6.0/routing/index.mdx
