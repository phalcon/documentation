...
The [Phalcon\Mvc\Model][mvc-model] is a full-featured ORM for PHP, giving developers a straightforward way to interact with databases.
...
The value-object classes are described under [Spatial / Geometry Columns](/6.0/db-layer/) in the database-layer documentation.
...
[db-models-relationships]: /6.0/db-models-relationships/
[models-relationships-eager]: /6.0/db-models-relationships/#eager-loading
[cache]: /6.0/cache/
[creating-models]: #creating-models
[db]: /6.0/db-layer/
[db-models-transactions]: /6.0/db-models-transactions/
[db-phql]: /6.0/db-phql/
[db-rawvalue]: /6.0/api/phalcon_db/#dbrawvalue
[DRY]: https://en.wikipedia.org/wiki/Don%27t_repeat_yourself
[events]: /6.0/events/
[finding-records]: #finding-records
[flash]: /6.0/flash/
[mvc-model]: /6.0/api/phalcon_mvc/#mvcmodel
[mvc-model-binder]: /6.0/api/phalcon_mvc/#mvcmodelbinder
[mvc-model-binder-bindableinterface]: /6.0/api/phalcon_mvc/#mvcmodelbinderbindableinterface
[mvc-model-binderinterface]: /6.0/api/phalcon_mvc/#mvcmodelbinderinterface
[mvc-model-criteria]: /6.0/api/phalcon_mvc/#mvcmodelcriteria
[mvc-model-criteriainterface]: /6.0/api/phalcon_mvc/#mvcmodelcriteriainterface
[mvc-model-exception]: /6.0/api/phalcon_mvc/#mvcmodelexception
[mvc-model-manager]: /6.0/api/phalcon_mvc/#mvcmodelmanager
[mvc-model-managerinterface]: /6.0/api/phalcon_mvc/#mvcmodelmanagerinterface
[mvc-model-query]: /6.0/api/phalcon_mvc/#mvcmodelquery
[mvc-model-query-builder]: /6.0/api/phalcon_mvc/#mvcmodelquerybuilder
[mvc-model-query-builderinterface]: /6.0/api/phalcon_mvc/#mvcmodelquerybuilderinterface
[mvc-model-query-status]: /6.0/api/phalcon_mvc/#mvcmodelquerystatus
[mvc-model-query-statusinterface]: /6.0/api/phalcon_mvc/#mvcmodelquerystatusinterface
[mvc-model-queryinterface]: /6.0/api/phalcon_mvc/#mvcmodelqueryinterface
[mvc-model-relation]: /6.0/api/phalcon_mvc/#mvcmodelrelation
[mvc-model-relationinterface]: /6.0/api/phalcon_mvc/#mvcmodelrelationinterface
[mvc-model-resultinterface]: /6.0/api/phalcon_mvc/#mvcmodelresultinterface
[mvc-model-resultset]: /6.0/api/phalcon_mvc/#mvcmodelresultset
[mvc-model-resultset-complex]: /6.0/api/phalcon_mvc/#mvcmodelresultsetcomplex
[mvc-model-resultset-simple]: /6.0/api/phalcon_mvc/#mvcmodelresultsetsimple
[mvc-model-resultsetinterface]: /6.0/api/phalcon_mvc/#mvcmodelresultsetinterface
[mvc-model-row]: /6.0/api/phalcon_mvc/#mvcmodelrow
[mvc-model-validationfailed]: /6.0/api/phalcon_mvc/#mvcmodelvalidationfailed
[mvc-modelinterface]: /6.0/api/phalcon_mvc/#mvcmodelinterface
[pdo-statements]: https://php.net/manual/en/pdo.prepared-statements.php
[transactions]: #transactions

Source: https://docs.phalcon.io/6.0/db-models/index.mdx
