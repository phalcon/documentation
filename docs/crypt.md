...
Phalcon provides encryption facilities via the [Phalcon\Crypt](api/Phalcon_Crypt.md) component. This class offers simple object-oriented wrappers to the [openssl](https://www.php.net/manual/en/book.openssl.php) PHP's encryption library.
