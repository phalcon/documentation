...
As with most Phalcon components, you can store the [Phalcon\Crypt][crypt] object in your [Phalcon\Di](di.md) container. By doing so, you will be able to access your configuration object from controllers, models, views and any component that implements `Injectable`.
...
[crypt]: api/phalcon_crypt.md#crypt
[crypt-cryptinterface]: api/phalcon_crypt.md#crypt-cryptinterface
[crypt-exception]: api/phalcon_crypt.md#crypt-exception
[crypt-mismatch]: api/phalcon_crypt.md#crypt-mismatch
