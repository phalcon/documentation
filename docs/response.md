# Returning Responses
Part of the HTTP cycle is returning responses to clients. [Phalcon\Http\Response](api/Phalcon_Http.md) is the Phalcon component designed to achieve this task. HTTP responses are usually composed by headers and body. The following is an example of basic usage:
...
A [Phalcon\Http\Response\Headers](api/Phalcon_Http.md) bag internally manages headers. This class retrieves the headers before sending it to client:
...
## Making Redirections
With [Phalcon\Http\Response](api/Phalcon_Http.md) you can also execute HTTP redirections:
...
All internal URIs are generated using the [url](url.md) service (by default [Phalcon\Mvc\Url](api/Phalcon_Mvc_Url.md)). This example demonstrates how you can redirect using a route you have defined in your application:
