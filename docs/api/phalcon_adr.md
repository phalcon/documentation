...
- **`Phalcon\ADR\Application`** - implements [`Phalcon\Contracts\ADR\Application`](phalcon_contracts.md#contractsadrapplication)
...
#### `factory()` { #adrapplication-factory }
...
#### `getContainer()` { #adrapplication-getcontainer }
...
#### `secureWith()` { #adrapplication-securewith }
...
#### `setActionDirectory()` { #adrapplication-setactiondirectory }
...
#### `setBaseNamespace()` { #adrapplication-setbasenamespace }
...
#### `setWordSeparator()` { #adrapplication-setwordseparator }
...
- **`Phalcon\ADR\Container\AdrProvider`** - implements [`Phalcon\Contracts\Container\Service\Provider`](phalcon_contracts.md#contractscontainerserviceprovider)
...
#### `provide()` { #adrcontaineradrprovider-provide }
...
- **`Phalcon\ADR\Dispatcher`** - implements [`Phalcon\Contracts\ADR\Dispatcher`](phalcon_contracts.md#contractsadrdispatcher)
...
#### `__construct()` { #adrdispatcher-__construct }
...
#### `dispatch()` { #adrdispatcher-dispatch }
...
#### `resolveAll()` { #adrdispatcher-resolveall }

```php
protected function resolveAll( array $classes ): array;
```

#### `resolveGlobal()` { #adrdispatcher-resolveglobal }
...
- **`Phalcon\ADR\Emitter\SapiEmitter`** - implements [`Phalcon\Contracts\ADR\Emitter\Emitter`](phalcon_contracts.md#contractsadremitteremitter)
...
#### `emit()` { #adremittersapiemitter-emit }
...
#### `__construct()` { #adrerrorresponder-__construct }
...
#### `handle()` { #adrerrorresponder-handle }
...
#### `correlationId()` { #adrerrorresponder-correlationid }

```php
protected function correlationId( RequestInterface $request ): string;
```

#### `defaultMap()` { #adrerrorresponder-defaultmap }

```php
protected function defaultMap(): array;
```

#### `details()` { #adrerrorresponder-details }
...
#### `reason()` { #adrerrorresponder-reason }
...
- **`Phalcon\ADR\EventfulHandler`** - implements [`Phalcon\Contracts\ADR\Handler`](phalcon_contracts.md#contractsadrhandler)
...
#### `__construct()` { #adreventfulhandler-__construct }
...
#### `__invoke()` { #adreventfulhandler-__invoke }
...
#### `__construct()` { #adrexceptionsactiondirectorynotset-__construct }
...
#### `__construct()` { #adrexceptionsheadersalreadysent-__construct }
...
#### `__construct()` { #adrexceptionsmethodnotallowed-__construct }
...
#### `__construct()` { #adrexceptionsnotanaction-__construct }
...
#### `__construct()` { #adrexceptionsoutputalreadysent-__construct }
...
#### `__construct()` { #adrexceptionsroutenotfound-__construct }
...
- **`Phalcon\ADR\Front\AbstractHttpFront`** - implements [`Phalcon\Contracts\Front\FrontController`](phalcon_contracts.md#contractsfrontfrontcontroller)
...
#### `__construct()` { #adrfrontabstracthttpfront-__construct }

```php
public function __construct( string $projectRoot );
```

#### `boot()` { #adrfrontabstracthttpfront-boot }
...
#### `run()` { #adrfrontabstracthttpfront-run }
...
#### `buildContainer()` { #adrfrontabstracthttpfront-buildcontainer }

```php
protected function buildContainer(): Container;
```

#### `getApplication()` { #adrfrontabstracthttpfront-getapplication }
...
#### `handleBootError()` { #adrfrontabstracthttpfront-handlebooterror }

```php
protected function handleBootError( \Throwable $exception ): int;
```

#### `loadEnvironment()` { #adrfrontabstracthttpfront-loadenvironment }

```php
protected function loadEnvironment( Container $container ): void;
```

#### `registerProviders()` { #adrfrontabstracthttpfront-registerproviders }
...
__Uses__ `Phalcon\Contracts\ADR\ADRTypes` · `Phalcon\Contracts\Http\AttributeRequest`
{ .api-uses }
...
#### `__construct()` { #adrinputinput-__construct }

```php
public function __construct( array $data = [] );
```

#### `fromArray()` { #adrinputinput-fromarray }

```php
public static function fromArray( array $data ): static;
```

#### `fromRequest()` { #adrinputinput-fromrequest }

```php
public static function fromRequest( AttributeRequest $request ): static;
```

#### `get()` { #adrinputinput-get }
...
#### `has()` { #adrinputinput-has }

```php
public function has( string $key ): bool;
```

#### `toArray()` { #adrinputinput-toarray }
...
- **`Phalcon\ADR\Middleware\CorsMiddleware`** - implements [`Phalcon\Contracts\ADR\Middleware`](phalcon_contracts.md#contractsadrmiddleware)
...
#### `__construct()` { #adrmiddlewarecorsmiddleware-__construct }

```php
public function __construct( array $config = [] );
```

#### `__invoke()` { #adrmiddlewarecorsmiddleware-__invoke }
...
#### `applyHeaders()` { #adrmiddlewarecorsmiddleware-applyheaders }
...
#### `isAllowed()` { #adrmiddlewarecorsmiddleware-isallowed }
...
- **`Phalcon\ADR\Middleware\MethodOverrideMiddleware`** - implements [`Phalcon\Contracts\ADR\Middleware`](phalcon_contracts.md#contractsadrmiddleware)
...
#### `__invoke()` { #adrmiddlewaremethodoverridemiddleware-__invoke }
...
- **`Phalcon\ADR\Middleware\RequestIdMiddleware`** - implements [`Phalcon\Contracts\ADR\Middleware`](phalcon_contracts.md#contractsadrmiddleware)
...
#### `__invoke()` { #adrmiddlewarerequestidmiddleware-__invoke }
...
- **`Phalcon\ADR\Middleware\TimingMiddleware`** - implements [`Phalcon\Contracts\ADR\Middleware`](phalcon_contracts.md#contractsadrmiddleware)
...
#### `__invoke()` { #adrmiddlewaretimingmiddleware-__invoke }
...
- **`Phalcon\ADR\Payload\Payload`** - implements [`Phalcon\Contracts\ADR\Payload\Payload`](phalcon_contracts.md#contractsadrpayloadpayload)
...
#### `accepted()` { #adrpayloadpayload-accepted }
...
#### `authenticated()` { #adrpayloadpayload-authenticated }
...
#### `authorized()` { #adrpayloadpayload-authorized }
...
#### `created()` { #adrpayloadpayload-created }
...
#### `deleted()` { #adrpayloadpayload-deleted }
...
#### `forbidden()` { #adrpayloadpayload-forbidden }
...
#### `getException()` { #adrpayloadpayload-getexception }
...
#### `getExtras()` { #adrpayloadpayload-getextras }
...
#### `getInput()` { #adrpayloadpayload-getinput }
...
#### `getMessages()` { #adrpayloadpayload-getmessages }
...
#### `getResult()` { #adrpayloadpayload-getresult }
...
#### `getStatus()` { #adrpayloadpayload-getstatus }
...
#### `invalid()` { #adrpayloadpayload-invalid }
...
#### `notAccepted()` { #adrpayloadpayload-notaccepted }
...
#### `notCreated()` { #adrpayloadpayload-notcreated }
...
#### `notDeleted()` { #adrpayloadpayload-notdeleted }
...
#### `notFound()` { #adrpayloadpayload-notfound }
...
#### `notUpdated()` { #adrpayloadpayload-notupdated }
...
#### `processing()` { #adrpayloadpayload-processing }
...
#### `success()` { #adrpayloadpayload-success }
...
#### `unauthenticated()` { #adrpayloadpayload-unauthenticated }
...
#### `updated()` { #adrpayloadpayload-updated }
...
#### `withException()` { #adrpayloadpayload-withexception }
...
#### `withExtras()` { #adrpayloadpayload-withextras }
...
#### `withInput()` { #adrpayloadpayload-withinput }
...
#### `withMessages()` { #adrpayloadpayload-withmessages }
...
#### `withResult()` { #adrpayloadpayload-withresult }
...
#### `withStatus()` { #adrpayloadpayload-withstatus }
...
#### `accepted()` { #adrpayloadpayloadfactory-accepted }
...
#### `authenticated()` { #adrpayloadpayloadfactory-authenticated }
...
#### `authorized()` { #adrpayloadpayloadfactory-authorized }
...
#### `created()` { #adrpayloadpayloadfactory-created }
...
#### `deleted()` { #adrpayloadpayloadfactory-deleted }
...
#### `error()` { #adrpayloadpayloadfactory-error }
...
#### `forbidden()` { #adrpayloadpayloadfactory-forbidden }
...
#### `found()` { #adrpayloadpayloadfactory-found }
...
#### `invalid()` { #adrpayloadpayloadfactory-invalid }
...
#### `notAccepted()` { #adrpayloadpayloadfactory-notaccepted }
...
#### `notCreated()` { #adrpayloadpayloadfactory-notcreated }
...
#### `notDeleted()` { #adrpayloadpayloadfactory-notdeleted }
...
#### `notFound()` { #adrpayloadpayloadfactory-notfound }
...
#### `notUpdated()` { #adrpayloadpayloadfactory-notupdated }
...
#### `processing()` { #adrpayloadpayloadfactory-processing }
...
#### `success()` { #adrpayloadpayloadfactory-success }
...
#### `unauthenticated()` { #adrpayloadpayloadfactory-unauthenticated }
...
#### `updated()` { #adrpayloadpayloadfactory-updated }
...
#### `valid()` { #adrpayloadpayloadfactory-valid }
...
- **`Phalcon\ADR\Pipeline`** - implements [`Phalcon\Contracts\ADR\Handler`](phalcon_contracts.md#contractsadrhandler)
...
#### `__construct()` { #adrpipeline-__construct }
...
__Uses__ `Phalcon\Contracts\ADR\Responder\Formatter\Formatter`
{ .api-uses }
...
#### `__construct()` { #adrresponderabstractformattedresponder-__construct }
...
- **`Phalcon\ADR\Responder\ChainResponder`** - implements [`Phalcon\Contracts\ADR\Responder\Responder`](phalcon_contracts.md#contractsadrresponderresponder)
...
#### `__construct()` { #adrresponderchainresponder-__construct }

```php
public function __construct( array $links = [] );
```

#### `__invoke()` { #adrresponderchainresponder-__invoke }
...
#### `with()` { #adrresponderchainresponder-with }
...
- **`Phalcon\ADR\Responder\FormatResponder`** - implements [`Phalcon\Contracts\ADR\Responder\Responder`](phalcon_contracts.md#contractsadrresponderresponder)

</div>

__Uses__ `Phalcon\Contracts\ADR\Payload\Payload` · `Phalcon\Contracts\ADR\Responder\Formatter\Formatter` · `Phalcon\Contracts\ADR\Responder\Responder` · `Phalcon\Http\RequestInterface` · `Phalcon\Http\ResponseInterface`
{ .api-uses }
...
#### `__construct()` { #adrresponderformatresponder-__construct }

```php
public function __construct( array $formatters = [] );
```

#### `__invoke()` { #adrresponderformatresponder-__invoke }
...
- **`Phalcon\ADR\Responder\Formatter\JsonFormatter`** - implements [`Phalcon\Contracts\ADR\Responder\Formatter\Formatter`](phalcon_contracts.md#contractsadrresponderformatterformatter)
...
#### `accepts()` { #adrresponderformatterjsonformatter-accepts }

```php
public function accepts( string $acceptHeader ): bool;
```

#### `contentType()` { #adrresponderformatterjsonformatter-contenttype }

```php
public function contentType(): string;
```

#### `format()` { #adrresponderformatterjsonformatter-format }
...
- **`Phalcon\ADR\Responder\Formatter\TextFormatter`** - implements [`Phalcon\Contracts\ADR\Responder\Formatter\Formatter`](phalcon_contracts.md#contractsadrresponderformatterformatter)

</div>

__Uses__ `Phalcon\Contracts\ADR\Payload\Payload` · `Phalcon\Contracts\ADR\Responder\Formatter\Formatter` · `Stringable`
{ .api-uses }
...
#### `accepts()` { #adrresponderformattertextformatter-accepts }

```php
public function accepts( string $acceptHeader ): bool;
```

#### `contentType()` { #adrresponderformattertextformatter-contenttype }

```php
public function contentType(): string;
```

#### `format()` { #adrresponderformattertextformatter-format }
...
#### `__construct()` { #adrresponderjsonresponder-__construct }
...
#### `seeOther()` { #adrresponderredirect-seeother }

```php
public static function seeOther( string $url ): Redirect;
```

#### `status()` { #adrresponderredirect-status }

```php
public function status(): int;
```

#### `temporary()` { #adrresponderredirect-temporary }

```php
public static function temporary( string $url ): Redirect;
```

#### `url()` { #adrresponderredirect-url }
...
- **`Phalcon\ADR\Responder\RedirectResponder`** - implements [`Phalcon\Contracts\ADR\Responder\Responder`](phalcon_contracts.md#contractsadrresponderresponder)
...
#### `__invoke()` { #adrresponderredirectresponder-__invoke }
...
#### `__construct()` { #adrresponderstatusmapper-__construct }

```php
public function __construct( array $overrides = [] );
```

#### `toHttpCode()` { #adrresponderstatusmapper-tohttpcode }
...
- **`Phalcon\ADR\Responder\StatusResponder`** - implements [`Phalcon\Contracts\ADR\Responder\Responder`](phalcon_contracts.md#contractsadrresponderresponder)
...
#### `__construct()` { #adrrespondertextresponder-__construct }
...
- **`Phalcon\ADR\Responder\ViewResponder`** - implements [`Phalcon\Contracts\ADR\Responder\Responder`](phalcon_contracts.md#contractsadrresponderresponder)
...
#### `__construct()` { #adrresponderviewresponder-__construct }
...
#### `__invoke()` { #adrresponderviewresponder-__invoke }
...
#### `withTemplate()` { #adrresponderviewresponder-withtemplate }
...
#### `viewData()` { #adrresponderviewresponder-viewdata }
...
- **`Phalcon\ADR\Router\AttributeFilter`** - implements [`Phalcon\Contracts\ADR\Router\AttributeFilter`](phalcon_contracts.md#contractsadrrouterattributefilter)
...
#### `filter()` { #adrrouterattributefilter-filter }
...
#### `cast()` { #adrrouterattributefilter-cast }
...
- **`Phalcon\ADR\Router\Router`** - implements [`Phalcon\Contracts\ADR\Router\Router`](phalcon_contracts.md#contractsadrrouterrouter)
...
<span class="desc">The first derived candidate whose class actually exists, together with</span>
</a>
...
#### `candidatesFor()` { #adrrouterrouter-candidatesfor }
...
#### `classFor()` { #adrrouterrouter-classfor }
...
#### `actionParams()` { #adrrouterrouter-actionparams }
...
#### `camelize()` { #adrrouterrouter-camelize }

```php
protected function camelize( string $segment ): string;
```

#### `decamelize()` { #adrrouterrouter-decamelize }

```php
protected function decamelize( string $part ): string;
```

#### `deriveCandidates()` { #adrrouterrouter-derivecandidates }
...
#### `hasSubNamespace()` { #adrrouterrouter-hassubnamespace }

```php
protected function hasSubNamespace( string $subNamespace ): bool;
```

#### `locate()` { #adrrouterrouter-locate }
...
#### `middlewareFor()` { #adrrouterrouter-middlewarefor }

```php
protected function middlewareFor( string $className ): array;
```

#### `verbOf()` { #adrrouterrouter-verbof }
...
- **`Phalcon\ADR\Router\RouterMatch`** - implements [`Phalcon\Contracts\ADR\Router\RouterMatch`](phalcon_contracts.md#contractsadrrouterroutermatch)
...
#### `__construct()` { #adrrouterroutermatch-__construct }
...
#### `getAction()` { #adrrouterroutermatch-getaction }

```php
public function getAction(): string;
```

#### `getAttributes()` { #adrrouterroutermatch-getattributes }

```php
public function getAttributes(): array;
```

#### `getMiddleware()` { #adrrouterroutermatch-getmiddleware }

```php
public function getMiddleware(): array;
```

#### `getName()` { #adrrouterroutermatch-getname }
