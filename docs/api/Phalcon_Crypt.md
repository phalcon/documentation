...
*implements* [Phalcon\CryptInterface](Phalcon_Crypt.md)
...
Throws [Phalcon\Crypt\Mismatch](Phalcon_Crypt.md)
...
public **setCipher** (*mixed* $cipher): *[Phalcon\Crypt](Phalcon_Crypt.md)*
...
Throws: [Phalcon\Crypt\Exception](Phalcon_Crypt.md)



public **setHashAlgo** (*string* $hashAlgo): *[Phalcon\Crypt](Phalcon_Crypt.md)*

Set the name of hashing algorithm to calculate the message digest. Throws [Phalcon\Crypt\Exception](Phalcon_Crypt.md) if the algorithm is not supported by the system



public **setKey** (*mixed* $key): *[Phalcon\Crypt](Phalcon_Crypt.md)*
...
See also: : [Phalcon\Security\Random](Phalcon_Security.md)



public **setPadding** (*mixed* $scheme): *[Phalcon\Crypt](Phalcon_Crypt.md)*

Changes the padding scheme used



public **useSigning** (*boolean* $useSigning): *[Phalcon\Crypt](Phalcon_Crypt.md)*
...
*extends* class [Phalcon\Crypt\Exception](Phalcon_Crypt.md)
