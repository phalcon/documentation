...
*implements* [Phalcon\Mvc\Model\MessageInterface](Phalcon_Mvc_Model_Message.md)
...
## Methods
public  **__construct** (*string* $message, [*string* | *array* $field], [*string* $type], [[Phalcon\Mvc\ModelInterface](Phalcon_Mvc_Model.md) $model], [*int* | *null* $code])
...
public  **setModel** ([Phalcon\Mvc\ModelInterface](Phalcon_Mvc_Model.md) $model)
