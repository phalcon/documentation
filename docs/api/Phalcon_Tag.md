...
public static  **setDI** ([Phalcon\DiInterface](Phalcon_Di.md) $dependencyInjector)
...
private static  **_optionsFromResultset** ([Phalcon\Mvc\Model\Resultset](Phalcon_Mvc_Model_Resultset.md) $resultset, *array* $using, *mixed* $value, *string* $closeOption)
