...
[Phalcon\Mvc\Url](api/Phalcon_Mvc_Url.md) is the component responsible of generate URLs in a Phalcon application. It's capable of produce independent URLs based on routes.
...
[Phalcon\Tag](api/Phalcon_Tag.md) will request both dynamic and static URIs using this component.


## Implementing your own URL Generator
The [Phalcon\Mvc\UrlInterface](api/Phalcon_Mvc_Url.md) interface must be implemented to create your own URL generator replacing the one provided by Phalcon.
