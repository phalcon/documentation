...
[db-adapter-abstractadapter]: api/phalcon_db/#dbadapterabstractadapter
[db-adapter-adapterinterface]: api/phalcon_db/#dbadapteradapterinterface
[db-adapter-pdo-abstractpdo]: api/phalcon_db/#dbadapterpdoabstractpdo
[db-adapter-pdo-mysql]: api/phalcon_db/#dbadapterpdomysql
[db-adapter-pdo-postgresql]: api/phalcon_db/#dbadapterpdopostgresql
[db-adapter-pdo-sqlite]: api/phalcon_db/#dbadapterpdosqlite
[db-adapter-pdofactory]: api/phalcon_db/#dbadapterpdofactory
[db-column]: api/phalcon_db/#dbcolumn
[db-columninterface]: api/phalcon_db/#dbcolumninterface
[db-dialect]: api/phalcon_db/#dbdialect
[db-dialect-mysql]: api/phalcon_db/#dbdialectmysql
[db-dialect-postgresql]: api/phalcon_db/#dbdialectpostgresql
[db-dialect-sqlite]: api/phalcon_db/#dbdialectsqlite
[db-dialectinterface]: api/phalcon_db/#dbdialectinterface
[db-enum]: api/phalcon_db/#dbenum
[db-exception]: api/phalcon_db/#dbexception
[db-index]: api/phalcon_db/#dbindex
[db-indexinterface]: api/phalcon_db/#dbindexinterface
[db-profiler]: api/phalcon_db/#dbprofiler
[db-profiler-item]: api/phalcon_db/#dbprofileritem
[db-rawvalue]: api/phalcon_db/#dbrawvalue
[db-reference]: api/phalcon_db/#dbreference
[db-referenceinterface]: api/phalcon_db/#dbreferenceinterface
[db-result-pdo]: api/phalcon_db/#dbresultpdoresult
[db-resultinterface]: api/phalcon_db/#dbresultinterface
