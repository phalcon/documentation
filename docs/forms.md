...
## Entities
An entity such as a [Phalcon\Mvc\Model](db-models.md), a PHP class or even a `\stdClass` object can be passed to the form in order to set default values, or to assign the values from the form to the object.
