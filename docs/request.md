...
[http-message-abstractcommon]: api/phalcon_http.md#http-message-abstractcommon
[http-message-abstractmessage]: api/phalcon_http.md#http-message-abstractmessage
[http-message-abstractrequest]: api/phalcon_http.md#http-message-abstractrequest
[http-message-exception-invalidargumentexception]: api/phalcon_http.md#http-message-exception-invalidargumentexception
[http-request]: api/phalcon_http.md#http-request
[http-request-exception]: api/phalcon_http.md#http-request-exception
[http-request-file]: api/phalcon_http.md#http-request-file
[http-request-fileinterface]: api/phalcon_http.md#http-request-fileinterface
[http-requestinterface]: api/phalcon_http.md#http-requestinterface
