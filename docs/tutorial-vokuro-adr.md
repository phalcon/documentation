...
The application is then on <http://localhost:8081> and Mailpit on <http://localhost:8026>. Sign in with a seeded account, for example `sarah.connor@skynet.dev` / `password1`.
...
[adr]: adr.md
[adr_actions]: adr-actions.md
[adr_domain]: adr-domain.md
[adr_front]: adr-front-controller.md
[adr_input]: adr-input.md
[adr_middleware]: adr-middleware.md
[adr_pattern]: https://pmjones.io/adr/
[adr_payload]: adr-payload.md
[adr_responders]: adr-responders.md
[datamapper]: datamapper.md
[github_vokuro_adr]: https://github.com/phalcon/vokuro-adr
[mailpit]: https://mailpit.axllent.org
[mvc_to_adr]: mvc-to-adr.md
[tutorial_vokuro]: tutorial-vokuro.md
