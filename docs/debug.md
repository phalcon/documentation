...
Any exception thrown within the block is captured in the variable `$e`. A [Phalcon\Exception](api/Phalcon_Exception.md) extends the PHP [Exception class](https://www.php.net/manual/en/language.exceptions.php) and is used to understand whether the exception came from Phalcon or PHP itself.
...
Retrieving information from [Phalcon\Exception](api/Phalcon_Exception.md) is the same as PHP's [Exception class](https://www.php.net/manual/en/language.exceptions.php):
