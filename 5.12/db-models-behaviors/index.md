...
[events-list]: /5.12/events/#list-of-events
[mvc-model-behavior]: /5.12/api/phalcon_mvc/#mvcmodelbehavior
[mvc-model-behavior-softdelete]: /5.12/api/phalcon_mvc/#mvcmodelbehaviorsoftdelete
[mvc-model-behavior-timestampable]: /5.12/api/phalcon_mvc/#mvcmodelbehaviortimestampable
[mvc-model-behaviorinterface]: /5.12/api/phalcon_mvc/#mvcmodelbehaviorinterface
[time]: https://php.net/manual/en/function.time.php
[traits]: https://php.net/manual/en/language.oop5.traits.php
[events]: /5.12/events/

Source: https://docs.phalcon.io/5.12/db-models-behaviors/index.mdx
