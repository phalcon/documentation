...
```php
public function validate( mixed $data = null, mixed $entity = null, array $whitelist = [] ): Messages | bool;
```
...
Source: https://docs.phalcon.io/5.12/api/phalcon_filter/index.mdx
