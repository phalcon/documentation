...
## Requirements
### PHP 8.1
Phalcon v5.12 supports only PHP 8.1 and above. PHP 8.1 [active support][php-support] has already expired, including security fixes. We will be supporting this version for a while longer, offering developers more time to upgrade their applications.
...
[phalcon-acl]: /5.12/acl/
[phalcon-annotations]: /5.12/annotations/
[phalcon-application]: /5.12/application/
[phalcon-assets]: /5.12/assets/
[phalcon-autoload]: /5.12/autoload/
[phalcon-cache]: /5.12/cache/
[phalcon-application-cli]: /5.12/application-cli/
[phalcon-support-collection]: /5.12/support-collection/
[phalcon-config]: /5.12/config/
[phalcon-encryption-crypt]: /5.12/encryption-crypt/
[phalcon-datamapper]: /5.12/datamapper/
[phalcon-db-layer]: /5.12/db-layer/
[phalcon-support-debug]: /5.12/support-debug/
[phalcon-di]: /5.12/di/
[phalcon-dispatcher]: /5.12/dispatcher/
[phalcon-domain]: /5.12/domain/
[phalcon-encryption-crypt]: /5.12/encryption-crypt/
[phalcon-html-escaper]: /5.12/html-escaper/
[phalcon-events]: /5.12/events/
[phalcon-filter-filter]: /5.12/filter-filter/
[phalcon-flash]: /5.12/flash/
[phalcon-forms]: /5.12/forms/
[phalcon-support-helper]: /5.12/support-helper/
[phalcon-html]: /5.12/html/
[phalcon-datamapper]: /5.12/datamapper/
[phalcon-logger]: /5.12/logger/
[phalcon-mvc]: /5.12/mvc/
[phalcon-db-pagination]: /5.12/db-pagination/
[phalcon-support-registry]: /5.12/support-registry/
[phalcon-encryption-security]: /5.12/encryption-security/
[phalcon-session]: /5.12/session/
[phalcon-storage]: /5.12/storage/
[phalcon-tag]: /5.12/tag/
[phalcon-translate]: /5.12/translate/
[phalcon-mvc-url]: /5.12/mvc-url/
[phalcon-filter-validation]: /5.12/filter-validation/
[phalcon-support-version]: /5.12/support-version/
[phalcon-volt]: /5.12/volt/
[volt-tag-helpers]: /5.12/volt/#tag-helpers
[support]: #support
[phalcon-html-tagfactory]: /5.12/html-tagfactory/
[phalcon-html-link]: /5.12/html-link/
[support]: #support

Source: https://docs.phalcon.io/5.12/upgrade/index.mdx
