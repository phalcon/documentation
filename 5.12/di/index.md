...
[container]: /5.12/container/
[di]: /5.12/api/phalcon_di/#didi
[di-abstractinjectionaware]: /5.12/api/phalcon_di/#diabstractinjectionaware
[di-diinterface]: /5.12/api/phalcon_di/#didiinterface
[di-exception]: /5.12/api/phalcon_di/#diexception
[di-exception-serviceresolutionexception]: /5.12/api/phalcon_di/#diexceptionserviceresolutionexception
[di-factorydefault]: /5.12/api/phalcon_di/#difactorydefault
[di-factorydefault-cli]: /5.12/api/phalcon_di/#difactorydefaultcli
[di-injectable]: /5.12/api/phalcon_di/#diinjectable
[di-injectionawareinterface]: /5.12/api/phalcon_di/#diinjectionawareinterface
[di-service]: /5.12/api/phalcon_di/#diservice
[di-service-builder]: /5.12/api/phalcon_di/#diservicebuilder
[di-serviceinterface]: /5.12/api/phalcon_di/#diserviceinterface
[di-serviceproviderinterface]: /5.12/api/phalcon_di/#diserviceproviderinterface
[ioc]: https://en.wikipedia.org/wiki/Inversion_of_control
[singleton]: https://en.wikipedia.org/wiki/Singleton_pattern
[yaml]: https://php.net/manual/book.yaml.php
[response]: /5.12/response/
[events]: /5.12/events/
[annotations]: /5.12/annotations/
[ssets]: /5.12/ssets/
[encryption-crypt]: /5.12/encryption-crypt/
[assets]: /5.12/assets/
[response-cookies]: /5.12/response/#cookies
[dispatcher]: /5.12/dispatcher/
[html-escaper]: /5.12/html-escaper/
[events]: /5.12/events/
[flash]: /5.12/flash/
[filter-filter]: /5.12/filter-filter/
[support-helper]: /5.12/support-helper/
[db-models]: /5.12/db-models/
[db-models-metadata]: /5.12/db-models-metadata/
[request]: /5.12/request/
[response]: /5.12/response/
[routing]: /5.12/routing/
[encryption-security]: /5.12/encryption-security/
[tagfactory]: /5.12/html-tagfactory/
[db-models-transactions]: /5.12/db-models-transactions/
[mvc-url]: /5.12/mvc-url/
[db-layer]: /5.12/db-layer/
[session-bag]: /5.12/session/#bag
[singletons]: https://en.wikipedia.org/wiki/Singleton_pattern

Source: https://docs.phalcon.io/5.12/di/index.mdx
