...
[config]: /5.12/api/phalcon_config/
[collection]: /5.12/support-collection/
[phalcon-incubator]: https://github.com/phalcon/incubator
[grouped]: /5.12/api/phalcon_config/#configadaptergrouped
[ini]: /5.12/api/phalcon_config/#configadapterini
[json]: /5.12/api/phalcon_config/#configadapterjson
[php]: /5.12/api/phalcon_config/#configadapterphp
[yaml]: /5.12/api/phalcon_config/#configadapteryaml
[config-config]: /5.12/api/phalcon_config/#configconfig
[config-configfactory]: /5.12/api/phalcon_config/#configconfigfactory
[config-exception]: /5.12/api/phalcon_config/#configexception
...
[di]: /5.12/di/
[support-collection]: /5.12/support-collection/

Source: https://docs.phalcon.io/5.12/config/index.mdx
