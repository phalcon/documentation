...
[di]: /5.12/di/
[di-factorydefault]: /5.12/di/#factory-default
[db-models-profiler]: /5.12/db-models-events/#profiling-sql-statements
[config]: /5.12/config/
[application]: /5.12/application/
[volt]: /5.12/volt/
[controllers]: /5.12/controllers/
[encryption-security]: /5.12/encryption-security/
[dispatcher]: /5.12/dispatcher/
[db-pagination]: /5.12/db-pagination/
[session-persistent-data]: /5.12/session/#persistent-data
[logger]: /5.12/logger/
[events]: /5.12/events/
[acl]: /5.12/acl/
[forms]: /5.12/forms/
...
Source: https://docs.phalcon.io/5.12/tutorial-invo/index.mdx
