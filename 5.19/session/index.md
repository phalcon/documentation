...
[session-adapter-abstractadapter]: /5.19/api/phalcon_session/#sessionadapterabstractadapter
[session-adapter-libmemcached]: /5.19/api/phalcon_session/#sessionadapterlibmemcached
[session-adapter-noop]: /5.19/api/phalcon_session/#sessionadapternoop
[session-adapter-redis]: /5.19/api/phalcon_session/#sessionadapterredis
[session-adapter-stream]: /5.19/api/phalcon_session/#sessionadapterstream
[session-bag]: /5.19/api/phalcon_session/#sessionbag
[session-exception]: /5.19/api/phalcon_session/#sessionexception
[session-manager]: /5.19/api/phalcon_session/#sessionmanager
[session-managerinterface]: /5.19/api/phalcon_session/#sessionmanagerinterface
...
[storage-adapter]: /5.19/api/phalcon_storage/#storageadapterabstractadapter
...
Source: https://docs.phalcon.io/5.19/session/index.mdx
