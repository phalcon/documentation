...
<a class="src-btn" href="https://github.com/phalcon/cphalcon/blob/5.0.x/phalcon/Auth/Adapter/Config/Traits/ModelConfigTrait.zep">Source on GitHub</a>
...
- **`Phalcon\Auth\AuthUser`** - implements [`Phalcon\Contracts\Auth\AuthUser`](/5.19/api/phalcon_contracts/#contractsauthauthuser)
...
- **`Phalcon\Auth\Manager`** - implements [`Phalcon\Contracts\Auth\Manager`](/5.19/api/phalcon_contracts/#contractsauthmanager)
...
Source: https://docs.phalcon.io/5.19/api/phalcon_auth/index.mdx
