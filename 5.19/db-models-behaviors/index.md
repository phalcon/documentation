...
Any exceptions thrown in the `Phalcon\Mvc\Model\Behavior` namespace will be of type `Phalcon\Mvc\Model\Exception`. You can use this exception to selectively catch exceptions thrown only from this component.
...
[events]: /5.19/events/
[events-list]: /5.19/events/#list-of-events
[mvc-model-behavior]: /5.19/api/phalcon_mvc/#mvcmodelbehavior
[mvc-model-behavior-softdelete]: /5.19/api/phalcon_mvc/#mvcmodelbehaviorsoftdelete
[mvc-model-behavior-timestampable]: /5.19/api/phalcon_mvc/#mvcmodelbehaviortimestampable
[mvc-model-behaviorinterface]: /5.19/api/phalcon_mvc/#mvcmodelbehaviorinterface
[time]: https://php.net/manual/en/function.time.php
[traits]: https://php.net/manual/en/language.oop5.traits.php

Source: https://docs.phalcon.io/5.19/db-models-behaviors/index.mdx
