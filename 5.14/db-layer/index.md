...
[Spatial Column Hydration](/5.14/db-models/) in the models documentation.
...
[db-abstractdb]: /5.14/api/phalcon_db/#dbabstractdb

[db-adapter-abstractadapter]: /5.14/api/phalcon_db/#dbadapterabstractadapter

[db-adapter-adapterinterface]: /5.14/api/phalcon_db/#dbadapteradapterinterface

[db-adapter-pdo-abstractpdo]: /5.14/api/phalcon_db/#dbadapterpdoabstractpdo

[db-adapter-pdo-mysql]: /5.14/api/phalcon_db/#dbadapterpdomysql

[db-adapter-pdo-postgresql]: /5.14/api/phalcon_db/#dbadapterpdopostgresql

[db-adapter-pdo-sqlite]: /5.14/api/phalcon_db/#dbadapterpdosqlite

[db-adapter-pdofactory]: /5.14/api/phalcon_db/#dbadapterpdofactory

[db-column]: /5.14/api/phalcon_db/#dbcolumn

[db-columninterface]: /5.14/api/phalcon_db/#dbcolumninterface

[db-dialect]: /5.14/api/phalcon_db/#dbdialect

[db-dialect-mysql]: /5.14/api/phalcon_db/#dbdialectmysql

[db-dialect-postgresql]: /5.14/api/phalcon_db/#dbdialectpostgresql

[db-dialect-sqlite]: /5.14/api/phalcon_db/#dbdialectsqlite

[db-dialectinterface]: /5.14/api/phalcon_db/#dbdialectinterface

[db-enum]: /5.14/api/phalcon_db/#dbenum

[db-exception]: /5.14/api/phalcon_db/#dbexception

[db-index]: /5.14/api/phalcon_db/#dbindex

[db-indexinterface]: /5.14/api/phalcon_db/#dbindexinterface

[db-profiler]: /5.14/api/phalcon_db/#dbprofiler

[db-profiler-item]: /5.14/api/phalcon_db/#dbprofileritem

[db-rawvalue]: /5.14/api/phalcon_db/#dbrawvalue

[db-reference]: /5.14/api/phalcon_db/#dbreference

[db-referenceinterface]: /5.14/api/phalcon_db/#dbreferenceinterface

[db-result-pdo]: /5.14/api/phalcon_db/#dbresultpdoresult

[db-resultinterface]: /5.14/api/phalcon_db/#dbresultinterface
...
Source: https://docs.phalcon.io/5.14/db-layer/index.mdx
