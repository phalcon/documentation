...
- **`Phalcon\Events\Event`** — implements [`Phalcon\Events\EventInterface`](#eventseventinterface), [`Phalcon\Contracts\Events\Stoppable`](/5.14/api/phalcon_contracts/#contractseventsstoppable)
...
Source: https://docs.phalcon.io/5.14/api/phalcon_events/index.mdx
