...
- [`Phalcon\Auth\Access\AccessLocator`](/5.14/api/phalcon_auth/#authaccessaccesslocator)
- [`Phalcon\Auth\Adapter\AdapterLocator`](/5.14/api/phalcon_auth/#authadapteradapterlocator)
- [`Phalcon\Auth\Guard\GuardLocator`](/5.14/api/phalcon_auth/#authguardguardlocator)
...
- [`Phalcon\Config\Config`](/5.14/api/phalcon_config/#configconfig)
- [`Phalcon\Html\Attributes`](/5.14/api/phalcon_html/#htmlattributes)
- [`Phalcon\Session\Bag`](/5.14/api/phalcon_session/#sessionbag)
...
- **`Phalcon\Support\Collection\CollectionInterface`**
- [`Phalcon\Config\ConfigInterface`](/5.14/api/phalcon_config/#configconfiginterface)
...
<h4 id="supportdebug-escapestring"><code>escapeString()</code></h4>
...
<h4 id="supportdebug-getarraydump"><code>getArrayDump()</code></h4>
...
<h4 id="supportdebug-getvardump"><code>getVarDump()</code></h4>
...
<h4 id="supportdebug-showtraceitem"><code>showTraceItem()</code></h4>
...
- [`Phalcon\Logger\Formatter\AbstractFormatter`](/5.14/api/phalcon_logger/#loggerformatterabstractformatter)
...
Source: https://docs.phalcon.io/5.14/api/phalcon_support/index.mdx
