...
[config]: /5.14/api/phalcon_config/#configconfig

[factorydefault]: /5.14/api/phalcon_di/#difactorydefault

[logger-logger]: /5.14/api/phalcon_logger/#loggerlogger

[logger-abstractlogger]: /5.14/api/phalcon_logger/#loggerabstractlogger

[logger-adapter-noop]: /5.14/api/phalcon_logger/#loggeradapternoop

[logger-adapter-stream]: /5.14/api/phalcon_logger/#loggeradapterstream

[logger-adapter-syslog]: /5.14/api/phalcon_logger/#loggeradaptersyslog

[logger-loggerfactory]: /5.14/api/phalcon_logger/#loggerloggerfactory

[logger-adapterfactory]: /5.14/api/phalcon_logger/#loggeradapterfactory

[logger-formatter-line]: /5.14/api/phalcon_logger/#loggerformatterline

[logger-formatter-json]: /5.14/api/phalcon_logger/#loggerformatterjson

[logger-formatter-formatterinterface]: /5.14/api/phalcon_logger/#loggerformatterformatterinterface

[logger-adapter-adapterinterface]: /5.14/api/phalcon_logger/#loggeradapteradapterinterface

[logger-formatter-abstractformatter]: /5.14/api/phalcon_logger/#loggerformatterabstractformatter

[logger-adapter-abstractadapter]: /5.14/api/phalcon_logger/#loggeradapterabstractadapter

[logger-exception]: /5.14/api/phalcon_logger/#loggerexception

[logger-item]: /5.14/api/phalcon_logger/#loggeritem
...
Source: https://docs.phalcon.io/5.14/logger/index.mdx
