...
As of 5.14 the component raises granular subclasses of `Phalcon\Config\Exception` so callers can catch a specific
...
[collection]: /5.14/support-collection/

[phalcon-incubator]: https://github.com/phalcon/incubator

[grouped]: /5.14/api/phalcon_config/#configadaptergrouped

[ini]: /5.14/api/phalcon_config/#configadapterini

[json]: /5.14/api/phalcon_config/#configadapterjson

[php]: /5.14/api/phalcon_config/#configadapterphp

[yaml]: /5.14/api/phalcon_config/#configadapteryaml

[config-config]: /5.14/api/phalcon_config/#configconfig

[config-configfactory]: /5.14/api/phalcon_config/#configconfigfactory

[config-exception]: /5.14/api/phalcon_config/#configexception
...
[support-collection]: /5.14/support-collection/

Source: https://docs.phalcon.io/5.14/config/index.mdx
