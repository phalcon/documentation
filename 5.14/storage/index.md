...
As of 5.14 the component raises granular subclasses of `Phalcon\Storage\Exception` so callers can catch a specific
...
[storage-adapter-rediscluster]: /5.14/api/phalcon_storage/#storageadapterrediscluster
