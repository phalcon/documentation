...
[db-models-metadata]: /5.18/db-models-metadata/
[db-models-transactions]: /5.18/db-models-transactions/
[di]: /5.18/api/phalcon_di/#didi
[di-abstractinjectionaware]: /5.18/api/phalcon_di/#diabstractinjectionaware
[di-diinterface]: /5.18/api/phalcon_di/#didiinterface
[di-exception]: /5.18/api/phalcon_di/#diexception
[di-exception-serviceresolutionexception]: /5.18/api/phalcon_di/#diexceptionserviceresolutionexception
...
[di-serviceinterface]: /5.18/api/phalcon_di/#diserviceinterface
[di-serviceproviderinterface]: /5.18/api/phalcon_di/#diserviceproviderinterface
[dispatcher]: /5.18/dispatcher/
[encryption-crypt]: /5.18/encryption-crypt/
[encryption-security]: /5.18/encryption-security/
[events]: /5.18/events/
[filter-filter]: /5.18/filter-filter/
[flash]: /5.18/flash/
[html-escaper]: /5.18/html-escaper/
[ioc]: https://en.wikipedia.org/wiki/Inversion_of_control
[mvc-url]: /5.18/mvc-url/
[request]: /5.18/request/
[response]: /5.18/response/
[response-cookies]: /5.18/response/#cookies
[routing]: /5.18/routing/
[session-bag]: /5.18/session/#bag
[singletons]: https://en.wikipedia.org/wiki/Singleton_pattern
[support-helper]: /5.18/support-helper/
[tagfactory]: /5.18/html-tagfactory/
[yaml]: https://php.net/manual/book.yaml.php

Source: https://docs.phalcon.io/5.18/di/index.mdx
