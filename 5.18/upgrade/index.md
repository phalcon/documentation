...
[phalcon-acl]: /5.18/acl/
[phalcon-annotations]: /5.18/annotations/
[phalcon-application]: /5.18/application/
[phalcon-application-cli]: /5.18/application-cli/
[phalcon-assets]: /5.18/assets/
[phalcon-autoload]: /5.18/autoload/
[phalcon-cache]: /5.18/cache/
[phalcon-config]: /5.18/config/
[phalcon-datamapper]: /5.18/datamapper/
[phalcon-db-layer]: /5.18/db-layer/
[phalcon-db-pagination]: /5.18/db-pagination/
[phalcon-di]: /5.18/di/
[phalcon-dispatcher]: /5.18/dispatcher/
[phalcon-domain]: /5.18/domain/
[phalcon-encryption-crypt]: /5.18/encryption-crypt/
[phalcon-encryption-security]: /5.18/encryption-security/
[phalcon-events]: /5.18/events/
[phalcon-filter-filter]: /5.18/filter-filter/
[phalcon-filter-validation]: /5.18/filter-validation/
[phalcon-flash]: /5.18/flash/
[phalcon-forms]: /5.18/forms/
[phalcon-html]: /5.18/html/
[phalcon-html-escaper]: /5.18/html-escaper/
[phalcon-html-link]: /5.18/html-link/
[phalcon-html-tagfactory]: /5.18/html-tagfactory/
[phalcon-logger]: /5.18/logger/
[phalcon-mvc]: /5.18/mvc/
[phalcon-mvc-url]: /5.18/mvc-url/
[phalcon-session]: /5.18/session/
[phalcon-storage]: /5.18/storage/
[phalcon-support-collection]: /5.18/support-collection/
[phalcon-support-debug]: /5.18/support-debug/
[phalcon-support-helper]: /5.18/support-helper/
[phalcon-support-registry]: /5.18/support-registry/
[phalcon-support-version]: /5.18/support-version/
[phalcon-tag]: /5.18/tag/
[phalcon-translate]: /5.18/translate/
[phalcon-volt]: /5.18/volt/
...
[support]: #support
[volt-tag-helpers]: /5.18/volt/#tag-helpers
[zephir-phar]: https://github.com/phalcon/zephir/releases

Source: https://docs.phalcon.io/5.18/upgrade/index.mdx
