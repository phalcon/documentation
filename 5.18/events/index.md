...
[application-micro]: /5.18/application-micro/
[auth]: /5.18/auth/
[autoload]: /5.18/autoload/
[cache]: /5.18/cache/
[contracts-event]: /5.18/api/phalcon_contracts/#contractseventsevent
[contracts-eventsaware]: /5.18/api/phalcon_contracts/#contractseventseventsaware
[contracts-manager]: /5.18/api/phalcon_contracts/#contractseventsmanager
[contracts-stoppable]: /5.18/api/phalcon_contracts/#contractseventsstoppable
[db]: /5.18/api/phalcon_db/
[db-layer]: /5.18/db-layer/
[db-models]: /5.18/db-models/
[di-factorydefaul]: /5.18/api/phalcon_di/#difactorydefault
[di-injectable]: /5.18/api/phalcon_di/#diinjectable
[dispatcher]: /5.18/dispatcher/
[events-event]: /5.18/api/phalcon_events/#eventsevent
[events-eventinterface]: /5.18/api/phalcon_events/#eventseventinterface
[events-eventsawareinterface]: /5.18/api/phalcon_events/#eventseventsawareinterface
[events-exception]: /5.18/api/phalcon_events/#eventsexception
[events-manager]: /5.18/api/phalcon_events/#eventsmanager
[events-managerinterface]: /5.18/api/phalcon_events/#eventsmanagerinterface
[events-subscriber]: /5.18/api/phalcon_contracts/#contractseventssubscriber
...
[storage]: /5.18/storage/
[views]: /5.18/views/
[volt]: /5.18/volt/

Source: https://docs.phalcon.io/5.18/events/index.mdx
