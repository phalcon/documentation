...
- **`Phalcon\Auth\AuthUser`** - implements [`Phalcon\Contracts\Auth\AuthUser`](/5.18/api/phalcon_contracts/#contractsauthauthuser)
...
- **`Phalcon\Auth\Manager`** - implements [`Phalcon\Contracts\Auth\Manager`](/5.18/api/phalcon_contracts/#contractsauthmanager)
...
Source: https://docs.phalcon.io/5.18/api/phalcon_auth/index.mdx
