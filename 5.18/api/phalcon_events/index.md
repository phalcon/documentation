...
- **`Phalcon\Events\Event`** - implements [`Phalcon\Events\EventInterface`](#eventseventinterface), [`Phalcon\Contracts\Events\Stoppable`](/5.18/api/phalcon_contracts/#contractseventsstoppable)
...
- **`Phalcon\Events\Manager`** - implements [`Phalcon\Events\ManagerInterface`](#eventsmanagerinterface), [`Phalcon\Contracts\Events\Enumerable`](/5.18/api/phalcon_contracts/#contractseventsenumerable)
...
Source: https://docs.phalcon.io/5.18/api/phalcon_events/index.mdx
