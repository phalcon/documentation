...
- **`Phalcon\Queue\Adapter\AbstractConsumer`** - implements [`Phalcon\Contracts\Queue\Consumer`](/5.18/api/phalcon_contracts/#contractsqueueconsumer)
...
- **`Phalcon\Queue\Adapter\AbstractContext`** - implements [`Phalcon\Contracts\Queue\Context`](/5.18/api/phalcon_contracts/#contractsqueuecontext)
...
- **`Phalcon\Queue\Adapter\AbstractMessage`** - implements [`Phalcon\Contracts\Queue\Message`](/5.18/api/phalcon_contracts/#contractsqueuemessage)
...
- **`Phalcon\Queue\Adapter\AbstractProducer`** - implements [`Phalcon\Contracts\Queue\Producer`](/5.18/api/phalcon_contracts/#contractsqueueproducer)
...
- **`Phalcon\Queue\Adapter\AbstractSubscriptionConsumer`** - implements [`Phalcon\Contracts\Queue\SubscriptionConsumer`](/5.18/api/phalcon_contracts/#contractsqueuesubscriptionconsumer)
...
- **`Phalcon\Queue\Adapter\Beanstalk\BeanstalkConnectionFactory`** - implements [`Phalcon\Contracts\Queue\ConnectionFactory`](/5.18/api/phalcon_contracts/#contractsqueueconnectionfactory)
...
- **`Phalcon\Queue\Adapter\Beanstalk\BeanstalkConsumer`** - implements [`Phalcon\Contracts\Queue\VisibilityAware`](/5.18/api/phalcon_contracts/#contractsqueuevisibilityaware)
...
- **`Phalcon\Queue\Adapter\Beanstalk\BeanstalkContext`** - implements [`Phalcon\Contracts\Queue\Inspectable`](/5.18/api/phalcon_contracts/#contractsqueueinspectable)
...
- **`Phalcon\Queue\Adapter\GenericQueue`** - implements [`Phalcon\Contracts\Queue\Queue`](/5.18/api/phalcon_contracts/#contractsqueuequeue)
...
- **`Phalcon\Queue\Adapter\GenericTopic`** - implements [`Phalcon\Contracts\Queue\Topic`](/5.18/api/phalcon_contracts/#contractsqueuetopic)
...
- **`Phalcon\Queue\Adapter\Memory\MemoryConnectionFactory`** - implements [`Phalcon\Contracts\Queue\ConnectionFactory`](/5.18/api/phalcon_contracts/#contractsqueueconnectionfactory)
...
- **`Phalcon\Queue\Adapter\Redis\RedisConnectionFactory`** - implements [`Phalcon\Contracts\Queue\ConnectionFactory`](/5.18/api/phalcon_contracts/#contractsqueueconnectionfactory)
...
- **`Phalcon\Queue\Adapter\Stream\StreamConnectionFactory`** - implements [`Phalcon\Contracts\Queue\ConnectionFactory`](/5.18/api/phalcon_contracts/#contractsqueueconnectionfactory)
...
<a class="src-btn" href="https://github.com/phalcon/cphalcon/blob/5.0.x/phalcon/Queue/Adapter/Traits/MessageTrait.zep">Source on GitHub</a>
...
<span class="badge badge--trait">Trait</span>
<a class="src-btn" href="https://github.com/phalcon/cphalcon/blob/5.0.x/phalcon/Queue/Adapter/Traits/SubscriptionConsumerTrait.zep">Source on GitHub</a>
...
<span class="desc">Subscriptions keyed by queue name: [consumer, callback]. @todo Use a default [] once Zephir supports array trait defaults</span>
</div>
</div>
...
- **`Phalcon\Queue\Consumer\QueueConsumer`** - implements [`Phalcon\Events\EventsAwareInterface`](/5.18/api/phalcon_events/#eventseventsawareinterface)
...
Source: https://docs.phalcon.io/5.18/api/phalcon_queue/index.mdx
