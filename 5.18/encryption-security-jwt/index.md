...
[security-jwt-builder]: /5.18/api/phalcon_encryption/#encryptionsecurityjwtbuilder
[security-jwt-exceptions-invalidaudiencetype]: /5.18/api/phalcon_encryption/#encryptionsecurityjwtexceptionsinvalidaudiencetype
[security-jwt-exceptions-unsupportedalgorithmexception]: /5.18/api/phalcon_encryption/#encryptionsecurityjwtexceptionsunsupportedalgorithmexception
[security-jwt-exceptions-validatorexception]: /5.18/api/phalcon_encryption/#encryptionsecurityjwtexceptionsvalidatorexception
[security-jwt-signer-abstractsigner]: /5.18/api/phalcon_encryption/#encryptionsecurityjwtsignerabstractsigner
[security-jwt-signer-hmac]: /5.18/api/phalcon_encryption/#encryptionsecurityjwtsignerhmac
[security-jwt-signer-none]: /5.18/api/phalcon_encryption/#encryptionsecurityjwtsignernone
[security-jwt-signer-signerinterface]: /5.18/api/phalcon_encryption/#encryptionsecurityjwtsignersignerinterface
[security-jwt-token-abstractitem]: /5.18/api/phalcon_encryption/#encryptionsecurityjwttokenabstractitem
[security-jwt-token-enum]: /5.18/api/phalcon_encryption/#encryptionsecurityjwttokenenum
[security-jwt-token-item]: /5.18/api/phalcon_encryption/#encryptionsecurityjwttokenitem
[security-jwt-token-parser]: /5.18/api/phalcon_encryption/#encryptionsecurityjwttokenparser
[security-jwt-token-signature]: /5.18/api/phalcon_encryption/#encryptionsecurityjwttokensignature
[security-jwt-token-token]: /5.18/api/phalcon_encryption/#encryptionsecurityjwttokentoken
[security-jwt-validator]: /5.18/api/phalcon_encryption/#encryptionsecurityjwtvalidator

Source: https://docs.phalcon.io/5.18/encryption-security-jwt/index.mdx
